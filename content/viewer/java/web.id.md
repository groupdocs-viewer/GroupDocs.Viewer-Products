...
head_title: "Java WEB Viewer API - Render & Tampilan WEB di Aplikasi Java"
head_description: "Lihat file WEB di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File WEB di Java"
description: "API penampil file WEB asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File WEB di Java"
    content_left: |
        [GroupDocs.Viewer](/viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file WEB di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file HTML dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file HTML ke format PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.html"))
        {
        	// Setel opsi tampilan
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa WEB"
    content: |
        Tampilkan file WEB sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
...
more_formats:
    ...
    format: 
        ...
        - name: "Penampil VDW Java"
          ...
          description: "Gambar Microsoft Visio 2010 WEB"
