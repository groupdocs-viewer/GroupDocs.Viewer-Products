...
############################# Head #############################
head_title: "„Java“ Spreadsheet peržiūros programos API – atvaizduokite ir rodykite Spreadsheet „Java Apps“."
head_description: "Peržiūrėkite Spreadsheet failus Java, J2EE, J2SE programose. Palaiko 170+ dokumentų ir vaizdo failų formatų peržiūrą HTML, PDF arba vaizdo režimu su pažangiomis funkcijomis, leidžiančiomis valdyti dokumentų peržiūros parinktis."

############################# Header ############################
title: "Pateikti ir peržiūrėti Spreadsheet Java" 
description: "Savoji ir didelio našumo Spreadsheet failų peržiūros programa, skirta Java, J2EE ir J2SE pagrįstoms programoms, palaikanti daugybę papildomų funkcijų, leidžiančių tinkinti išvesties dokumento formato išvaizdą." 
...
steps:
    enable: true
    title_left: "Veiksmai, kaip pateikti Spreadsheet failą Java" 
    content_left: |
        Naudodami [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) atlikdami kelis veiksmus galite pateikti Spreadsheet į HTML, JPEG, PNG arba PDF.

        * Pridėkite [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) kaip projekto priklausomybę. 
        * Sukurkite Viewer klasės egzempliorių ir įkelkite failą Spreadsheet su visu keliu. 
        * Nustatykite parinktis, kaip pateikti Spreadsheet failą HTML, PNG, JPEG arba PDF formatu. 
...
demos:
    enable: true
    title: "Spreadsheet žiūrovo tiesioginė demonstracija"
    content: |
        Peržiūrėkite Spreadsheet failą dabar apsilankę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/excel) svetainėje.
    lang: "lt"
