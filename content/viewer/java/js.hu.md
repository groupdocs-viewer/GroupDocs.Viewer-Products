...
############################# Head #############################
head_title: "Java JS Viewer API – JS renderelés és megjelenítése Java alkalmazásokban"
head_description: "Tekintse meg a JS fájlokat Java, J2EE, J2SE alkalmazásokban. Támogatja a 170+ dokumentum- és képfájlformátum megtekintését HTML, PDF vagy kép módban, fejlett funkciókkal a dokumentummegtekintési beállítások kezeléséhez."

############################# Header ############################
title: "Render & View JS Java nyelven" 
description: "Natív és nagy teljesítményű JS fájlnézegető API Java, J2EE és J2SE alapú alkalmazásokhoz, amely számos további funkciót támogat a kimeneti dokumentumformátum megjelenésének testreszabásához." 
...
steps:
    enable: true
    title_left: "A JS fájl renderelésének lépései a Java programban" 
    content_left: |
        A [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) segítségével néhány lépésben megjelenítheti a JS fájlt HTML, JPEG, PNG vagy PDF formátumban.
