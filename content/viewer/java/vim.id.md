...
head_title: "Java VIM Viewer API - Render & Tampilan VIM di Aplikasi Java"
head_description: "Lihat file VIM di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File VIM di Java"
description: "API penampil file VIM asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File VIM di Java"
    content_left: |
        [GroupDocs.Viewer](viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file VIM di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file VIM dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file VIM ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa VIM"
    content: |
        Tampilkan file VIM sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-vim"
          title: "Tentang Format Berkas VIM"
          content: |
            {{VIM}}
