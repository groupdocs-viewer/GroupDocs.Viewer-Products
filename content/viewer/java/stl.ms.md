...
############################# Head #############################
head_title: "Java STL Viewer API - Render & Display STL dalam Java Apps"
head_description: "Lihat STL fail dalam aplikasi Java, J2EE, J2SE. Menyokong melihat 170+ format fail dokumen dan imej dalam mod HTML, PDF atau imej dengan ciri lanjutan untuk mengurus pilihan melihat dokumen."

############################# Header ############################
title: "Render & Lihat STL Dalam Java" 
description: "API pemapar fail STL asli dan berprestasi tinggi untuk aplikasi berasaskan Java, J2EE dan J2SE, menyokong pelbagai ciri tambahan untuk menyesuaikan penampilan format dokumen output." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail STL dalam Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) anda boleh memaparkan STL kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.

        * Tambahkan [GroupDocs.Viewer untuk Java](https://releases.groupdocs.com/viewer/java/) sebagai pergantungan kepada projek anda. 
        * Buat contoh kelas Viewer dan muatkan fail STL dengan laluan penuh. 
        * Tetapkan pilihan untuk memaparkan fail STL ke dalam format HTML, PNG, JPEG atau PDF. 
...
demos:
    enable: true
    title: "STL Demo Langsung Penonton"
    content: |
        Lihat fail STL sekarang dengan melawati tapak web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/stl).
    lang: "ms"
