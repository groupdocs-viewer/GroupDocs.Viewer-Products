...
############################# Head #############################
head_title: "Java SCRIPT Viewer API - Render & Tampilkan SCRIPT di Aplikasi Java"
head_description: "Lihat file SCRIPT dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat SCRIPT Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file SCRIPT di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender SCRIPT ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file SCRIPT ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "SCRIPT Demo Langsung Pemirsa"
    content: |
        Lihat file SCRIPT sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/script).
    lang: "id"
