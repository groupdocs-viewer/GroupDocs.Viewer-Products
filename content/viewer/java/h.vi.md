...
############################# Head #############################
head_title: "API Trình xem Java H - Kết xuất & Hiển thị H trong Ứng dụng Java"
head_description: "Xem các tệp H trong các ứng dụng Java, J2EE, J2SE. Hỗ trợ xem hơn 170 định dạng tệp tài liệu và hình ảnh ở chế độ HTML, PDF hoặc hình ảnh với các tính năng nâng cao để quản lý các tùy chọn xem tài liệu."

############################# Header ############################
title: "Kết xuất & Xem H Trong Java" 
description: "API trình xem tệp H gốc và hiệu suất cao dành cho các ứng dụng dựa trên Java, J2EE và J2SE, hỗ trợ nhiều tính năng bổ sung để tùy chỉnh giao diện của định dạng tài liệu đầu ra." 
...
steps:
    enable: true
    title_left: "Các bước để kết xuất tệp H trong Java" 
    content_left: |
        Với [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/), bạn có thể kết xuất H thành HTML, JPEG, PNG hoặc PDF trong một vài bước.

        * Thêm [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) làm phần phụ thuộc cho dự án của bạn. 
        * Tạo một thể hiện của lớp Viewer và tải tệp H với đường dẫn đầy đủ. 
        * Đặt các tùy chọn để hiển thị tệp H thành định dạng HTML, PNG, JPEG hoặc PDF. 
...
demos:
    enable: true
    title: "H Trình diễn trực tiếp dành cho người xem"
    content: |
        Xem tệp H ngay bây giờ bằng cách truy cập trang web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/h).
    lang: "vi"
