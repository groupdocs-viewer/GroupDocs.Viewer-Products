...
############################# Head #############################
head_title: "Java SCRIPT Viewer API — renderowanie i wyświetlanie SCRIPT w aplikacjach Java"
head_description: "Zobacz pliki SCRIPT w aplikacjach Java, J2EE, J2SE. Obsługuje przeglądanie ponad 170 formatów dokumentów i plików obrazów w trybie HTML, PDF lub obrazu z zaawansowanymi funkcjami do zarządzania opcjami przeglądania dokumentów."

############################# Header ############################
title: "Renderuj i przeglądaj DOCX SCRIPT w Javie" 
description: "Natywny i wydajny interfejs API przeglądarki plików SCRIPT dla aplikacji opartych na językach Java, J2EE i J2SE, obsługujący szeroki zakres dodatkowych funkcji umożliwiających dostosowanie wyglądu formatu dokumentu wyjściowego." 
...
steps:
    enable: true
    title_left: "Kroki renderowania pliku SCRIPT w Java" 
    content_left: |
        Dzięki [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) możesz w kilku krokach wyrenderować SCRIPT do formatu HTML, JPEG, PNG lub PDF.

        * Dodaj [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) jako zależność do swojego projektu. 
        * Utwórz instancję klasy Viewer i załaduj plik SCRIPT z pełną ścieżką. 
        * Ustaw opcje renderowania pliku SCRIPT do formatu HTML, PNG, JPEG lub PDF. 
...
demos:
    enable: true
    title: "SCRIPT Przeglądarka Demo na żywo"
    content: |
        Wyświetl teraz plik SCRIPT, odwiedzając witrynę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/script).
    lang: "pl"
