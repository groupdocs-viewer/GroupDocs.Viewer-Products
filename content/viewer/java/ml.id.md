...
head_title: "Java ML Viewer API - Render & Tampilan ML di Aplikasi Java"
head_description: "Lihat file ML di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File ML di Java"
description: "API penampil file ML asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File ML di Java"
    content_left: |
        [GroupDocs.Viewer](/viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file ML di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file ML dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file ML ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa ML"
    content: |
        Tampilkan file ML sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-ml"
          title: "Tentang Format Berkas ML"
          content: |
            {{ML}}
