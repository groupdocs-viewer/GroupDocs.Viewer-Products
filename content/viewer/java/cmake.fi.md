...
############################# Head #############################
head_title: "Java CMAKE Viewer API - Renderöi ja näytä CMAKE Java-sovelluksissa"
head_description: "Tarkastele CMAKE-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä CMAKE Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn CMAKE-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston CMAKE renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa CMAKE HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.

        * Lisää [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) projektisi riippuvuudeksi. 
        * Luo Viewer-luokan ilmentymä ja lataa CMAKE tiedosto koko polulla. 
        * Aseta asetukset renderöidäksesi CMAKE-tiedosto HTML-, PNG-, JPEG- tai PDF-muotoon. 
...
demos:
    enable: true
    title: "CMAKE Viewerin live-demo"
    content: |
        Tarkastele tiedostoa CMAKE heti käymällä [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cmake) -sivustolla.
    lang: "fi"
