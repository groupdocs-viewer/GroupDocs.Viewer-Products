...
############################# Head #############################
head_title: "Java XPS Viewer API - Procesar y mostrar XPS en aplicaciones Java"
head_description: "Ver archivos XPS en aplicaciones Java, J2EE, J2SE. Admite la visualización de más de 170 formatos de archivos de imágenes y documentos en HTML, PDF o modo de imagen con funciones avanzadas para administrar las opciones de visualización de documentos."

############################# Header ############################
title: "Renderizar y ver XPS en Java" 
description: "API de visor de archivos XPS nativa y de alto rendimiento para aplicaciones basadas en Java, J2EE y J2SE, que admite una amplia gama de características adicionales para personalizar la apariencia del formato del documento de salida." 
...
steps:
    enable: true
    title_left: "Pasos para procesar el archivo XPS en Java" 
    content_left: |
        Con [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) puede representar XPS a HTML, JPEG, PNG o PDF en unos pocos pasos.

        * Agregue [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) como una dependencia de su proyecto. 
        * Cree una instancia de la clase Viewer y cargue el archivo XPS con la ruta completa. 
        * Configure las opciones para representar el archivo XPS en formato HTML, PNG, JPEG o PDF. 
...
demos:
    enable: true
    title: "XPS Espectador de demostración en vivo"
    content: |
        Vea el archivo XPS ahora mismo visitando el sitio web de [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/xps).
    lang: "es"
