...
head_description: "View BAT files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View BAT In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render BAT file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render BAT to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render BAT file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View BAT file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/bat) website.
    lang: "en"
