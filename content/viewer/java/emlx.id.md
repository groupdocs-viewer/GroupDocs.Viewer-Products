...
############################# Head #############################
head_title: "Java EMLX Viewer API - Render & Tampilkan EMLX di Aplikasi Java"
head_description: "Lihat file EMLX dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat EMLX Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file EMLX di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender EMLX ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file EMLX ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "EMLX Demo Langsung Pemirsa"
    content: |
        Lihat file EMLX sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/emlx).
    lang: "id"
