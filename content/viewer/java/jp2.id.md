...
############################# Head #############################
head_title: "Java JP2 Viewer API - Render & Tampilkan JP2 di Aplikasi Java"
head_description: "Lihat file JP2 dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat JP2 Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file JP2 di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender JP2 ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
