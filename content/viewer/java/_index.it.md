...
overview:
  ...
  features:
    ...
    - title: "Visualizza i documenti in modo efficiente e affidabile"
      content: "Con l'API GroupDocs.Viewer è possibile rendere in modo efficiente documenti di qualsiasi formato supportato in [HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/), [JPEG, PNG](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/), e [PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/) grazie a opzioni flessibili e potenti, preservando l'integrità del contenuto e della struttura del documento. GroupDocs.Viewer funziona su piattaforme Windows e Linux."
...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Visualizza i documenti in HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Rasterizzare i documenti](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/)"
    ...
    # feature loop
    - icon: "font"
      title: "[Controlla i caratteri del documento](https://docs.groupdocs.com/viewer/java/set-custom-fonts/)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Converti in PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Applicare trasformazioni](https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Regolazione dell'output HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Supporto di strutture documentali complesse](https://blog.groupdocs.com/viewer/view-files-and-folders-in-zip-and-tar-archives-using-java-api/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Opzioni di ottimizzazione](https://docs.groupdocs.com/viewer/java/how-to-use-custom-cache-implementation/)"
    ...
    - icon: "passwordprotected"
      title: "[Supporto di documenti protetti da password](https://docs.groupdocs.com/viewer/java/load-password-protected-document/)"
