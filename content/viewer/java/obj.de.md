...
############################# Head #############################
head_title: "Java OBJ Viewer API – Rendern und Anzeigen von OBJ in Java-Apps"
head_description: "Sehen Sie sich OBJ-Dateien in Java-, J2EE- und J2SE-Anwendungen an. Unterstützt die Anzeige von über 180 Dokument- und Bilddateiformaten im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung der Dokumentanzeigeoptionen."

############################# Header ############################
title: "Rendern und Anzeigen von OBJ in Java" 
description: "Native und leistungsstarke OBJ-Dateibetrachter-API für Java-, J2EE- und J2SE-basierte Anwendungen, die eine Vielzahl zusätzlicher Funktionen unterstützt, um das Erscheinungsbild des Ausgabedokumentformats anzupassen." 
...
steps:
    enable: true
    title: "Schritte zum Rendern der Datei OBJ in Java" 
    content: |
      Mit <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> können Sie OBJ in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
      ...
      2. Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei OBJ mit dem vollständigen Pfad.  
      3. Legen Sie Optionen fest, um die Datei OBJ im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
    ...
    code:
      ...
      content: |
        ...
        // Richten Sie die Eingabedatei OBJ ein
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Rendern Sie die Datei OBJ mit eingebetteten Ressourcen in HTML
