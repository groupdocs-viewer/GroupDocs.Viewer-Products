...
############################# Head #############################
head_title: "Java XLS Viewer API - Render & Tampilkan XLS di Aplikasi Java"
head_description: "Lihat file XLS dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat XLS Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file XLS di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender XLS ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
