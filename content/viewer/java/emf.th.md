...
############################# Head #############################
head_title: "Java EMF Viewer API - แสดงผลและแสดงผล EMF ในแอป Java"
head_description: "ดูไฟล์ EMF ในแอปพลิเคชัน Java, J2EE, J2SE รองรับการดูไฟล์เอกสารและรูปภาพมากกว่า 170 รูปแบบในโหมด HTML, PDF หรือรูปภาพ พร้อมคุณสมบัติขั้นสูงในการจัดการตัวเลือกการดูเอกสาร"

############################# Header ############################
title: "แสดงผล & ดู EMF ใน Java" 
description: "API โปรแกรมดูไฟล์แบบเนทีฟและประสิทธิภาพสูง EMF สำหรับแอปพลิเคชันที่ใช้ Java, J2EE และ J2SE รองรับคุณสมบัติเพิ่มเติมที่หลากหลายเพื่อปรับแต่งรูปลักษณ์ของรูปแบบเอกสารเอาต์พุต" 
...
steps:
    enable: true
    title_left: "ขั้นตอนใน Render ไฟล์ EMF ใน Java" 
    content_left: |
        ด้วย [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) คุณสามารถแสดง EMF เป็น HTML, JPEG, PNG หรือ PDF ในไม่กี่ขั้นตอน

        * เพิ่ม [GroupDocs.Viewer สำหรับ Java](https://releases.groupdocs.com/viewer/java/) เป็นการพึ่งพาในโครงการของคุณ 
        * สร้างอินสแตนซ์ของคลาส Viewer และโหลดไฟล์ EMF ด้วยเส้นทางแบบเต็ม 
        * ตั้งค่าตัวเลือกเพื่อแสดงไฟล์ EMF เป็นรูปแบบ HTML, PNG, JPEG หรือ PDF 
...
demos:
    enable: true
    title: "EMF โปรแกรมดูการสาธิตสด"
    content: |
        ดูไฟล์ EMF ตอนนี้โดยไปที่เว็บไซต์ [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/emf)
    lang: "th"
