...
############################# Head #############################
head_title: "Java VDX Viewer API - เรนเดอร์และแสดง VDX ในแอป Java"
head_description: "ดูไฟล์ VDX ในแอปพลิเคชัน Java, J2EE, J2SE รองรับการดูเอกสารและไฟล์รูปภาพมากกว่า 180 รูปแบบในโหมด HTML, PDF หรือรูปภาพพร้อมคุณสมบัติขั้นสูงเพื่อจัดการตัวเลือกการดูเอกสาร"

############################# Header ############################
title: "เรนเดอร์และดู VDX ใน Java" 
description: "API โปรแกรมดูไฟล์ VDX แบบเนทีฟและประสิทธิภาพสูงสำหรับแอปพลิเคชันที่ใช้ Java, J2EE และ J2SE ซึ่งรองรับคุณสมบัติเพิ่มเติมที่หลากหลายเพื่อปรับแต่งลักษณะที่ปรากฏของรูปแบบเอกสารเอาต์พุต" 
...
steps:
    enable: true
    title: "ขั้นตอนในการแสดงผลไฟล์ VDX ใน Java" 
    content: |
      ด้วย <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> คุณสามารถแสดงผล VDX เป็น HTML, JPEG, PNG หรือ PDF ได้ในไม่กี่ขั้นตอน
      ...
      2. สร้างอินสแตนซ์ของคลาส Viewer และโหลดไฟล์ VDX ด้วยเส้นทางแบบเต็ม  
      3. ตั้งค่าตัวเลือกเพื่อแสดงไฟล์ VDX เป็นรูปแบบ HTML, PNG, JPEG หรือ PDF 
    ...
    code:
      ...
      content: |
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // เรนเดอร์ไฟล์ VDX เป็น HTML ด้วยทรัพยากรที่ฝังอยู่
