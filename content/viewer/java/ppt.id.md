...
############################# Head #############################
head_title: "Java PPT Viewer API - Render & Tampilkan PPT di Aplikasi Java"
head_description: "Lihat file PPT dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat PPT Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file PPT di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender PPT ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file PPT ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "PPT Demo Langsung Pemirsa"
    content: |
        Lihat file PPT sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ppt).
    lang: "id"
