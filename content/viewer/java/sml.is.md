...
############################# Head #############################
head_title: "Java SML áhorfandaforritaskil - birta og birta SML í Java forritum"
head_description: "Skoðaðu SML skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu SML í Java" 
description: "Innbyggt og afkastamikið SML skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera SML skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert SML í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið SML skránni með fullri slóð. 
        * Stilltu valkosti til að gera SML skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "SML Sýning áhorfanda í beinni"
    content: |
        Skoðaðu SML skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/sml).
    lang: "is"
