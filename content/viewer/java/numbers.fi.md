...
############################# Head #############################
head_title: "Java NUMBERS Viewer API - Renderöi ja näytä NUMBERS Java-sovelluksissa"
head_description: "Tarkastele NUMBERS-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä NUMBERS Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn NUMBERS-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston NUMBERS renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa NUMBERS HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.

        * Lisää [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) projektisi riippuvuudeksi. 
        * Luo Viewer-luokan ilmentymä ja lataa NUMBERS tiedosto koko polulla. 
        * Aseta asetukset renderöidäksesi NUMBERS-tiedosto HTML-, PNG-, JPEG- tai PDF-muotoon. 
...
demos:
    enable: true
    title: "NUMBERS Viewerin live-demo"
    content: |
        Tarkastele tiedostoa NUMBERS heti käymällä [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/numbers) -sivustolla.
    lang: "fi"
