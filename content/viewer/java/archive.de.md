...
############################# Head #############################
head_title: "Java Archive Viewer API – Rendern und Anzeigen von Archive in Java-Apps"
head_description: "Sehen Sie sich Archive-Dateien in Java-, J2EE- und J2SE-Anwendungen an. Unterstützt die Anzeige von über 170 Dokument- und Bilddateiformaten im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung der Dokumentanzeigeoptionen."

############################# Header ############################
title: "Rendern und Anzeigen von Archive in Java" 
description: "Native und leistungsstarke Archive-Dateibetrachter-API für Java-, J2EE- und J2SE-basierte Anwendungen, die eine Vielzahl zusätzlicher Funktionen unterstützt, um das Erscheinungsbild des Ausgabedokumentformats anzupassen." 
...
steps:
    enable: true
    title_left: "Schritte zum Rendern der Archive-Datei in Java" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) können Sie Archive in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.

        * Fügen Sie [GroupDocs.Viewer für Java](https://releases.groupdocs.com/viewer/java/) als Abhängigkeit zu Ihrem Projekt hinzu. 
        * Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei Archive mit dem vollständigen Pfad. 
        * Legen Sie Optionen fest, um die Datei Archive im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
...
demos:
    ...
    content: |
        Sehen Sie sich die Datei Archive jetzt auf der Website von [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/archive) an.
    lang: "de"
