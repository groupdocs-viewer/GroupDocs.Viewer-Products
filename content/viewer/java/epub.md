...
steps:
    enable: true
    title_left: "Steps for View EPUB File in Java"
    content_left: |
        ...
        *   Set view options to convert EPUB file into PNG format.
...
demos:
    ...
    content: |
        Display EPUB file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
