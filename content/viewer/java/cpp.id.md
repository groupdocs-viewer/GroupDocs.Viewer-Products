...
############################# Head #############################
head_title: "Java CPP Viewer API - Render & Tampilkan CPP di Aplikasi Java"
head_description: "Lihat file CPP dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat CPP Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file CPP di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender CPP ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
