...
head_description: "View ML files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View ML In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render ML file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render ML to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render ML file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View ML file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ml) website.
    lang: "en"
