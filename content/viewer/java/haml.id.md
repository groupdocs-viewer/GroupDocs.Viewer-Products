...
############################# Head #############################
head_title: "Java HAML Viewer API - merender & menampilkan HAML di aplikasi Java"
head_description: "Lihat file HAML dalam aplikasi Java, J2EE, J2SE. Mendukung melihat 180+ format file dokumen dan gambar dalam mode HTML, PDF atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & lihat HAML di Java" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk merender file HAML di Java" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> Anda dapat merender HAML ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
