...
head_description: "View BZ2 files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View BZ2 In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render BZ2 file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render BZ2 to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render BZ2 file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View BZ2 file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/bz2) website.
    lang: "en"
