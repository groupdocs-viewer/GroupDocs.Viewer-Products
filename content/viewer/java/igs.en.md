...
head_description: "View IGS files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View IGS In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render IGS file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render IGS to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render IGS file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View IGS file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/igs) website.
    lang: "en"
