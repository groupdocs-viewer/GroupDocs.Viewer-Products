...
head_description: "View HAML files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View HAML In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render HAML file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render HAML to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render HAML file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View HAML file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/haml) website.
    lang: "en"
