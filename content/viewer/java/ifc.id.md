...
head_title: "Java IFC Viewer API - Render & Tampilan IFC di Aplikasi Java"
head_description: "Lihat file IFC di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File IFC di Java"
description: "API penampil file IFC asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File IFC di Java"
    content_left: |
        [GroupDocs.Viewer](viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file IFC di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file IFC dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file IFC ke format PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.ifc"))
        {
        	// Setel opsi tampilan
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa IFC"
    content: |
        Tampilkan file IFC sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
