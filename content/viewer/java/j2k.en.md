...
head_description: "View J2K files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View J2K In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render J2K file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render J2K to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render J2K file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View J2K file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/j2k) website.
    lang: "en"
