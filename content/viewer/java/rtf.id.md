...
############################# Head #############################
head_title: "Java RTF Viewer API - Render & Tampilkan RTF di Aplikasi Java"
head_description: "Lihat file RTF dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat RTF Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file RTF di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender RTF ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
