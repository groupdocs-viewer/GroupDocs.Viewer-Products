...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Просмотр документов в формате HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Растеризация документов](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/)"
    ...
    # feature loop
    - icon: "font"
      title: "[Управление шрифтами документа](https://docs.groupdocs.com/viewer/java/set-custom-fonts/)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Конвертировать в PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/)"
      content: "Документ любого поддерживаемого формата можно легко преобразовать и сохранить в PDF с настраиваемыми параметрами."

    # feature loop
    - icon: "transform"
      title: "[Применить преобразования](https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Настройка вывода HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Поддержка сложных структур документов](https://blog.groupdocs.com/viewer/view-files-and-folders-in-zip-and-tar-archives-using-java-api/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Варианты оптимизации](https://docs.groupdocs.com/viewer/java/how-to-use-custom-cache-implementation/)"
    ...
    - icon: "passwordprotected"
      title: "[Поддержка документов, защищенных паролем](https://docs.groupdocs.com/viewer/java/load-password-protected-document/)"
