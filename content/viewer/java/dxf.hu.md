...
############################# Head #############################
head_title: "Java DXF Viewer API – DXF renderelés és megjelenítése Java alkalmazásokban"
head_description: "Tekintse meg a DXF fájlokat Java, J2EE, J2SE alkalmazásokban. Támogatja a 170+ dokumentum- és képfájlformátum megtekintését HTML, PDF vagy kép módban, fejlett funkciókkal a dokumentummegtekintési beállítások kezeléséhez."

############################# Header ############################
title: "Render & View DXF Java nyelven" 
description: "Natív és nagy teljesítményű DXF fájlnézegető API Java, J2EE és J2SE alapú alkalmazásokhoz, amely számos további funkciót támogat a kimeneti dokumentumformátum megjelenésének testreszabásához." 
...
steps:
    enable: true
    title_left: "A DXF fájl renderelésének lépései a Java programban" 
    content_left: |
        A [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) segítségével néhány lépésben megjelenítheti a DXF fájlt HTML, JPEG, PNG vagy PDF formátumban.
