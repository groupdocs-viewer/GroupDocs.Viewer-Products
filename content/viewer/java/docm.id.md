...
############################# Head #############################
head_title: "Java DOCM Viewer API - merender & menampilkan DOCM di aplikasi Java"
head_description: "Lihat file DOCM dalam aplikasi Java, J2EE, J2SE. Mendukung melihat 180+ format file dokumen dan gambar dalam mode HTML, PDF atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."
...
steps:
    enable: true
    title: "Langkah-langkah untuk merender file DOCM di Java" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> Anda dapat merender DOCM ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
