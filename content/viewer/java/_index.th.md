...
overview:
  ...
  features:
    ...
    - title: "ดูเอกสารอย่างมีประสิทธิภาพและเชื่อถือได้"
      content: "ด้วย GroupDocs.Viewer API คุณสามารถแสดงผลเอกสารในรูปแบบที่รองรับทั้งหมดเป็น [HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/), [JPEG, PNG](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/), และ [PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/) ด้วยตัวเลือกที่ยืดหยุ่นและทรงพลัง ขณะเดียวกันคงรักษาเนื้อหาและโครงสร้างของเอกสารไว้ครบถ้วน GroupDocs.Viewer ทำงานบนแพลตฟอร์ม Windows และ Linux"
...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[ดูเอกสารในรูปแบบ HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
      content: "แปลงเอกสารทุกประเภทให้เป็นเอกสาร HTML ด้วย CSS และ SVG ซึ่งสามารถแสดงในเว็บเบราว์เซอร์สมัยใหม่"

    # feature loop
    - icon: "rasterize"
      title: "[แปลงเอกสารเป็นแรสเตอร์](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/)"
      content: "แรสเตอร์รูปแบบเอกสารที่รองรับให้เป็นภาพแรสเตอร์ พร้อมรูปแบบภาพที่ปรับได้และคุณภาพการบีบอัด"

    # feature loop
    - icon: "font"
      title: "[ควบคุมแบบอักษรเอกสาร](https://docs.groupdocs.com/viewer/java/set-custom-fonts/)"
      content: "ระบุแบบอักษรที่ใช้ในเอกสาร จัดการแบบอักษรที่หายไปโดยการแทนที่หรือคัดออกจากผลลัพธ์"

    # feature loop
    - icon: "convertpdf"
      title: "[แปลงเป็น PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/)"
      content: "เอกสารในรูปแบบที่รองรับสามารถแปลงและบันทึกเป็น PDF ได้อย่างง่ายดายพร้อมตัวเลือกที่ปรับได้"

    # feature loop
    - icon: "transform"
      title: "[ใช้การแปลง](https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[การปรับเอาต์พุต HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[รองรับโครงสร้างเอกสารที่ซับซ้อน](https://blog.groupdocs.com/viewer/view-files-and-folders-in-zip-and-tar-archives-using-java-api/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[ตัวเลือกการเพิ่มประสิทธิภาพ](https://docs.groupdocs.com/viewer/java/how-to-use-custom-cache-implementation/)"
    ...
    - icon: "passwordprotected"
      title: "[รองรับเอกสารที่มีการป้องกันด้วยรหัสผ่าน](https://docs.groupdocs.com/viewer/java/load-password-protected-document/)"
