...
steps:
    enable: true
    title_left: "Steps for View CDR File in Java"
    content_left: |
        ...
        *   Set view options to convert CDR file into PNG format.
...
demos:
    ...
    content: |
        Display CDR file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
