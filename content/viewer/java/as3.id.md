...
############################# Head #############################
head_title: "Java AS3 Viewer API - Render & Tampilkan AS3 di Aplikasi Java"
head_description: "Lihat file AS3 dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat AS3 Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file AS3 di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender AS3 ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
