...
############################# Head #############################
head_title: "Java FODS Viewer API - Render & Tampilkan FODS di Aplikasi Java"
head_description: "Lihat file FODS dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat FODS Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file FODS di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender FODS ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
