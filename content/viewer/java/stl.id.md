...
############################# Head #############################
head_title: "Java STL Viewer API - merender & menampilkan STL di aplikasi Java"
head_description: "Lihat file STL dalam aplikasi Java, J2EE, J2SE. Mendukung melihat 180+ format file dokumen dan gambar dalam mode HTML, PDF atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & lihat STL di Java" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk merender file STL di Java" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> Anda dapat merender STL ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
      ...
      2. Buat instance kelas Viewer dan muat file STL dengan path lengkap.  
      3. Tetapkan opsi untuk merender file STL ke dalam format HTML, PNG, JPEG, atau PDF. 
    ...
    code:
      ...
      content: |
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Render file STL ke HTML dengan sumber daya yang disematkan
