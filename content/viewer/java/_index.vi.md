...
overview:
  ...
  features:
    ...
    - title: "Xem tài liệu hiệu quả và đáng tin cậy"
      content: "Với API GroupDocs.Viewer, bạn có thể nhanh chóng chuyển đổi tài liệu ở bất kỳ định dạng nào hỗ trợ sang [HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/), [JPEG, PNG](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/), và [PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/) với các tùy chọn linh hoạt và mạnh mẽ, đồng thời duy trì tính toàn vẹn của nội dung và cấu trúc tài liệu. GroupDocs.Viewer hoạt động trên nền tảng Windows và Linux."
...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Xem tài liệu bằng HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Rasterize tài liệu](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/)"
    ...
    # feature loop
    - icon: "font"
      title: "[Kiểm soát phông chữ tài liệu](https://docs.groupdocs.com/viewer/java/set-custom-fonts/)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Chuyển đổi sang PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Áp dụng các phép biến đổi](https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Điều chỉnh đầu ra HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Hỗ trợ cấu trúc tài liệu phức tạp](https://blog.groupdocs.com/viewer/view-files-and-folders-in-zip-and-tar-archives-using-java-api/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Tùy chọn tối ưu hóa](https://docs.groupdocs.com/viewer/java/how-to-use-custom-cache-implementation/)"
    ...
    - icon: "passwordprotected"
      title: "[Hỗ trợ các tài liệu được bảo vệ bằng mật khẩu](https://docs.groupdocs.com/viewer/java/load-password-protected-document/)"
