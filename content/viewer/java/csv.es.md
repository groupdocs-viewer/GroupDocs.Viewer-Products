...
############################# Head #############################
head_title: "Java CSV API de visualización: renderiza y muestra CSV en aplicaciones Java"
head_description: "Ver archivos CSV en aplicaciones Java, J2EE, J2SE. Admite la visualización de más de 180 formatos de archivos de imágenes y documentos en HTML, PDF o modo de imagen con funciones avanzadas para administrar las opciones de visualización de documentos."

############################# Header ############################
title: "Renderizar y ver CSV en Java" 
description: "API de visualización de archivos CSV nativa y de alto rendimiento para aplicaciones basadas en Java, J2EE y J2SE, que admite una amplia gama de funciones adicionales para personalizar la apariencia del formato del documento de salida." 
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo CSV en Java" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> puedes renderizar CSV a HTML, JPEG, PNG o PDF en unos pocos pasos.
      ...
      2. Cree una instancia de la clase Viewer y cargue el archivo CSV con la ruta completa.  
      3. Configure opciones para representar el archivo CSV en formato HTML, PNG, JPEG o PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurar el archivo de entrada CSV
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Renderice el archivo CSV a HTML con recursos integrados
