...
############################# Head #############################
head_title: "Java DGN vaataja API – renderda ja kuva DGN Java rakendustes"
head_description: "Vaadake DGN faile Java, J2EE, J2SE rakendustes. Toetab 170+ dokumendi- ja pildifailivormingu vaatamist HTML-, PDF- või pildirežiimis koos täiustatud funktsioonidega dokumentide vaatamise valikute haldamiseks."

############################# Header ############################
title: "Renderda ja kuva DGN Javas" 
description: "Native ja suure jõudlusega DGN failivaaturi API Java-, J2EE- ja J2SE-põhiste rakenduste jaoks, mis toetab laia valikut lisafunktsioone väljunddokumendi vormingu välimuse kohandamiseks." 
...
steps:
    enable: true
    title_left: "Toimingud faili DGN renderdamiseks rakenduses Java" 
    content_left: |
        Rakendusega [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) saate mõne sammuga renderdada faili DGN HTML-, JPEG-, PNG- või PDF-vormingusse.
