...
############################# Head #############################
head_title: "Java JS áhorfandaforritaskil - birta og birta JS í Java forritum"
head_description: "Skoðaðu JS skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu JS í Java" 
description: "Innbyggt og afkastamikið JS skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera JS skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert JS í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið JS skránni með fullri slóð. 
        * Stilltu valkosti til að gera JS skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "JS Sýning áhorfanda í beinni"
    content: |
        Skoðaðu JS skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/js).
    lang: "is"
