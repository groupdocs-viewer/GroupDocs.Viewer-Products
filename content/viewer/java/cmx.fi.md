...
############################# Head #############################
head_title: "Java CMX Viewer API - Renderöi ja näytä CMX Java-sovelluksissa"
head_description: "Tarkastele CMX-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä CMX Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn CMX-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston CMX renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa CMX HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.
