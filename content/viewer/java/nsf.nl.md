...
############################# Head #############################
head_title: "Java NSF Viewer-API - NSF weergeven en weergeven in Java-apps"
head_description: "Bekijk NSF bestanden in Java-, J2EE-, J2SE-applicaties. Ondersteunt het bekijken van meer dan 170 document- en afbeeldingsbestandsindelingen in HTML-, PDF- of afbeeldingsmodus met geavanceerde functies om opties voor het bekijken van documenten te beheren."

############################# Header ############################
title: "Render en bekijk NSF in Java" 
description: "Native en krachtige NSF API voor bestandsviewer voor op Java, J2EE en J2SE gebaseerde applicaties, die een breed scala aan extra functies ondersteunt om het uiterlijk van het uitvoerdocumentformaat aan te passen." 
...
steps:
    enable: true
    title_left: "Stappen om NSF bestand weer te geven in Java" 
    content_left: |
        Met [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) kun je in een paar stappen NSF renderen naar HTML, JPEG, PNG of PDF.

        * Voeg [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) toe als afhankelijkheid van uw project. 
        * Maak een instantie van de klasse Viewer en laad het bestand NSF met het volledige pad. 
        * Stel opties in om NSF-bestanden weer te geven in HTML-, PNG-, JPEG- of PDF-indeling. 
...
demos:
    ...
    content: |
        Bekijk het NSF-bestand nu door naar de website [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/nsf) te gaan.
    lang: "nl"
