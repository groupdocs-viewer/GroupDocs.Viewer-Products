...
############################# Head #############################
head_title: "Java PPTM Viewer API - Render & Tampilkan PPTM di Aplikasi Java"
head_description: "Lihat file PPTM dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat PPTM Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file PPTM di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender PPTM ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
