...
draft: false
############################# Head ############################
head_title: "Java C Viewer API — рендеринг и отображение C в приложениях Java"
head_description: "Просмотр файлов C в приложениях Java, J2EE, J2SE. Поддерживает просмотр более 150 форматов файлов документов и изображений в формате HTML, PDF или изображения с расширенными функциями для управления параметрами просмотра документов."
############################# Header ############################
title: "Рендеринг и просмотр файла C в Java"
description: "Собственный и высокопроизводительный API-интерфейс просмотра файлов C для приложений на основе Java, J2EE и J2SE, поддерживающий широкий спектр дополнительных функций для настройки внешнего вида формата выходного документа."
bg_overlay: false
button:
    enable: true
...
steps:
    enable: true
    title_left: "Шаги для просмотра файла C в Java"
    content_left: |
        [GroupDocs.Viewer](/ru/viewer/java/) позволяет разработчикам Java легко добавлять функцию просмотра файлов C в свои приложения с помощью нескольких строк кода.
        * Создайте экземпляр класса Viewer и загрузите файл C с полным путем.
        * Установите параметры просмотра для преобразования файла C в формат PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.c"))
        {
...
demos:
    enable: true
    title: "C Viewer Живые демонстрации"
    content: |
        Отобразите файл C прямо сейчас, посетив веб-сайт [GroupDocs.Viewer Живые волнения](https://products.groupdocs.app/viewer/).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        # format loop
        - icon: "far fa-file-c"
          title: "О формате файла C"
          content: |
            Файл с расширением .c представляет собой файл исходного кода для написания программных приложений на языке программирования C. Файлы C включают в себя всю реализацию функциональности приложения в виде исходного кода. Объявление исходного кода записано в файлах заголовков, которые сохраняются с расширением .h. C++ — это современная форма языка C, которая в настоящее время используется для разработки большей части программного обеспечения. Файлы C можно открывать с помощью таких приложений, как Notepad++, Eclipse IDE, Microsoft Visual Studio и Borland C++ Builder.
