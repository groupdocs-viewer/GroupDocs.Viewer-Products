...
############################# Head #############################
head_title: "Java DOTX Viewer API - merender & menampilkan DOTX di aplikasi Java"
head_description: "Lihat file DOTX dalam aplikasi Java, J2EE, J2SE. Mendukung melihat 180+ format file dokumen dan gambar dalam mode HTML, PDF atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & lihat DOTX di Java" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk merender file DOTX di Java" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> Anda dapat merender DOTX ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
