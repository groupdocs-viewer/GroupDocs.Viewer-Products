...
############################# Head #############################
head_title: "Java Worksheet Viewer API - Rindreáil & Taispeáin Worksheet in Java Apps"
head_description: "Féach ar Worksheet comhad i bhfeidhmchláir Java, J2EE, J2SE. Tacaíonn sé le breathnú ar 170+ formáid doiciméad agus comhaid íomhá i mód HTML, PDF nó íomhá le hardghnéithe chun roghanna féachana doiciméad a bhainistiú."

############################# Header ############################
title: "Rindreáil & Féach ar Worksheet I Java" 
description: "API breathnóir comhad Worksheet dúchasach agus ardfheidhmíochta le haghaidh feidhmchláir bunaithe ar Java, J2EE agus J2SE, ag tacú le raon leathan gnéithe breise chun cuma na formáide doiciméid aschuir a shaincheapadh." 
...
steps:
    enable: true
    title_left: "Céimeanna chun comhad Worksheet a rindreáil in Java" 
    content_left: |
        Le [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) is féidir leat Worksheet a dhéanamh go HTML, JPEG, PNG nó PDF i gceann cúpla céim.

        * Cuir [GroupDocs.Viewer le haghaidh Java](https://releases.groupdocs.com/viewer/java/) mar spleáchas le do thionscadal. 
        * Cruthaigh sampla de rang Amharcóra agus lódáil an comhad Worksheet le cosán iomlán. 
        * Socraigh roghanna chun comhad Worksheet a chur i bhformáid HTML, PNG, JPEG nó PDF. 
...
demos:
    enable: true
    title: "Worksheet Taispeántas Amharcóra Beo"
    content: |
        Féach ar chomhad Worksheet faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/excel).
    lang: "ga"
