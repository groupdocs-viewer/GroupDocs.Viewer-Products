...
head_title: "Java BAT Viewer API - Render & Tampilan BAT di Aplikasi Java"
head_description: "Lihat file BAT di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File BAT di Java"
...
demos:
    ...
    content: |
        Tampilkan file BAT sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
