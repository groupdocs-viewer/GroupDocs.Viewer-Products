...
############################# Head #############################
head_title: "Java MPX Viewer API - Render & Tampilkan MPX di Aplikasi Java"
head_description: "Lihat file MPX dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat MPX Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file MPX di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender MPX ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file MPX ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "MPX Demo Langsung Pemirsa"
    content: |
        Lihat file MPX sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/mpx).
    lang: "id"
