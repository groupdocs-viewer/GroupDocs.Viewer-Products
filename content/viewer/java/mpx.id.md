...
head_title: "Java MPX Viewer API - Render & Tampilan MPX di Aplikasi Java"
head_description: "Lihat file MPX di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File MPX di Java"
description: "API penampil file MPX asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File MPX di Java"
    content_left: |
        [GroupDocs.Viewer](/viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file MPX di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file MPX dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file MPX ke format PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.mpx"))
        {
        	// Setel opsi tampilan
...
demos:
    ...
    content: |
        Tampilkan file MPX sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
