...
############################# Head #############################
head_title: "Java ONE Viewer API — renderowanie i wyświetlanie ONE w aplikacjach Java"
head_description: "Zobacz pliki ONE w aplikacjach Java, J2EE, J2SE. Obsługuje przeglądanie ponad 170 formatów dokumentów i plików obrazów w trybie HTML, PDF lub obrazu z zaawansowanymi funkcjami do zarządzania opcjami przeglądania dokumentów."

############################# Header ############################
title: "Renderuj i przeglądaj DOCX ONE w Javie" 
description: "Natywny i wydajny interfejs API przeglądarki plików ONE dla aplikacji opartych na językach Java, J2EE i J2SE, obsługujący szeroki zakres dodatkowych funkcji umożliwiających dostosowanie wyglądu formatu dokumentu wyjściowego." 
...
steps:
    enable: true
    title_left: "Kroki renderowania pliku ONE w Java" 
    content_left: |
        Dzięki [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) możesz w kilku krokach wyrenderować ONE do formatu HTML, JPEG, PNG lub PDF.

        * Dodaj [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) jako zależność do swojego projektu. 
        * Utwórz instancję klasy Viewer i załaduj plik ONE z pełną ścieżką. 
        * Ustaw opcje renderowania pliku ONE do formatu HTML, PNG, JPEG lub PDF. 
...
demos:
    enable: true
    title: "ONE Przeglądarka Demo na żywo"
    content: |
        Wyświetl teraz plik ONE, odwiedzając witrynę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/one).
    lang: "pl"
