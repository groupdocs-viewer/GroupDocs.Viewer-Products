...
############################# Head #############################
head_title: "Java HAML Viewer API - Rendering e visualizzazione HAML nelle app Java"
head_description: "Visualizza HAML file nelle applicazioni Java, J2EE, J2SE. Supporta la visualizzazione di oltre 170 formati di documenti e file immagine in modalità HTML, PDF o immagine con funzionalità avanzate per gestire le opzioni di visualizzazione dei documenti."

############################# Header ############################
title: "Visualizza e visualizza HAML in Java" 
description: "API del visualizzatore di file HAML nativa e ad alte prestazioni per applicazioni basate su Java, J2EE e J2SE, che supporta un'ampia gamma di funzionalità aggiuntive per personalizzare l'aspetto del formato del documento di output." 
...
steps:
    enable: true
    title_left: "Passaggi per eseguire il rendering del file HAML in Java" 
    content_left: |
        Con [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) puoi eseguire il rendering di HAML in HTML, JPEG, PNG o PDF in pochi passaggi.

        * Aggiungi [GroupDocs.Viewer per Java](https://releases.groupdocs.com/viewer/java/) come dipendenza al tuo progetto. 
        * Crea un'istanza della classe Viewer e carica il file HAML con il percorso completo. 
        * Imposta le opzioni per rendere il file HAML in formato HTML, PNG, JPEG o PDF. 
...
demos:
    enable: true
    title: "HAML Demo dal vivo dello spettatore"
    content: |
        Visualizza subito il file HAML visitando il sito web di [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/haml).
    lang: "it"
