...
############################# Head #############################
head_title: "Java Presentation Viewer API - Renderöi ja näytä Presentation Java-sovelluksissa"
head_description: "Tarkastele Presentation-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä Presentation Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn Presentation-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston Presentation renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa Presentation HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.

        * Lisää [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) projektisi riippuvuudeksi. 
        * Luo Viewer-luokan ilmentymä ja lataa Presentation tiedosto koko polulla. 
        * Aseta asetukset renderöidäksesi Presentation-tiedosto HTML-, PNG-, JPEG- tai PDF-muotoon. 
...
demos:
    enable: true
    title: "Presentation Viewerin live-demo"
    content: |
        Tarkastele tiedostoa Presentation heti käymällä [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/powerpoint) -sivustolla.
    lang: "fi"
