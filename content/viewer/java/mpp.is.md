...
############################# Head #############################
head_title: "Java MPP áhorfandaforritaskil - birta og birta MPP í Java forritum"
head_description: "Skoðaðu MPP skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu MPP í Java" 
description: "Innbyggt og afkastamikið MPP skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera MPP skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert MPP í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið MPP skránni með fullri slóð. 
        * Stilltu valkosti til að gera MPP skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "MPP Sýning áhorfanda í beinni"
    content: |
        Skoðaðu MPP skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/mpp).
    lang: "is"
