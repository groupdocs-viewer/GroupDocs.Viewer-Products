...
############################# Head #############################
head_title: "Java HAML Viewer API - Rindreáil & Taispeáin HAML in Java Apps"
head_description: "Féach ar HAML comhad i bhfeidhmchláir Java, J2EE, J2SE. Tacaíonn sé le breathnú ar 170+ formáid doiciméad agus comhaid íomhá i mód HTML, PDF nó íomhá le hardghnéithe chun roghanna féachana doiciméad a bhainistiú."

############################# Header ############################
title: "Rindreáil & Féach ar HAML I Java" 
description: "API breathnóir comhad HAML dúchasach agus ardfheidhmíochta le haghaidh feidhmchláir bunaithe ar Java, J2EE agus J2SE, ag tacú le raon leathan gnéithe breise chun cuma na formáide doiciméid aschuir a shaincheapadh." 
...
steps:
    enable: true
    title_left: "Céimeanna chun comhad HAML a rindreáil in Java" 
    content_left: |
        Le [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) is féidir leat HAML a dhéanamh go HTML, JPEG, PNG nó PDF i gceann cúpla céim.

        * Cuir [GroupDocs.Viewer le haghaidh Java](https://releases.groupdocs.com/viewer/java/) mar spleáchas le do thionscadal. 
        * Cruthaigh sampla de rang Amharcóra agus lódáil an comhad HAML le cosán iomlán. 
        * Socraigh roghanna chun comhad HAML a chur i bhformáid HTML, PNG, JPEG nó PDF. 
...
demos:
    enable: true
    title: "HAML Taispeántas Amharcóra Beo"
    content: |
        Féach ar chomhad HAML faoi láthair trí chuairt a thabhairt ar an suíomh Gréasáin [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/haml).
    lang: "ga"
