...
############################# Head #############################
head_title: "Java vCard Viewer API - Renderöi ja näytä vCard Java-sovelluksissa"
head_description: "Tarkastele vCard-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä vCard Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn vCard-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston vCard renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa vCard HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.

        * Lisää [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) projektisi riippuvuudeksi. 
        * Luo Viewer-luokan ilmentymä ja lataa vCard tiedosto koko polulla. 
        * Aseta asetukset renderöidäksesi vCard-tiedosto HTML-, PNG-, JPEG- tai PDF-muotoon. 
...
demos:
    enable: true
    title: "vCard Viewerin live-demo"
    content: |
        Tarkastele tiedostoa vCard heti käymällä [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/vcf) -sivustolla.
    lang: "fi"
