...
draft: false
############################# Head ############################
head_title: "Java OneNote Viewer API — рендеринг и отображение OneNote в приложениях Java"
head_description: "Просматривайте файлы OneNote в приложениях Java, J2EE, J2SE. Поддерживает просмотр более 150 форматов файлов документов и изображений в формате HTML, PDF или изображения с расширенными функциями для управления параметрами просмотра документов."
############################# Header ############################
title: "Рендеринг и просмотр файла OneNote в Java"
description: "Встроенный и высокопроизводительный API-интерфейс OneNote для просмотра файлов для приложений на основе Java, J2EE и J2SE, поддерживающий широкий спектр дополнительных функций для настройки внешнего вида формата выходного документа."
bg_overlay: false
button:
    enable: true
...
steps:
    enable: true
    title_left: "Шаги для просмотра файла OneNote в Java"
    content_left: |
        [GroupDocs.Viewer](/ru/viewer/java/) позволяет разработчикам Java легко добавлять функцию просмотра файлов OneNote в свои приложения с помощью нескольких строк кода.
        * Создайте экземпляр класса Viewer и загрузите ОДИН файл с полным путем.
        * Установите параметры просмотра, чтобы преобразовать ОДИН файл в формат PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.one"))
        {
...
demos:
    enable: true
    title: "Интерактивные демонстрации OneNote Viewer"
    content: |
        Отобразите файл OneNote прямо сейчас, посетив веб-сайт [GroupDocs.Viewer Живые волнения](https://products.groupdocs.app/viewer/).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        ...
        - icon: "far fa-sticky-note-o"
          ...
          content: |
            Файлы программы создания заметок содержат разделы и страницы для хранения заметок. Документ заметки может быть как простым текстовым документом, так и более подробным, состоящим из цифровых изображений, аудио/видеоклипов и рисунков от руки. Распространенные расширения файлов OneNote и связанные с ними форматы файлов включают .ONE и файл с оглавлением .ONETOC2.
