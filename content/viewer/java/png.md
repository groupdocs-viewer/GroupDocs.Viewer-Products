...
steps:
    enable: true
    title_left: "Steps for View PNG File in Java"
    content_left: |
        ...
        *   Set view options to convert PNG file into PNG format.
...
demos:
    ...
    content: |
        Display PNG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
