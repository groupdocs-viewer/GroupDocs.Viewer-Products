...
############################# Head #############################
head_title: "Java DOC Viewer API - upodabljanje in prikaz DOC v aplikacijah Java"
head_description: "Oglejte si datoteke DOC v aplikacijah Java, J2EE, J2SE. Podpira ogled več kot 170 formatov dokumentov in slikovnih datotek v HTML, PDF ali slikovnem načinu z naprednimi funkcijami za upravljanje možnosti ogledovanja dokumentov."

############################# Header ############################
title: "Upodabljanje in ogled DOC v Javi" 
description: "Izvorni in visoko zmogljiv API pregledovalnika datotek DOC za aplikacije, ki temeljijo na Javi, J2EE in J2SE, podpira širok nabor dodatnih funkcij za prilagajanje videza oblike izhodnega dokumenta." 
...
steps:
    enable: true
    title_left: "Koraki za upodabljanje datoteke DOC v Java" 
    content_left: |
        Z [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) lahko v nekaj korakih upodobite DOC v HTML, JPEG, PNG ali PDF.

        * Dodajte [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) kot odvisnost od svojega projekta. 
        * Ustvarite primerek razreda Viewer in naložite datoteko DOC s celotno potjo. 
        * Nastavite možnosti za upodabljanje datoteke DOC v formatu HTML, PNG, JPEG ali PDF. 
...
demos:
    ...
    content: |
        Takoj si oglejte datoteko DOC tako, da obiščete spletno mesto [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/doc).
    lang: "sl"
