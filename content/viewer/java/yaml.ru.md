...
draft: false
############################# Head ############################
head_title: "Java YAML Viewer API — рендеринг и отображение YAML в приложениях Java"
head_description: "Просмотр файлов YAML в приложениях Java, J2EE, J2SE. Поддерживает просмотр более 150 форматов файлов документов и изображений в формате HTML, PDF или изображения с расширенными функциями для управления параметрами просмотра документов."
############################# Header ############################
title: "Рендеринг и просмотр файла YAML в Java"
description: "Встроенный и высокопроизводительный API-интерфейс просмотра файлов YAML для приложений на основе Java, J2EE и J2SE, поддерживающий широкий спектр дополнительных функций для настройки внешнего вида формата выходного документа."
bg_overlay: false
button:
    enable: true
...
steps:
    enable: true
    title_left: "Шаги для просмотра файла YAML в Java"
    content_left: |
        [GroupDocs.Viewer](/ru/viewer/java/) позволяет разработчикам Java легко добавлять функцию просмотра файлов YAML в свои приложения с помощью нескольких строк кода.
        * Создайте экземпляр класса Viewer и загрузите файл YAML с полным путем.
        * Установите параметры просмотра для преобразования файла YAML в формат PNG.
...
demos:
    enable: true
    title: "Демонстрации YAML Viewer в реальном времени"
    content: |
        Отобразите файл YAML прямо сейчас, посетив веб-сайт [GroupDocs.Viewer Живые волнения](https://products.groupdocs.app/viewer/).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        ...
        - icon: "far fa-file-yaml"
          title: "О формате файла YAML"
          content: |
            YAML (YAML — это не язык разметки) — это язык сериализации данных на основе Unicode, который используется для файлов конфигурации, обмена сообщениями в Интернете, сохранения объектов и т. д. YAML использует расширение .yaml для своих файлов. YAML был разработан, чтобы хорошо работать с современными языками программирования.
