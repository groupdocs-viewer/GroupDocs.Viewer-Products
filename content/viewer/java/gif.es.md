...
############################# Head #############################
head_title: "Java GIF API de visualización: renderiza y muestra GIF en aplicaciones Java"
head_description: "Ver archivos GIF en aplicaciones Java, J2EE, J2SE. Admite la visualización de más de 180 formatos de archivos de imágenes y documentos en HTML, PDF o modo de imagen con funciones avanzadas para administrar las opciones de visualización de documentos."

############################# Header ############################
title: "Renderizar y ver GIF en Java" 
description: "API de visualización de archivos GIF nativa y de alto rendimiento para aplicaciones basadas en Java, J2EE y J2SE, que admite una amplia gama de funciones adicionales para personalizar la apariencia del formato del documento de salida." 
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo GIF en Java" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> puedes renderizar GIF a HTML, JPEG, PNG o PDF en unos pocos pasos.
      ...
      2. Cree una instancia de la clase Viewer y cargue el archivo GIF con la ruta completa.  
      3. Configure opciones para representar el archivo GIF en formato HTML, PNG, JPEG o PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurar el archivo de entrada GIF
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Renderice el archivo GIF a HTML con recursos integrados
