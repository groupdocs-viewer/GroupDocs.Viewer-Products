...
steps:
    enable: true
    title_left: "Steps for View DOCX File in Java"
    content_left: |
...
demos:
    ...
    content: |
        Display DOCX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
