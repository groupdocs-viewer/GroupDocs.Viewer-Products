...
############################# Head #############################
head_title: "Java VDW API Viewer - renderizar e exibir VDW em aplicativos Java"
head_description: "Visualize arquivos VDW em aplicativos Java, J2EE, J2SE. Suporta a visualização de mais de 180 formatos de documentos e arquivos de imagem em HTML, PDF ou modo de imagem com recursos avançados para gerenciar opções de visualização de documentos."

############################# Header ############################
title: "Renderizar e visualizar VDW em Java" 
description: "API visualizadora de arquivos VDW nativa e de alto desempenho para aplicativos baseados em Java, J2EE e J2SE, suportando uma ampla gama de recursos adicionais para personalizar a aparência do formato do documento de saída." 
...
steps:
    enable: true
    title: "Etapas para renderizar o arquivo VDW em Java" 
    content: |
      Com <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> você pode renderizar VDW para HTML, JPEG, PNG ou PDF em algumas etapas.
      ...
      2. Crie uma instância da classe Viewer e carregue o arquivo VDW com caminho completo.  
      3. Defina opções para renderizar o arquivo VDW em formato HTML, PNG, JPEG ou PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurar arquivo de entrada VDW
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Renderize o arquivo VDW em HTML com recursos incorporados
