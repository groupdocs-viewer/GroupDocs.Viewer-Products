...
############################# Head #############################
head_title: "Java Spreadsheet vaataja API – renderda ja kuva Spreadsheet Java rakendustes"
head_description: "Vaadake Spreadsheet faile Java, J2EE, J2SE rakendustes. Toetab 170+ dokumendi- ja pildifailivormingu vaatamist HTML-, PDF- või pildirežiimis koos täiustatud funktsioonidega dokumentide vaatamise valikute haldamiseks."

############################# Header ############################
title: "Renderda ja kuva Spreadsheet Javas" 
description: "Native ja suure jõudlusega Spreadsheet failivaaturi API Java-, J2EE- ja J2SE-põhiste rakenduste jaoks, mis toetab laia valikut lisafunktsioone väljunddokumendi vormingu välimuse kohandamiseks." 
...
steps:
    enable: true
    title_left: "Toimingud faili Spreadsheet renderdamiseks rakenduses Java" 
    content_left: |
        Rakendusega [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) saate mõne sammuga renderdada faili Spreadsheet HTML-, JPEG-, PNG- või PDF-vormingusse.

        * Lisage [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) oma projekti sõltuvusena. 
        * Looge Vieweri klassi eksemplar ja laadige fail Spreadsheet kogu teega. 
        * Määrake suvandid faili Spreadsheet renderdamiseks HTML-, PNG-, JPEG- või PDF-vormingusse. 
...
demos:
    enable: true
    title: "Spreadsheet vaataja reaalajas demo"
    content: |
        Vaadake kohe faili Spreadsheet, külastades veebisaiti [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/excel).
    lang: "et"
