...
############################# Head #############################
head_title: "Java HH Viewer API – Rendern und Anzeigen von HH in Java-Apps"
head_description: "Sehen Sie sich HH-Dateien in Java-, J2EE- und J2SE-Anwendungen an. Unterstützt die Anzeige von über 170 Dokument- und Bilddateiformaten im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung der Dokumentanzeigeoptionen."

############################# Header ############################
title: "Rendern und Anzeigen von HH in Java" 
description: "Native und leistungsstarke HH-Dateibetrachter-API für Java-, J2EE- und J2SE-basierte Anwendungen, die eine Vielzahl zusätzlicher Funktionen unterstützt, um das Erscheinungsbild des Ausgabedokumentformats anzupassen." 
...
steps:
    enable: true
    title_left: "Schritte zum Rendern der HH-Datei in Java" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) können Sie HH in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.

        * Fügen Sie [GroupDocs.Viewer für Java](https://releases.groupdocs.com/viewer/java/) als Abhängigkeit zu Ihrem Projekt hinzu. 
        * Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei HH mit dem vollständigen Pfad. 
        * Legen Sie Optionen fest, um die Datei HH im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
...
demos:
    ...
    content: |
        Sehen Sie sich die Datei HH jetzt auf der Website von [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/hh) an.
    lang: "de"
