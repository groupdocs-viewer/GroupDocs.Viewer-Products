...
############################# Head #############################
head_title: "Java VSDM Viewer API - Render & Tampilkan VSDM di Aplikasi Java"
head_description: "Lihat file VSDM dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat VSDM Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file VSDM di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender VSDM ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
