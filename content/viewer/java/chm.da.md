...
############################# Head #############################
head_title: "Java CHM Viewer API - Gengivelse og visning CHM i Java Apps"
head_description: "Se CHM filer i Java, J2EE, J2SE applikationer. Understøtter visning af mere end 170 dokument- og billedfilformater i HTML-, PDF- eller billedtilstand med avancerede funktioner til at administrere dokumentvisningsmuligheder."

############################# Header ############################
title: "Gengiv og vis CHM i Java" 
description: "Indbygget og højtydende CHM-filfremviser-API til Java-, J2EE- og J2SE-baserede applikationer, der understøtter en lang række yderligere funktioner til at tilpasse udseendet af outputdokumentformatet." 
...
steps:
    enable: true
    title_left: "Trin til gengivelse af CHM-fil i Java" 
    content_left: |
        Med [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) kan du gengive CHM til HTML, JPEG, PNG eller PDF i nogle få trin.

        * Tilføj [GroupDocs.Viewer til Java](https://releases.groupdocs.com/viewer/java/) som en afhængighed til dit projekt. 
        * Opret en forekomst af Viewer-klassen og indlæs CHM-filen med fuld sti. 
        * Indstil muligheder for at gengive filen CHM til HTML-, PNG-, JPEG- eller PDF-format. 
...
demos:
    ...
    title: "CHM Live-demo"
    content: |
        Se filen CHM lige nu ved at besøge webstedet [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/chm).
    lang: "da"
