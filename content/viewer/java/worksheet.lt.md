...
############################# Head #############################
head_title: "„Java“ Worksheet peržiūros programos API – atvaizduokite ir rodykite Worksheet „Java Apps“."
head_description: "Peržiūrėkite Worksheet failus Java, J2EE, J2SE programose. Palaiko 170+ dokumentų ir vaizdo failų formatų peržiūrą HTML, PDF arba vaizdo režimu su pažangiomis funkcijomis, leidžiančiomis valdyti dokumentų peržiūros parinktis."

############################# Header ############################
title: "Pateikti ir peržiūrėti Worksheet Java" 
description: "Savoji ir didelio našumo Worksheet failų peržiūros programa, skirta Java, J2EE ir J2SE pagrįstoms programoms, palaikanti daugybę papildomų funkcijų, leidžiančių tinkinti išvesties dokumento formato išvaizdą." 
...
steps:
    enable: true
    title_left: "Veiksmai, kaip pateikti Worksheet failą Java" 
    content_left: |
        Naudodami [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) atlikdami kelis veiksmus galite pateikti Worksheet į HTML, JPEG, PNG arba PDF.

        * Pridėkite [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) kaip projekto priklausomybę. 
        * Sukurkite Viewer klasės egzempliorių ir įkelkite failą Worksheet su visu keliu. 
        * Nustatykite parinktis, kaip pateikti Worksheet failą HTML, PNG, JPEG arba PDF formatu. 
...
demos:
    enable: true
    title: "Worksheet žiūrovo tiesioginė demonstracija"
    content: |
        Peržiūrėkite Worksheet failą dabar apsilankę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/excel) svetainėje.
    lang: "lt"
