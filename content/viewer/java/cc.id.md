...
############################# Head #############################
head_title: "Java CC Viewer API - merender & menampilkan CC di aplikasi Java"
head_description: "Lihat file CC dalam aplikasi Java, J2EE, J2SE. Mendukung melihat 180+ format file dokumen dan gambar dalam mode HTML, PDF atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & lihat CC di Java" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk merender file CC di Java" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> Anda dapat merender CC ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
      ...
      2. Buat instance kelas Viewer dan muat file CC dengan path lengkap.  
      3. Tetapkan opsi untuk merender file CC ke dalam format HTML, PNG, JPEG, atau PDF. 
    ...
    code:
      ...
      content: |
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Render file CC ke HTML dengan sumber daya yang disematkan
