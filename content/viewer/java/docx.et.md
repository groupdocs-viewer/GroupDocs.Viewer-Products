...
############################# Head #############################
head_title: "Java DOCX vaataja API – renderda ja kuva DOCX Java rakendustes"
head_description: "Vaadake DOCX faile Java, J2EE, J2SE rakendustes. Toetab 170+ dokumendi- ja pildifailivormingu vaatamist HTML-, PDF- või pildirežiimis koos täiustatud funktsioonidega dokumentide vaatamise valikute haldamiseks."

############################# Header ############################
title: "Renderda ja kuva DOCX Javas" 
description: "Native ja suure jõudlusega DOCX failivaaturi API Java-, J2EE- ja J2SE-põhiste rakenduste jaoks, mis toetab laia valikut lisafunktsioone väljunddokumendi vormingu välimuse kohandamiseks." 
...
steps:
    enable: true
    title_left: "Toimingud faili DOCX renderdamiseks rakenduses Java" 
    content_left: |
        Rakendusega [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) saate mõne sammuga renderdada faili DOCX HTML-, JPEG-, PNG- või PDF-vormingusse.
