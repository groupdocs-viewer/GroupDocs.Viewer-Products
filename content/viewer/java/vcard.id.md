...
head_title: "Java VCARD Viewer API - Render & Tampilan VCARD di Aplikasi Java"
head_description: "Lihat file VCARD di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File VCARD di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File VCARD di Java"
    content_left: |
        [GroupDocs.Viewer](viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file VCARD di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file VCARD dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file VCARD ke format PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.vcard"))
        {
        	// Setel opsi tampilan
...
demos:
    ...
    content: |
        Tampilkan file VCARD sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
