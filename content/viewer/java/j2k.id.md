...
############################# Head #############################
head_title: "Java J2K Viewer API - Render & Tampilkan J2K di Aplikasi Java"
head_description: "Lihat file J2K dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat J2K Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file J2K di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender J2K ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
