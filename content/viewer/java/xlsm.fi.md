...
############################# Head #############################
head_title: "Java XLSM Viewer API - Renderöi ja näytä XLSM Java-sovelluksissa"
head_description: "Tarkastele XLSM-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä XLSM Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn XLSM-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston XLSM renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa XLSM HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.

        * Lisää [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) projektisi riippuvuudeksi. 
        * Luo Viewer-luokan ilmentymä ja lataa XLSM tiedosto koko polulla. 
        * Aseta asetukset renderöidäksesi XLSM-tiedosto HTML-, PNG-, JPEG- tai PDF-muotoon. 
...
demos:
    enable: true
    title: "XLSM Viewerin live-demo"
    content: |
        Tarkastele tiedostoa XLSM heti käymällä [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/xlsm) -sivustolla.
    lang: "fi"
