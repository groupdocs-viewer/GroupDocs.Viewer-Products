...
head_description: "View OneNote files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View OneNote In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render OneNote file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render OneNote to HTML, JPEG, PNG or PDF in a few steps.

        * Add [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) as a dependency to your project. 
        * Create an instance of Viewer class and load the OneNote file with full path. 
        * Set options to render OneNote file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View OneNote file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/one) website.
    lang: "en"
