...
############################# Head #############################
head_title: "Java Worksheet Viewer API - Render & Tampilkan Worksheet di Aplikasi Java"
head_description: "Lihat file Worksheet dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat Worksheet Di Java" 
description: "API penampil file Worksheet asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file Worksheet di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender Worksheet ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.

        * Tambahkan [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) sebagai dependensi ke project Anda. 
        * Buat instance kelas Viewer dan muat file Worksheet dengan path lengkap. 
        * Setel opsi untuk merender file Worksheet ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "Worksheet Demo Langsung Pemirsa"
    content: |
        Lihat file Worksheet sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/excel).
    lang: "id"
