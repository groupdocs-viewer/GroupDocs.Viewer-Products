...
############################# Head #############################
head_title: "Java Worksheet Viewer API - merender & menampilkan Worksheet di aplikasi Java"
head_description: "Lihat file Worksheet dalam aplikasi Java, J2EE, J2SE. Mendukung melihat 180+ format file dokumen dan gambar dalam mode HTML, PDF atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."
...
steps:
    enable: true
    title: "Langkah-langkah untuk merender file Worksheet di Java" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> Anda dapat merender Worksheet ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
      ...
      2. Buat instance kelas Viewer dan muat file Worksheet dengan path lengkap.  
      3. Tetapkan opsi untuk merender file Worksheet ke dalam format HTML, PNG, JPEG, atau PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Siapkan file masukan Worksheet
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Render file Worksheet ke HTML dengan sumber daya yang disematkan
