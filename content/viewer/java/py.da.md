...
############################# Head #############################
head_title: "Java PY Viewer API - Gengivelse og visning PY i Java Apps"
head_description: "Se PY filer i Java, J2EE, J2SE applikationer. Understøtter visning af mere end 170 dokument- og billedfilformater i HTML-, PDF- eller billedtilstand med avancerede funktioner til at administrere dokumentvisningsmuligheder."

############################# Header ############################
title: "Gengiv og vis PY i Java" 
description: "Indbygget og højtydende PY-filfremviser-API til Java-, J2EE- og J2SE-baserede applikationer, der understøtter en lang række yderligere funktioner til at tilpasse udseendet af outputdokumentformatet." 
...
steps:
    enable: true
    title_left: "Trin til gengivelse af PY-fil i Java" 
    content_left: |
        Med [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) kan du gengive PY til HTML, JPEG, PNG eller PDF i nogle få trin.

        * Tilføj [GroupDocs.Viewer til Java](https://releases.groupdocs.com/viewer/java/) som en afhængighed til dit projekt. 
        * Opret en forekomst af Viewer-klassen og indlæs PY-filen med fuld sti. 
        * Indstil muligheder for at gengive filen PY til HTML-, PNG-, JPEG- eller PDF-format. 
...
demos:
    ...
    title: "PY Live-demo"
    content: |
        Se filen PY lige nu ved at besøge webstedet [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/py).
    lang: "da"
