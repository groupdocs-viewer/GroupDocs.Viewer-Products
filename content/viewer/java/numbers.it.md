...
############################# Head #############################
head_title: "API visualizzatore Java NUMBERS: rendering e visualizzazione di NUMBERS nelle app Java"
head_description: "Visualizza file NUMBERS nelle applicazioni Java, J2EE, J2SE. Supporta la visualizzazione di oltre 180 formati di documenti e file immagine in modalità HTML, PDF o immagine con funzionalità avanzate per gestire le opzioni di visualizzazione dei documenti."

############################# Header ############################
title: "Esegui il rendering e visualizza NUMBERS in Java" 
description: "API di visualizzazione file NUMBERS nativa e ad alte prestazioni per applicazioni basate su Java, J2EE e J2SE, che supporta un'ampia gamma di funzionalità aggiuntive per personalizzare l'aspetto del formato del documento di output." 
...
steps:
    enable: true
    title: "Passaggi per eseguire il rendering del file NUMBERS in Java" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> puoi eseguire il rendering di NUMBERS in HTML, JPEG, PNG o PDF in pochi passaggi.
      
      1. Aggiungi <a href='https://releases.groupdocs.com/viewer/java/'>GroupDocs.Viewer for Java</a> come dipendenza al tuo progetto. 
      2. Crea un'istanza della classe Viewer e carica il file NUMBERS con il percorso completo.  
      3. Imposta le opzioni per eseguire il rendering del file NUMBERS nel formato HTML, PNG, JPEG o PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configura il file di input NUMBERS
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Visualizza il file NUMBERS in HTML con risorse incorporate
