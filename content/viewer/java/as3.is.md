...
############################# Head #############################
head_title: "Java AS3 áhorfandaforritaskil - birta og birta AS3 í Java forritum"
head_description: "Skoðaðu AS3 skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu AS3 í Java" 
description: "Innbyggt og afkastamikið AS3 skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera AS3 skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert AS3 í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið AS3 skránni með fullri slóð. 
        * Stilltu valkosti til að gera AS3 skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "AS3 Sýning áhorfanda í beinni"
    content: |
        Skoðaðu AS3 skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/as3).
    lang: "is"
