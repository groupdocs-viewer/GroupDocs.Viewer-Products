...
############################# Head #############################
head_title: "Java PPS Viewer API - Render & Tampilkan PPS di Aplikasi Java"
head_description: "Lihat file PPS dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat PPS Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file PPS di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender PPS ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
