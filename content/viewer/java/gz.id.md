...
############################# Head #############################
head_title: "Java GZ Viewer API - Render & Tampilkan GZ di Aplikasi Java"
head_description: "Lihat file GZ dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file GZ di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender GZ ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
