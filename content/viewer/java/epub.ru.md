...
############################# Head #############################
head_title: "API Java EPUB Viewer – рендеринг и отображение EPUB в приложениях Java"
head_description: "Просмотр файлов EPUB в приложениях Java, J2EE, J2SE. Поддерживает просмотр более 180 форматов документов и изображений в режиме HTML, PDF или изображений, а также расширенные функции для управления параметрами просмотра документов."

############################# Header ############################
title: "Рендеринг и просмотр EPUB в Java" 
description: "Собственный высокопроизводительный API-интерфейс просмотра файлов EPUB для приложений на базе Java, J2EE и J2SE, поддерживающий широкий спектр дополнительных функций для настройки внешнего вида формата выходного документа." 
...
steps:
    enable: true
    title: "Действия по рендерингу файла EPUB в Java" 
    content: |
      С помощью <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> вы можете преобразовать EPUB в HTML, JPEG, PNG или PDF за несколько шагов.
      ...
      2. Создайте экземпляр класса Viewer и загрузите файл EPUB с полным путем.  
      3. Установите параметры для преобразования файла EPUB в формат HTML, PNG, JPEG или PDF. 
    ...
    code:
      ...
      content: |
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Преобразовать файл EPUB в HTML со встроенными ресурсами.
