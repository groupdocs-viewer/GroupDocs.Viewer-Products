...
############################# Head #############################
head_title: "Java MPT Viewer API - Render & Tampilkan MPT di Aplikasi Java"
head_description: "Lihat file MPT dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat MPT Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file MPT di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender MPT ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file MPT ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "MPT Demo Langsung Pemirsa"
    content: |
        Lihat file MPT sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/mpt).
    lang: "id"
