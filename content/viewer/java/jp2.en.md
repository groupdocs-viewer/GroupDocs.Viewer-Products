...
head_description: "View JP2 files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View JP2 In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render JP2 file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render JP2 to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render JP2 file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View JP2 file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/jp2) website.
    lang: "en"
