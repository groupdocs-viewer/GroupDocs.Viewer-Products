...
############################# Head #############################
head_title: "Java ICO Viewer API - Procesar y mostrar ICO en aplicaciones Java"
head_description: "Ver archivos ICO en aplicaciones Java, J2EE, J2SE. Admite la visualización de más de 170 formatos de archivos de imágenes y documentos en HTML, PDF o modo de imagen con funciones avanzadas para administrar las opciones de visualización de documentos."

############################# Header ############################
title: "Renderizar y ver ICO en Java" 
description: "API de visor de archivos ICO nativa y de alto rendimiento para aplicaciones basadas en Java, J2EE y J2SE, que admite una amplia gama de características adicionales para personalizar la apariencia del formato del documento de salida." 
...
steps:
    enable: true
    title_left: "Pasos para procesar el archivo ICO en Java" 
    content_left: |
        Con [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) puede representar ICO a HTML, JPEG, PNG o PDF en unos pocos pasos.

        * Agregue [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) como una dependencia de su proyecto. 
        * Cree una instancia de la clase Viewer y cargue el archivo ICO con la ruta completa. 
        * Configure las opciones para representar el archivo ICO en formato HTML, PNG, JPEG o PDF. 
...
demos:
    enable: true
    title: "ICO Espectador de demostración en vivo"
    content: |
        Vea el archivo ICO ahora mismo visitando el sitio web de [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ico).
    lang: "es"
