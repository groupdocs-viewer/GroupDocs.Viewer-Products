...
head_title: "Java JSON Viewer API - Render & Tampilan JSON di Aplikasi Java"
head_description: "Lihat file JSON di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File JSON di Java"
description: "API penampil file JSON asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File JSON di Java"
    content_left: |
        [GroupDocs.Viewer](viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file JSON di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file JSON dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file JSON ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa JSON"
    content: |
        Tampilkan file JSON sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
