...
############################# Head #############################
head_title: "Java ODP Görüntüleyici API'si - Java Uygulamalarında ODP Oluşturun ve Görüntüleyin"
head_description: "ODP dosyalarını Java, J2EE, J2SE uygulamalarında görüntüleyin. Belge görüntüleme seçeneklerini yönetmek için gelişmiş özelliklerle HTML, PDF veya görüntü modunda 170'den fazla belge ve görüntü dosyası formatını görüntülemeyi destekler."

############################# Header ############################
title: "Java'da ODP Oluşturun ve Görüntüleyin" 
description: "Java, J2EE ve J2SE tabanlı uygulamalar için yerel ve yüksek performanslı ODP dosya görüntüleyici API'si, çıktı belge biçiminin görünümünü özelleştirmek için çok çeşitli ek özellikleri destekler." 
...
steps:
    enable: true
    title_left: "ODP dosyasını Java içinde Oluşturma Adımları" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) ile ODP dosyasını birkaç adımda HTML, JPEG, PNG veya PDF'ye dönüştürebilirsiniz.

        * Projenize bir bağımlılık olarak [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) ekleyin. 
        * Viewer sınıfının bir örneğini oluşturun ve ODP dosyasını tam yolla yükleyin. 
        * ODP dosyasını HTML, PNG, JPEG veya PDF formatına dönüştürmek için seçenekleri ayarlayın. 
...
demos:
    enable: true
    title: "ODP İzleyici Canlı Demosu"
    content: |
        [GroupDocs.Viewer Çevrimiçi Uygulamaları](https://products.groupdocs.app/viewer/odp) web sitesini ziyaret ederek ODP dosyasını hemen görüntüleyin.
    lang: "tr"
