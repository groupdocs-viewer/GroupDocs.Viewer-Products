...
############################# Head #############################
head_title: "Java BMP Viewer API - Render & Display BMP dalam Java Apps"
head_description: "Lihat BMP fail dalam aplikasi Java, J2EE, J2SE. Menyokong melihat 170+ format fail dokumen dan imej dalam mod HTML, PDF atau imej dengan ciri lanjutan untuk mengurus pilihan melihat dokumen."

############################# Header ############################
title: "Render & Lihat BMP Dalam Java" 
description: "API pemapar fail BMP asli dan berprestasi tinggi untuk aplikasi berasaskan Java, J2EE dan J2SE, menyokong pelbagai ciri tambahan untuk menyesuaikan penampilan format dokumen output." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail BMP dalam Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) anda boleh memaparkan BMP kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.
