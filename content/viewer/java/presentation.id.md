...
############################# Head #############################
head_title: "Java Presentation Viewer API - Render & Tampilkan Presentation di Aplikasi Java"
head_description: "Lihat file Presentation dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat Presentation Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file Presentation di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender Presentation ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.

        * Tambahkan [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) sebagai dependensi ke project Anda. 
        * Buat instance kelas Viewer dan muat file Presentation dengan path lengkap. 
        * Setel opsi untuk merender file Presentation ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "Presentation Demo Langsung Pemirsa"
    content: |
        Lihat file Presentation sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/powerpoint).
    lang: "id"
