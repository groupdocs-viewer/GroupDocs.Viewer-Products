...
head_description: "View VTX files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View VTX In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render VTX file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render VTX to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render VTX file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View VTX file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/vtx) website.
    lang: "en"
