...
############################# Head #############################
head_title: "Java CC Viewer API - Render & Display CC dalam Java Apps"
head_description: "Lihat CC fail dalam aplikasi Java, J2EE, J2SE. Menyokong melihat 170+ format fail dokumen dan imej dalam mod HTML, PDF atau imej dengan ciri lanjutan untuk mengurus pilihan melihat dokumen."

############################# Header ############################
title: "Render & Lihat CC Dalam Java" 
description: "API pemapar fail CC asli dan berprestasi tinggi untuk aplikasi berasaskan Java, J2EE dan J2SE, menyokong pelbagai ciri tambahan untuk menyesuaikan penampilan format dokumen output." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail CC dalam Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) anda boleh memaparkan CC kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.

        * Tambahkan [GroupDocs.Viewer untuk Java](https://releases.groupdocs.com/viewer/java/) sebagai pergantungan kepada projek anda. 
        * Buat contoh kelas Viewer dan muatkan fail CC dengan laluan penuh. 
        * Tetapkan pilihan untuk memaparkan fail CC ke dalam format HTML, PNG, JPEG atau PDF. 
...
demos:
    enable: true
    title: "CC Demo Langsung Penonton"
    content: |
        Lihat fail CC sekarang dengan melawati tapak web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cc).
    lang: "ms"
