...
############################# Head #############################
head_title: "Java MBOX Viewer API - Render & Tampilkan MBOX di Aplikasi Java"
head_description: "Lihat file MBOX dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat MBOX Di Java" 
description: "API penampil file MBOX asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file MBOX di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender MBOX ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
