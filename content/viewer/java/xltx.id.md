...
############################# Head #############################
head_title: "Java XLTX Viewer API - Render & Tampilkan XLTX di Aplikasi Java"
head_description: "Lihat file XLTX dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat XLTX Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file XLTX di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender XLTX ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file XLTX ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "XLTX Demo Langsung Pemirsa"
    content: |
        Lihat file XLTX sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/xltx).
    lang: "id"
