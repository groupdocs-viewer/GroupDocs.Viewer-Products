...
############################# Head #############################
head_title: "API de visualització de Java PSM1: renderitza i mostra PSM1 a les aplicacions de Java"
head_description: "Veure fitxers PSM1 en aplicacions Java, J2EE, J2SE. Admet la visualització de més de 170 formats de documents i fitxers d'imatge en mode HTML, PDF o imatge amb funcions avançades per gestionar les opcions de visualització de documents."

############################# Header ############################
title: "Renderitza i visualitza PSM1 a Java" 
description: "API de visualització de fitxers PSM1 nativa i d'alt rendiment per a aplicacions basades en Java, J2EE i J2SE, que admet una àmplia gamma de funcions addicionals per personalitzar l'aparença del format del document de sortida." 
...
steps:
    enable: true
    title_left: "Passos per renderitzar el fitxer PSM1 a Java" 
    content_left: |
        Amb [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) podeu renderitzar PSM1 a HTML, JPEG, PNG o PDF en uns quants passos.

        * Afegiu [GroupDocs.Viewer per Java](https://releases.groupdocs.com/viewer/java/) com a dependència al vostre projecte. 
        * Creeu una instància de la classe Viewer i carregueu el fitxer PSM1 amb el camí complet. 
        * Estableix les opcions per renderitzar el fitxer PSM1 en format HTML, PNG, JPEG o PDF. 
...
demos:
    enable: true
    title: "PSM1 Visualitzador de demostració en directe"
    content: |
        Consulteu el fitxer PSM1 ara mateix visitant el lloc web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/psm1).
    lang: "ca"
