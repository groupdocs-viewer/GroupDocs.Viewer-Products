...
############################# Head #############################
head_title: "Java DWF Viewer API - Render & Tampilkan DWF di Aplikasi Java"
head_description: "Lihat file DWF dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat DWF Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file DWF di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender DWF ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file DWF ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "DWF Demo Langsung Pemirsa"
    content: |
        Lihat file DWF sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/dwf).
    lang: "id"
