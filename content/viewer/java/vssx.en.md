...
head_description: "View VSSX files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View VSSX In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render VSSX file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render VSSX to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render VSSX file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View VSSX file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/vssx) website.
    lang: "en"
