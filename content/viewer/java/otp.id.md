...
############################# Head #############################
head_title: "Java OTP Viewer API - Render & Tampilkan OTP di Aplikasi Java"
head_description: "Lihat file OTP dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat OTP Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file OTP di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender OTP ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
