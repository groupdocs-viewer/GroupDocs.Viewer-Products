...
############################# Head #############################
head_title: "Java DNG Viewer API - Render & Tampilkan DNG di Aplikasi Java"
head_description: "Lihat file DNG dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat DNG Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file DNG di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender DNG ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
