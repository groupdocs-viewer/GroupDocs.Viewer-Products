...
############################# Head #############################
head_title: "Java LOG Viewer API - Render & Display LOG in Java Apps"
head_description: "View LOG files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View LOG In Java" 
description: "Native and high performance LOG file viewer API for Java, J2EE and J2SE based applications, supporting a wide range of additional features to customize the appearance of the output document format." 
...
steps:
    enable: true
    title_left: "Steps to Render LOG file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render LOG to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render LOG file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View LOG file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/log) website.
    lang: "en"
