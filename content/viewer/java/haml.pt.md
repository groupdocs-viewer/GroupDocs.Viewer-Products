...
############################# Head #############################
head_title: "Java HAML API do visualizador - renderizar e exibir HAML em aplicativos Java"
head_description: "Veja arquivos HAML em aplicativos Java, J2EE, J2SE. Suporta a visualização de mais de 170 formatos de arquivo de imagem e documento em HTML, PDF ou modo de imagem com recursos avançados para gerenciar as opções de visualização de documentos."

############################# Header ############################
title: "Renderizar e visualizar HAML em Java" 
description: "API do visualizador de arquivos HAML nativo e de alto desempenho para aplicativos baseados em Java, J2EE e J2SE, suportando uma ampla gama de recursos adicionais para personalizar a aparência do formato do documento de saída." 
...
steps:
    enable: true
    title_left: "Etapas para renderizar o arquivo HAML em Java" 
    content_left: |
        Com [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) você pode renderizar HAML para HTML, JPEG, PNG ou PDF em algumas etapas.

        * Adicione [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) como uma dependência ao seu projeto. 
        * Crie uma instância da classe Viewer e carregue o arquivo HAML com o caminho completo. 
        * Defina as opções para renderizar o arquivo HAML em formato HTML, PNG, JPEG ou PDF. 
...
demos:
    enable: true
    title: "Demonstração ao vivo do visualizador HAML"
    content: |
        Veja o arquivo HAML agora visitando o site [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/haml).
    lang: "pt"
