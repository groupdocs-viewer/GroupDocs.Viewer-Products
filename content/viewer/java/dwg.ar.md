...
############################# Head #############################
head_title: "Java DWG Viewer API - Render & Display DWG في تطبيقات Java"
head_description: "عرض ملفات DWG في تطبيقات Java و J2EE و J2SE. يدعم عرض أكثر من 170 تنسيقًا لملف المستندات والصور بتنسيق HTML أو PDF أو وضع الصورة مع ميزات متقدمة لإدارة خيارات عرض المستندات."

############################# Header ############################
title: "تقديم وعرض DWG في Java" 
description: "واجهة برمجة تطبيقات عارض الملفات الأصلية وعالية الأداء DWG للتطبيقات المستندة إلى Java و J2EE و J2SE ، مما يدعم نطاقًا واسعًا من الميزات الإضافية لتخصيص مظهر تنسيق المستند الناتج." 
...
steps:
    enable: true
    title_left: "خطوات تقديم ملف DWG في Java" 
    content_left: |
        باستخدام [GroupDocs.Viewer] (https://products.groupdocs.com/viewer/java/) ، يمكنك عرض DWG إلى HTML أو JPEG أو PNG أو PDF في بضع خطوات.

        * أضف [GroupDocs.Viewer for Java] (https://releases.groupdocs.com/viewer/java/) كعنصر تبعية لمشروعك. 
        * إنشاء مثيل لفئة Viewer وتحميل الملف DWG بالمسار الكامل. 
        * تعيين الخيارات لعرض ملف DWG في تنسيق HTML أو PNG أو JPEG أو PDF. 
...
demos:
    enable: true
    title: "DWG عرض توضيحي مباشر للمشاهد"
    content: |
        اعرض ملف DWG الآن من خلال زيارة موقع ويب [GroupDocs.Viewer Online Apps] (https://products.groupdocs.app/viewer/ dwg).
    lang: "ar"
