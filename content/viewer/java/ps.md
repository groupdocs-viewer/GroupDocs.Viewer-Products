...
steps:
    enable: true
    title_left: "Steps for View PS File in Java"
    content_left: |
        ...
        *   Set view options to convert PS file into PNG format.
...
demos:
    ...
    content: |
        Display PS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
