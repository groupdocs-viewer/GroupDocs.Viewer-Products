...
head_description: "View MPX files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View MPX In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render MPX file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render MPX to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render MPX file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View MPX file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/mpx) website.
    lang: "en"
