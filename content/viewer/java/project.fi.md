...
############################# Head #############################
head_title: "Java Project Viewer API - Renderöi ja näytä Project Java-sovelluksissa"
head_description: "Tarkastele Project-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä Project Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn Project-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston Project renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa Project HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.

        * Lisää [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) projektisi riippuvuudeksi. 
        * Luo Viewer-luokan ilmentymä ja lataa Project tiedosto koko polulla. 
        * Aseta asetukset renderöidäksesi Project-tiedosto HTML-, PNG-, JPEG- tai PDF-muotoon. 
...
demos:
    enable: true
    title: "Project Viewerin live-demo"
    content: |
        Tarkastele tiedostoa Project heti käymällä [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/project) -sivustolla.
    lang: "fi"
