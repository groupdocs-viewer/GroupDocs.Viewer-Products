...
############################# Head #############################
head_title: "Java FBX Viewer API - Rendera och visa FBX i Java Apps"
head_description: "Visa FBX-filer i Java-, J2EE-, J2SE-applikationer. Stöder visning av 170+ dokument- och bildfilformat i HTML-, PDF- eller bildläge med avancerade funktioner för att hantera dokumentvisningsalternativ."

############################# Header ############################
title: "Rendera och visa FBX i Java" 
description: "Inbyggt och högpresterande FBX filvisar-API för Java-, J2EE- och J2SE-baserade applikationer, som stöder ett brett utbud av ytterligare funktioner för att anpassa utseendet på utdatadokumentformatet." 
...
steps:
    enable: true
    title_left: "Steg för att rendera filen FBX i Java" 
    content_left: |
        Med [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) kan du rendera FBX till HTML, JPEG, PNG eller PDF i några få steg.

        * Lägg till [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) som ett beroende till ditt projekt. 
        * Skapa en instans av Viewer-klassen och ladda FBX-filen med fullständig sökväg. 
        * Ställ in alternativ för att rendera filen FBX till HTML-, PNG-, JPEG- eller PDF-format. 
...
demos:
    ...
    content: |
        Visa filen FBX just nu genom att besöka webbplatsen [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/fbx).
    lang: "sv"
