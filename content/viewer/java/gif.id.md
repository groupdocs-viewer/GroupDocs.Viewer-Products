...
############################# Head #############################
head_title: "Java GIF Viewer API - Render & Tampilkan GIF di Aplikasi Java"
head_description: "Lihat file GIF dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat GIF Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file GIF di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender GIF ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
