...
############################# Head #############################
head_title: "Java SML Viewer API - upodabljanje in prikaz SML v aplikacijah Java"
head_description: "Oglejte si datoteke SML v aplikacijah Java, J2EE, J2SE. Podpira ogled več kot 170 formatov dokumentov in slikovnih datotek v HTML, PDF ali slikovnem načinu z naprednimi funkcijami za upravljanje možnosti ogledovanja dokumentov."

############################# Header ############################
title: "Upodabljanje in ogled SML v Javi" 
description: "Izvorni in visoko zmogljiv API pregledovalnika datotek SML za aplikacije, ki temeljijo na Javi, J2EE in J2SE, podpira širok nabor dodatnih funkcij za prilagajanje videza oblike izhodnega dokumenta." 
...
steps:
    enable: true
    title_left: "Koraki za upodabljanje datoteke SML v Java" 
    content_left: |
        Z [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) lahko v nekaj korakih upodobite SML v HTML, JPEG, PNG ali PDF.
