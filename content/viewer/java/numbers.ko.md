...
############################# Head #############################
head_title: "Java NUMBERS 뷰어 API - Java 앱에서 NUMBERS 렌더링 및 표시"
head_description: "Java, J2EE, J2SE 애플리케이션에서 NUMBERS 파일을 봅니다. 문서 보기 옵션을 관리하는 고급 기능을 사용하여 HTML, PDF 또는 이미지 모드에서 170개 이상의 문서 및 이미지 파일 형식 보기를 지원합니다."

############################# Header ############################
title: "자바에서 NUMBERS 렌더링 및 보기" 
description: "Java, J2EE 및 J2SE 기반 응용 프로그램을 위한 기본 및 고성능 NUMBERS 파일 뷰어 API는 출력 문서 형식의 모양을 사용자 지정하는 다양한 추가 기능을 지원합니다." 
...
steps:
    enable: true
    title_left: "Java에서 NUMBERS 파일을 렌더링하는 단계" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/)를 사용하면 몇 단계 만에 NUMBERS을 HTML, JPEG, PNG 또는 PDF로 렌더링할 수 있습니다.
