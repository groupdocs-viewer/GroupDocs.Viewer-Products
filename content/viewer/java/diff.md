...
steps:
    enable: true
    title_left: "Steps for View DIFF File in Java"
    content_left: |
        ...
        *   Set view options to convert DIFF file into PNG format.
...
demos:
    ...
    content: |
        Display DIFF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
