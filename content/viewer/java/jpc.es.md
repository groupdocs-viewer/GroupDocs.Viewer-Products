...
############################# Head #############################
head_title: "Java JPC API de visualización: renderiza y muestra JPC en aplicaciones Java"
head_description: "Ver archivos JPC en aplicaciones Java, J2EE, J2SE. Admite la visualización de más de 180 formatos de archivos de imágenes y documentos en HTML, PDF o modo de imagen con funciones avanzadas para administrar las opciones de visualización de documentos."

############################# Header ############################
title: "Renderizar y ver JPC en Java" 
description: "API de visualización de archivos JPC nativa y de alto rendimiento para aplicaciones basadas en Java, J2EE y J2SE, que admite una amplia gama de funciones adicionales para personalizar la apariencia del formato del documento de salida." 
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo JPC en Java" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> puedes renderizar JPC a HTML, JPEG, PNG o PDF en unos pocos pasos.
