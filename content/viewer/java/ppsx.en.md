...
head_description: "View PPSX files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View PPSX In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render PPSX file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render PPSX to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render PPSX file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View PPSX file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ppsx) website.
    lang: "en"
