...
############################# Head #############################
head_title: "Java AS3 Viewer API - Render & Display AS3 mewn Java Apps"
head_description: "Gweld AS3 ffeil mewn rhaglenni Java, J2EE, J2SE. Yn cefnogi gwylio dros 170 o fformatau ffeil dogfen a delwedd mewn modd HTML, PDF neu ddelwedd gyda nodweddion uwch i reoli opsiynau gwylio dogfennau."

############################# Header ############################
title: "Rendro a Gweld AS3 Yn Java" 
description: "API gwyliwr ffeil AS3 brodorol a pherfformiad uchel ar gyfer cymwysiadau seiliedig ar Java, J2EE a J2SE, gan gefnogi ystod eang o nodweddion ychwanegol i addasu ymddangosiad fformat y ddogfen allbwn." 
...
steps:
    enable: true
    title_left: "Camau i Rendro ffeil AS3 yn Java" 
    content_left: |
        Gyda [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) gallwch rendro AS3 i HTML, JPEG, PNG neu PDF mewn ychydig o gamau.

        * Ychwanegu [GroupDocs.Viewer ar gyfer Java](https://releases.groupdocs.com/viewer/java/) fel dibyniaeth i'ch prosiect. 
        * Creu enghraifft o ddosbarth Gwyliwr a llwytho'r ffeil AS3 gyda llwybr llawn. 
        * Gosod opsiynau i rendr ffeil AS3 i fformat HTML, PNG, JPEG neu PDF. 
...
demos:
    ...
    content: |
        Gweld AS3 ffeil ar hyn o bryd drwy ymweld â gwefan [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/as3).
    lang: "cy"
