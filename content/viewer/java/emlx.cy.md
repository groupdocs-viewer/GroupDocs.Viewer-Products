...
############################# Head #############################
head_title: "Java EMLX Viewer API - Render & Display EMLX mewn Java Apps"
head_description: "Gweld EMLX ffeil mewn rhaglenni Java, J2EE, J2SE. Yn cefnogi gwylio dros 170 o fformatau ffeil dogfen a delwedd mewn modd HTML, PDF neu ddelwedd gyda nodweddion uwch i reoli opsiynau gwylio dogfennau."

############################# Header ############################
title: "Rendro a Gweld EMLX Yn Java" 
description: "API gwyliwr ffeil EMLX brodorol a pherfformiad uchel ar gyfer cymwysiadau seiliedig ar Java, J2EE a J2SE, gan gefnogi ystod eang o nodweddion ychwanegol i addasu ymddangosiad fformat y ddogfen allbwn." 
...
steps:
    enable: true
    title_left: "Camau i Rendro ffeil EMLX yn Java" 
    content_left: |
        Gyda [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) gallwch rendro EMLX i HTML, JPEG, PNG neu PDF mewn ychydig o gamau.

        * Ychwanegu [GroupDocs.Viewer ar gyfer Java](https://releases.groupdocs.com/viewer/java/) fel dibyniaeth i'ch prosiect. 
        * Creu enghraifft o ddosbarth Gwyliwr a llwytho'r ffeil EMLX gyda llwybr llawn. 
        * Gosod opsiynau i rendr ffeil EMLX i fformat HTML, PNG, JPEG neu PDF. 
...
demos:
    ...
    content: |
        Gweld EMLX ffeil ar hyn o bryd drwy ymweld â gwefan [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/emlx).
    lang: "cy"
