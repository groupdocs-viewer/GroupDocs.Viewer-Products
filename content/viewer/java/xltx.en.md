...
############################# Head #############################
head_title: "Java XLTX Viewer API - Render & Display XLTX in Java Apps"
head_description: "View XLTX files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View XLTX In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render XLTX file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render XLTX to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render XLTX file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View XLTX file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/xltx) website.
    lang: "en"
