...
head_title: "Java BZ2 Viewer API - Render & Tampilan BZ2 di Aplikasi Java"
head_description: "Lihat file BZ2 di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File BZ2 di Java"
description: "API penampil file BZ2 asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File BZ2 di Java"
    content_left: |
        [GroupDocs.Viewer](/viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file BZ2 di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file BZ2 dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file BZ2 ke format PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.bz2"))
        {
        	// Setel opsi tampilan
...
demos:
    ...
    content: |
        Tampilkan file BZ2 sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
