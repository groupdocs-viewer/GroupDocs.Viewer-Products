...
head_description: "View PPTX files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View PPTX In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render PPTX file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render PPTX to HTML, JPEG, PNG or PDF in a few steps.
...
demos:
    ...
    content: |
        View PPTX file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/pptx) website.
    lang: "en"
