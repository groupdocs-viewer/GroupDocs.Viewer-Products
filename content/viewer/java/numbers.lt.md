...
############################# Head #############################
head_title: "„Java“ NUMBERS peržiūros programos API – atvaizduokite ir rodykite NUMBERS „Java Apps“."
head_description: "Peržiūrėkite NUMBERS failus Java, J2EE, J2SE programose. Palaiko 170+ dokumentų ir vaizdo failų formatų peržiūrą HTML, PDF arba vaizdo režimu su pažangiomis funkcijomis, leidžiančiomis valdyti dokumentų peržiūros parinktis."

############################# Header ############################
title: "Pateikti ir peržiūrėti NUMBERS Java" 
description: "Savoji ir didelio našumo NUMBERS failų peržiūros programa, skirta Java, J2EE ir J2SE pagrįstoms programoms, palaikanti daugybę papildomų funkcijų, leidžiančių tinkinti išvesties dokumento formato išvaizdą." 
...
steps:
    enable: true
    title_left: "Veiksmai, kaip pateikti NUMBERS failą Java" 
    content_left: |
        Naudodami [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) atlikdami kelis veiksmus galite pateikti NUMBERS į HTML, JPEG, PNG arba PDF.

        * Pridėkite [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) kaip projekto priklausomybę. 
        * Sukurkite Viewer klasės egzempliorių ir įkelkite failą NUMBERS su visu keliu. 
        * Nustatykite parinktis, kaip pateikti NUMBERS failą HTML, PNG, JPEG arba PDF formatu. 
...
demos:
    enable: true
    title: "NUMBERS žiūrovo tiesioginė demonstracija"
    content: |
        Peržiūrėkite NUMBERS failą dabar apsilankę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/numbers) svetainėje.
    lang: "lt"
