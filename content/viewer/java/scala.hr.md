...
############################# Head #############################
head_title: "Java SCALA Viewer API - Render & Display SCALA u Java aplikacijama"
head_description: "Pogledajte SCALA datoteke u Java, J2EE, J2SE aplikacijama. Podržava pregledavanje više od 170 formata dokumenata i slikovnih datoteka u HTML, PDF ili slikovnom načinu s naprednim značajkama za upravljanje opcijama pregledavanja dokumenata."

############################# Header ############################
title: "Renderirajte i pogledajte SCALA u Javi" 
description: "Nativni i visokoučinkoviti SCALA API za preglednik datoteka za aplikacije temeljene na Javi, J2EE i J2SE, podržavajući širok raspon dodatnih značajki za prilagodbu izgleda formata izlaznog dokumenta." 
...
steps:
    enable: true
    title_left: "Koraci za prikaz SCALA datoteke u Java" 
    content_left: |
        Pomoću [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) možete prikazati SCALA u HTML, JPEG, PNG ili PDF u nekoliko koraka.
