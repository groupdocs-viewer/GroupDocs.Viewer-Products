...
############################# Head #############################
head_title: "Java JPEG Viewer API - merender & menampilkan JPEG di aplikasi Java"
head_description: "Lihat file JPEG dalam aplikasi Java, J2EE, J2SE. Mendukung melihat 180+ format file dokumen dan gambar dalam mode HTML, PDF atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & lihat JPEG di Java" 
...
steps:
    enable: true
    title: "Langkah-langkah untuk merender file JPEG di Java" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> Anda dapat merender JPEG ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
