...
############################# Head #############################
head_title: "Java VTX Viewer API — renderowanie i wyświetlanie VTX w aplikacjach Java"
head_description: "Zobacz pliki VTX w aplikacjach Java, J2EE, J2SE. Obsługuje przeglądanie ponad 170 formatów dokumentów i plików obrazów w trybie HTML, PDF lub obrazu z zaawansowanymi funkcjami do zarządzania opcjami przeglądania dokumentów."

############################# Header ############################
title: "Renderuj i przeglądaj DOCX VTX w Javie" 
description: "Natywny i wydajny interfejs API przeglądarki plików VTX dla aplikacji opartych na językach Java, J2EE i J2SE, obsługujący szeroki zakres dodatkowych funkcji umożliwiających dostosowanie wyglądu formatu dokumentu wyjściowego." 
...
steps:
    enable: true
    title_left: "Kroki renderowania pliku VTX w Java" 
    content_left: |
        Dzięki [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) możesz w kilku krokach wyrenderować VTX do formatu HTML, JPEG, PNG lub PDF.

        * Dodaj [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) jako zależność do swojego projektu. 
        * Utwórz instancję klasy Viewer i załaduj plik VTX z pełną ścieżką. 
        * Ustaw opcje renderowania pliku VTX do formatu HTML, PNG, JPEG lub PDF. 
...
demos:
    enable: true
    title: "VTX Przeglądarka Demo na żywo"
    content: |
        Wyświetl teraz plik VTX, odwiedzając witrynę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/vtx).
    lang: "pl"
