...
head_description: "Sehen Sie sich CXX-Dateien in Java-, J2EE- und J2SE-Anwendungen an. Unterstützt die Anzeige von über 180 Dokument- und Bilddateiformaten im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung der Dokumentanzeigeoptionen."
...
steps:
    enable: true
    title: "Schritte zum Rendern der Datei CXX in Java" 
    content: |
      Mit <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> können Sie CXX in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
