...
head_title: "Java ONENOTE Viewer API - Render & Tampilan ONENOTE di Aplikasi Java"
head_description: "Lihat file ONENOTE di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File ONENOTE di Java"
description: "API penampil file ONENOTE asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File ONENOTE di Java"
    content_left: |
        [GroupDocs.Viewer](viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file ONENOTE di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat SATU file dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi SATU file ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa ONENOTE"
    content: |
        Tampilkan file ONENOTE sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
...
about_formats:
    ...
    format:
        - icon: "far fa-sticky-note-o"
          ...
          content: |
            File program pencatat berisi bagian dan halaman untuk menyimpan catatan. Dokumen catatan bisa sesederhana dokumen teks maupun lebih detail yang terdiri dari gambar digital, klip audio/video, dan gambar sketsa tangan. Ekstensi file ONENOTE umum dan format file terkaitnya termasuk .ONE dan file daftar isinya .ONETOC2.
