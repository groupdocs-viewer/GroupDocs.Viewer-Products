...
############################# Head #############################
head_title: "Java EMZ áhorfandaforritaskil - birta og birta EMZ í Java forritum"
head_description: "Skoðaðu EMZ skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu EMZ í Java" 
description: "Innbyggt og afkastamikið EMZ skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera EMZ skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert EMZ í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið EMZ skránni með fullri slóð. 
        * Stilltu valkosti til að gera EMZ skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "EMZ Sýning áhorfanda í beinni"
    content: |
        Skoðaðu EMZ skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/emz).
    lang: "is"
