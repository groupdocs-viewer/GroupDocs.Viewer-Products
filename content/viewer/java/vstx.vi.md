...
############################# Head #############################
head_title: "API Trình xem Java VSTX - Kết xuất & Hiển thị VSTX trong Ứng dụng Java"
head_description: "Xem các tệp VSTX trong các ứng dụng Java, J2EE, J2SE. Hỗ trợ xem hơn 170 định dạng tệp tài liệu và hình ảnh ở chế độ HTML, PDF hoặc hình ảnh với các tính năng nâng cao để quản lý các tùy chọn xem tài liệu."

############################# Header ############################
title: "Kết xuất & Xem VSTX Trong Java" 
...
steps:
    enable: true
    title_left: "Các bước để kết xuất tệp VSTX trong Java" 
    content_left: |
        Với [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/), bạn có thể kết xuất VSTX thành HTML, JPEG, PNG hoặc PDF trong một vài bước.
