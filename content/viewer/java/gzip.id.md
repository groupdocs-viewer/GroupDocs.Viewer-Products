...
head_title: "Java GZIP Viewer API - Render & Tampilan GZIP di Aplikasi Java"
head_description: "Lihat file GZIP di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File GZIP di Java"
description: "API penampil file GZIP asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File GZIP di Java"
    content_left: |
        [GroupDocs.Viewer](viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file GZIP di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file GZIP dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file GZIP ke format PNG.
...
demos:
    ...
    content: |
        Tampilkan file GZIP sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-archive-o"
          title: "Tentang Format File GZ"
          content: |
