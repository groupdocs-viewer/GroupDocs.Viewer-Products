...
############################# Head #############################
head_title: "Java 7Z áhorfandaforritaskil - birta og birta 7Z í Java forritum"
head_description: "Skoðaðu 7Z skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu 7Z í Java" 
description: "Innbyggt og afkastamikið 7Z skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera 7Z skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert 7Z í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið 7Z skránni með fullri slóð. 
        * Stilltu valkosti til að gera 7Z skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "7Z Sýning áhorfanda í beinni"
    content: |
        Skoðaðu 7Z skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/7z).
    lang: "is"
