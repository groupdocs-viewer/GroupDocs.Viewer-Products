...
head_description: "View Web files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View Web In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render Web file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render Web to HTML, JPEG, PNG or PDF in a few steps.

        * Add [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) as a dependency to your project. 
        * Create an instance of Viewer class and load the Web file with full path. 
        * Set options to render Web file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View Web file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/web) website.
    lang: "en"
