...
head_description: "View HPG files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View HPG In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render HPG file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render HPG to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render HPG file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View HPG file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/hpg) website.
    lang: "en"
