...
############################# Head #############################
head_title: "Java SH Viewer API - Render & Tampilkan SH di Aplikasi Java"
head_description: "Lihat file SH dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat SH Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file SH di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender SH ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file SH ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "SH Demo Langsung Pemirsa"
    content: |
        Lihat file SH sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/sh).
    lang: "id"
