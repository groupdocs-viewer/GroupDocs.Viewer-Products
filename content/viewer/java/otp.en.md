...
head_description: "View OTP files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View OTP In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render OTP file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render OTP to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render OTP file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View OTP file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/otp) website.
    lang: "en"
