...
############################# Head #############################
head_title: "Java XLT Viewer API – Rendern und Anzeigen von XLT in Java-Apps"
head_description: "Sehen Sie sich XLT-Dateien in Java-, J2EE- und J2SE-Anwendungen an. Unterstützt die Anzeige von über 170 Dokument- und Bilddateiformaten im HTML-, PDF- oder Bildmodus mit erweiterten Funktionen zur Verwaltung der Dokumentanzeigeoptionen."

############################# Header ############################
title: "Rendern und Anzeigen von XLT in Java" 
description: "Native und leistungsstarke XLT-Dateibetrachter-API für Java-, J2EE- und J2SE-basierte Anwendungen, die eine Vielzahl zusätzlicher Funktionen unterstützt, um das Erscheinungsbild des Ausgabedokumentformats anzupassen." 
...
steps:
    enable: true
    title_left: "Schritte zum Rendern der XLT-Datei in Java" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) können Sie XLT in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.

        * Fügen Sie [GroupDocs.Viewer für Java](https://releases.groupdocs.com/viewer/java/) als Abhängigkeit zu Ihrem Projekt hinzu. 
        * Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei XLT mit dem vollständigen Pfad. 
        * Legen Sie Optionen fest, um die Datei XLT im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
...
demos:
    enable: true
    title: "XLT Viewer-Live-Demo"
    content: |
        Sehen Sie sich die Datei XLT jetzt auf der Website von [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/xlt) an.
    lang: "de"
