...
overview:
  ...
  features:
    ...
    - title: "Visualisez les documents de manière efficace et fiable"
      content: "Avec l'API GroupDocs.Viewer, vous pouvez rendre efficacement des documents de tout format pris en charge en [HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/), [JPEG, PNG](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/), et [PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/) grâce à des options souples et puissantes, tout en conservant le contenu et l’intégrité de la structure du document. GroupDocs.Viewer fonctionne sur les plateformes Windows et Linux."
...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Afficher les documents en HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Pixelliser les documents](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/)"
    ...
    # feature loop
    - icon: "font"
      title: "[Contrôler les polices du document](https://docs.groupdocs.com/viewer/java/set-custom-fonts/)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Convertir en PDF](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Appliquer des transformations](https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Ajustement de la sortie HTML](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Prise en charge de structures de documents complexes](https://blog.groupdocs.com/viewer/view-files-and-folders-in-zip-and-tar-archives-using-java-api/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Options d'optimisation](https://docs.groupdocs.com/viewer/java/how-to-use-custom-cache-implementation/)"
    ...
    - icon: "passwordprotected"
      title: "[Prise en charge des documents protégés par mot de passe](https://docs.groupdocs.com/viewer/java/load-password-protected-document/)"
