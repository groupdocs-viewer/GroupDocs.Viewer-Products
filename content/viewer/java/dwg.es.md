...
############################# Head #############################
head_title: "Java DWG API de visualización: renderiza y muestra DWG en aplicaciones Java"
head_description: "Ver archivos DWG en aplicaciones Java, J2EE, J2SE. Admite la visualización de más de 180 formatos de archivos de imágenes y documentos en HTML, PDF o modo de imagen con funciones avanzadas para administrar las opciones de visualización de documentos."

############################# Header ############################
title: "Renderizar y ver DWG en Java" 
description: "API de visualización de archivos DWG nativa y de alto rendimiento para aplicaciones basadas en Java, J2EE y J2SE, que admite una amplia gama de funciones adicionales para personalizar la apariencia del formato del documento de salida." 
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo DWG en Java" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> puedes renderizar DWG a HTML, JPEG, PNG o PDF en unos pocos pasos.
      ...
      2. Cree una instancia de la clase Viewer y cargue el archivo DWG con la ruta completa.  
      3. Configure opciones para representar el archivo DWG en formato HTML, PNG, JPEG o PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurar el archivo de entrada DWG
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Renderice el archivo DWG a HTML con recursos integrados
