...
############################# Head #############################
head_title: "Java PROPERTIES Viewer API - Renderöi ja näytä PROPERTIES Java-sovelluksissa"
head_description: "Tarkastele PROPERTIES-tiedostoja Java-, J2EE- ja J2SE-sovelluksissa. Tukee yli 170 asiakirja- ja kuvatiedostomuodon katselua HTML-, PDF- tai kuvatilassa edistyneillä ominaisuuksilla asiakirjojen katseluvaihtoehtojen hallitsemiseksi."

############################# Header ############################
title: "Renderöi ja näytä PROPERTIES Javassa" 
description: "Alkuperäinen ja korkean suorituskyvyn PROPERTIES-tiedostojen katselusovellusliittymä Java-, J2EE- ja J2SE-pohjaisille sovelluksille, joka tukee laajaa valikoimaa lisäominaisuuksia tulostetun asiakirjamuodon ulkoasun mukauttamiseen." 
...
steps:
    enable: true
    title_left: "Vaiheet tiedoston PROPERTIES renderöimiseksi Java" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) avulla voit hahmontaa PROPERTIES HTML-, JPEG-, PNG- tai PDF-muotoon muutamassa vaiheessa.

        * Lisää [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) projektisi riippuvuudeksi. 
        * Luo Viewer-luokan ilmentymä ja lataa PROPERTIES tiedosto koko polulla. 
        * Aseta asetukset renderöidäksesi PROPERTIES-tiedosto HTML-, PNG-, JPEG- tai PDF-muotoon. 
...
demos:
    enable: true
    title: "PROPERTIES Viewerin live-demo"
    content: |
        Tarkastele tiedostoa PROPERTIES heti käymällä [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/properties) -sivustolla.
    lang: "fi"
