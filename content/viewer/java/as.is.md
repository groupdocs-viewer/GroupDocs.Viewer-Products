...
############################# Head #############################
head_title: "Java AS áhorfandaforritaskil - birta og birta AS í Java forritum"
head_description: "Skoðaðu AS skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu AS í Java" 
description: "Innbyggt og afkastamikið AS skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera AS skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert AS í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið AS skránni með fullri slóð. 
        * Stilltu valkosti til að gera AS skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "AS Sýning áhorfanda í beinni"
    content: |
        Skoðaðu AS skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/as).
    lang: "is"
