...
############################# Head #############################
head_title: "Java OTT Görüntüleyici API'si - Java Uygulamalarında OTT Oluşturun ve Görüntüleyin"
head_description: "OTT dosyalarını Java, J2EE, J2SE uygulamalarında görüntüleyin. Belge görüntüleme seçeneklerini yönetmek için gelişmiş özelliklerle HTML, PDF veya görüntü modunda 170'den fazla belge ve görüntü dosyası formatını görüntülemeyi destekler."

############################# Header ############################
title: "Java'da OTT Oluşturun ve Görüntüleyin" 
description: "Java, J2EE ve J2SE tabanlı uygulamalar için yerel ve yüksek performanslı OTT dosya görüntüleyici API'si, çıktı belge biçiminin görünümünü özelleştirmek için çok çeşitli ek özellikleri destekler." 
...
steps:
    enable: true
    title_left: "OTT dosyasını Java içinde Oluşturma Adımları" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) ile OTT dosyasını birkaç adımda HTML, JPEG, PNG veya PDF'ye dönüştürebilirsiniz.

        * Projenize bir bağımlılık olarak [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) ekleyin. 
        * Viewer sınıfının bir örneğini oluşturun ve OTT dosyasını tam yolla yükleyin. 
        * OTT dosyasını HTML, PNG, JPEG veya PDF formatına dönüştürmek için seçenekleri ayarlayın. 
...
demos:
    enable: true
    title: "OTT İzleyici Canlı Demosu"
    content: |
        [GroupDocs.Viewer Çevrimiçi Uygulamaları](https://products.groupdocs.app/viewer/ott) web sitesini ziyaret ederek OTT dosyasını hemen görüntüleyin.
    lang: "tr"
