...
############################# Head #############################
head_title: "API trình xem Java J2K - hiển thị và hiển thị J2K trong ứng dụng Java"
head_description: "Xem các tệp J2K trong các ứng dụng Java, J2EE, J2SE. Hỗ trợ xem hơn 180 định dạng tệp tài liệu và hình ảnh ở chế độ HTML, PDF hoặc hình ảnh với các tính năng nâng cao để quản lý các tùy chọn xem tài liệu."

############################# Header ############################
title: "Hiển thị và xem J2K trong Java" 
...
steps:
    enable: true
    title: "Các bước để hiển thị tệp J2K trong Java" 
    content: |
      Với <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> bạn có thể hiển thị J2K thành HTML, JPEG, PNG hoặc PDF chỉ trong vài bước.
