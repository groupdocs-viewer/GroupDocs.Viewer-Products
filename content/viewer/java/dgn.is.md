...
############################# Head #############################
head_title: "Java DGN áhorfandaforritaskil - birta og birta DGN í Java forritum"
head_description: "Skoðaðu DGN skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu DGN í Java" 
description: "Innbyggt og afkastamikið DGN skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera DGN skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert DGN í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið DGN skránni með fullri slóð. 
        * Stilltu valkosti til að gera DGN skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "DGN Sýning áhorfanda í beinni"
    content: |
        Skoðaðu DGN skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/dgn).
    lang: "is"
