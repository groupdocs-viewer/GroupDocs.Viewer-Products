...
############################# Head #############################
head_title: "Java CS Viewer API - Render & Tampilkan CS di Aplikasi Java"
head_description: "Lihat file CS dalam aplikasi Java, J2EE, J2SE. Mendukung tampilan 170+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur lanjutan untuk mengelola opsi tampilan dokumen."

############################# Header ############################
title: "Render & Lihat CS Di Java" 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Merender file CS di Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) Anda dapat merender CS ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
