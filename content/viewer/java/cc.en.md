...
head_description: "View CC files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View CC In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render CC file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render CC to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render CC file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View CC file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cc) website.
    lang: "en"
