...
############################# Head #############################
head_title: "Java Project API Viewer - renderizar e exibir Project em aplicativos Java"
head_description: "Visualize arquivos Project em aplicativos Java, J2EE, J2SE. Suporta a visualização de mais de 180 formatos de documentos e arquivos de imagem em HTML, PDF ou modo de imagem com recursos avançados para gerenciar opções de visualização de documentos."

############################# Header ############################
title: "Renderizar e visualizar Project em Java" 
description: "API visualizadora de arquivos Project nativa e de alto desempenho para aplicativos baseados em Java, J2EE e J2SE, suportando uma ampla gama de recursos adicionais para personalizar a aparência do formato do documento de saída." 
...
steps:
    enable: true
    title: "Etapas para renderizar o arquivo Project em Java" 
    content: |
      Com <a href='https://products.groupdocs.com/viewer/java/'>GroupDocs.Viewer</a> você pode renderizar Project para HTML, JPEG, PNG ou PDF em algumas etapas.
      ...
      2. Crie uma instância da classe Viewer e carregue o arquivo Project com caminho completo.  
      3. Defina opções para renderizar o arquivo Project em formato HTML, PNG, JPEG ou PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurar arquivo de entrada Project
        ...
        try (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Renderize o arquivo Project em HTML com recursos incorporados
