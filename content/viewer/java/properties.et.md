...
############################# Head #############################
head_title: "Java PROPERTIES vaataja API – renderda ja kuva PROPERTIES Java rakendustes"
head_description: "Vaadake PROPERTIES faile Java, J2EE, J2SE rakendustes. Toetab 170+ dokumendi- ja pildifailivormingu vaatamist HTML-, PDF- või pildirežiimis koos täiustatud funktsioonidega dokumentide vaatamise valikute haldamiseks."

############################# Header ############################
title: "Renderda ja kuva PROPERTIES Javas" 
description: "Native ja suure jõudlusega PROPERTIES failivaaturi API Java-, J2EE- ja J2SE-põhiste rakenduste jaoks, mis toetab laia valikut lisafunktsioone väljunddokumendi vormingu välimuse kohandamiseks." 
...
steps:
    enable: true
    title_left: "Toimingud faili PROPERTIES renderdamiseks rakenduses Java" 
    content_left: |
        Rakendusega [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) saate mõne sammuga renderdada faili PROPERTIES HTML-, JPEG-, PNG- või PDF-vormingusse.

        * Lisage [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) oma projekti sõltuvusena. 
        * Looge Vieweri klassi eksemplar ja laadige fail PROPERTIES kogu teega. 
        * Määrake suvandid faili PROPERTIES renderdamiseks HTML-, PNG-, JPEG- või PDF-vormingusse. 
...
demos:
    enable: true
    title: "PROPERTIES vaataja reaalajas demo"
    content: |
        Vaadake kohe faili PROPERTIES, külastades veebisaiti [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/properties).
    lang: "et"
