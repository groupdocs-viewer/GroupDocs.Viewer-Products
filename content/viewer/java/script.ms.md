...
############################# Head #############################
head_title: "Java SCRIPT Viewer API - Render & Display SCRIPT dalam Java Apps"
head_description: "Lihat SCRIPT fail dalam aplikasi Java, J2EE, J2SE. Menyokong melihat 170+ format fail dokumen dan imej dalam mod HTML, PDF atau imej dengan ciri lanjutan untuk mengurus pilihan melihat dokumen."

############################# Header ############################
title: "Render & Lihat SCRIPT Dalam Java" 
description: "API pemapar fail SCRIPT asli dan berprestasi tinggi untuk aplikasi berasaskan Java, J2EE dan J2SE, menyokong pelbagai ciri tambahan untuk menyesuaikan penampilan format dokumen output." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail SCRIPT dalam Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) anda boleh memaparkan SCRIPT kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.

        * Tambahkan [GroupDocs.Viewer untuk Java](https://releases.groupdocs.com/viewer/java/) sebagai pergantungan kepada projek anda. 
        * Buat contoh kelas Viewer dan muatkan fail SCRIPT dengan laluan penuh. 
        * Tetapkan pilihan untuk memaparkan fail SCRIPT ke dalam format HTML, PNG, JPEG atau PDF. 
...
demos:
    enable: true
    title: "SCRIPT Demo Langsung Penonton"
    content: |
        Lihat fail SCRIPT sekarang dengan melawati tapak web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/script).
    lang: "ms"
