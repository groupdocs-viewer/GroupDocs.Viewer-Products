...
############################# Head #############################
head_title: "Java BMP Viewer API - Redare și afișare BMP în aplicațiile Java"
head_description: "Vizualizați fișiere BMP în aplicații Java, J2EE, J2SE. Acceptă vizualizarea a peste 170 de formate de documente și fișiere imagine în HTML, PDF sau în modul imagine cu funcții avansate pentru a gestiona opțiunile de vizualizare a documentelor."

############################# Header ############################
title: "Redați și vizualizați BMP în Java" 
description: "API nativ și de înaltă performanță pentru vizualizarea fișierelor BMP pentru aplicații bazate pe Java, J2EE și J2SE, care acceptă o gamă largă de caracteristici suplimentare pentru a personaliza aspectul formatului documentului de ieșire." 
...
steps:
    enable: true
    title_left: "Pași pentru redarea fișierului BMP în Java" 
    content_left: |
        Cu [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) puteți reda BMP în HTML, JPEG, PNG sau PDF în câțiva pași.

        * Adăugați [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) ca dependență pentru proiectul dvs. 
        * Creați o instanță a clasei Viewer și încărcați fișierul BMP cu calea completă. 
        * Setați opțiunile de redare a fișierului BMP în format HTML, PNG, JPEG sau PDF. 
...
demos:
    ...
    content: |
        Vizualizați fișierul BMP chiar acum, vizitând site-ul web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/bmp).
    lang: "ro"
