...
############################# Head #############################
head_title: "Java J2C áhorfandaforritaskil - birta og birta J2C í Java forritum"
head_description: "Skoðaðu J2C skrár í Java, J2EE, J2SE forritum. Styður að skoða 170+ skjala- og myndaskráarsnið í HTML, PDF eða myndham með háþróaðri eiginleikum til að stjórna skjalaskoðunarvalkostum."

############################# Header ############################
title: "Gerðu og skoðaðu J2C í Java" 
description: "Innbyggt og afkastamikið J2C skráaskoðaraforritaskil fyrir Java, J2EE og J2SE byggð forrit, sem styður fjölbreytt úrval viðbótareiginleika til að sérsníða útlit útlagsskjalsniðsins." 
...
steps:
    enable: true
    title_left: "Skref til að gera J2C skrá í Java" 
    content_left: |
        Með [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) geturðu gert J2C í HTML, JPEG, PNG eða PDF í nokkrum skrefum.

        * Bættu við [GroupDocs.Viewer fyrir Java](https://releases.groupdocs.com/viewer/java/) sem háð verkefninu þínu. 
        * Búðu til tilvik af Viewer class og hlaðið J2C skránni með fullri slóð. 
        * Stilltu valkosti til að gera J2C skrána á HTML, PNG, JPEG eða PDF sniði. 
...
demos:
    enable: true
    title: "J2C Sýning áhorfanda í beinni"
    content: |
        Skoðaðu J2C skrána núna með því að fara á vefsíðu [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/j2c).
    lang: "is"
