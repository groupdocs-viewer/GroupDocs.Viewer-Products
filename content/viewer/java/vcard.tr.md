...
############################# Head #############################
head_title: "Java vCard Görüntüleyici API'si - Java Uygulamalarında vCard Oluşturun ve Görüntüleyin"
head_description: "vCard dosyalarını Java, J2EE, J2SE uygulamalarında görüntüleyin. Belge görüntüleme seçeneklerini yönetmek için gelişmiş özelliklerle HTML, PDF veya görüntü modunda 170'den fazla belge ve görüntü dosyası formatını görüntülemeyi destekler."

############################# Header ############################
title: "Java'da vCard Oluşturun ve Görüntüleyin" 
description: "Java, J2EE ve J2SE tabanlı uygulamalar için yerel ve yüksek performanslı vCard dosya görüntüleyici API'si, çıktı belge biçiminin görünümünü özelleştirmek için çok çeşitli ek özellikleri destekler." 
...
steps:
    enable: true
    title_left: "vCard dosyasını Java içinde Oluşturma Adımları" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) ile vCard dosyasını birkaç adımda HTML, JPEG, PNG veya PDF'ye dönüştürebilirsiniz.
