...
head_description: "View PS files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View PS In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render PS file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render PS to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render PS file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View PS file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ps) website.
    lang: "en"
