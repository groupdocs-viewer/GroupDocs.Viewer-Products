...
head_description: "View GROOVY files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View GROOVY In Java" 
...
steps:
    enable: true
    title_left: "Steps to Render GROOVY file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render GROOVY to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render GROOVY file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View GROOVY file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/groovy) website.
    lang: "en"
