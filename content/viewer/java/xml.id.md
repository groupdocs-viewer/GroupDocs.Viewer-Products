...
head_title: "Java XML Viewer API - Render & Tampilan XML di Aplikasi Java"
head_description: "Lihat file XML di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File XML di Java"
description: "API penampil file XML asli dan berkinerja tinggi untuk aplikasi berbasis Java, J2EE dan J2SE, mendukung berbagai fitur tambahan untuk menyesuaikan tampilan format dokumen keluaran."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File XML di Java"
    content_left: |
        [GroupDocs.Viewer](/viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file XML di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file XML dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file XML ke format PNG.
    ...
    code: |
        ...
        try (Viewer viewer = new Viewer("sample.xml"))
        {
        	// Setel opsi tampilan
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa XML"
    content: |
        Tampilkan file XML sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
...
about_formats:
    ...
    format:
        - icon: "far fa-file-xml"
          ...
          content: |
            XML adalah singkatan dari Extensible Markup Language yang mirip dengan HTML tetapi berbeda dalam penggunaan tag untuk mendefinisikan objek. Seluruh ide di balik pembuatan format file XML adalah untuk menyimpan dan mengangkut data tanpa bergantung pada perangkat lunak atau perangkat keras. Popularitasnya adalah karena dapat dibaca manusia dan juga mesin. Ini memungkinkannya untuk membuat protokol data umum dalam bentuk objek untuk disimpan dan dibagikan melalui jaringan seperti World Wide Web (WWW). "X" di XML adalah untuk extensible yang menyiratkan bahwa bahasa dapat diperluas ke sejumlah simbol sesuai kebutuhan pengguna. Untuk fitur-fitur inilah banyak format file standar memanfaatkannya seperti Microsoft Open XML, LibreOffice OpenDocument, XHTML dan SVG.
...
more_formats:
    ...
    format: 
        ...
        - name: "Penampil Java VST"
          ...
          description: "Gambar Microsoft Visio 2003-2010 XML"
