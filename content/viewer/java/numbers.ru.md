...
draft: false
############################# Head ############################
head_title: "Java NUMBERS Viewer API — рендеринг и отображение NUMBERS в приложениях Java"
head_description: "Просмотр файлов NUMBERS в приложениях Java, J2EE, J2SE. Поддерживает просмотр более 150 форматов файлов документов и изображений в формате HTML, PDF или изображения с расширенными функциями для управления параметрами просмотра документов."
############################# Header ############################
title: "Рендеринг и просмотр файла NUMBERS в Java"
description: "Собственный и высокопроизводительный API-интерфейс просмотра файлов NUMBERS для приложений на основе Java, J2EE и J2SE, поддерживающий широкий спектр дополнительных функций для настройки внешнего вида формата выходного документа."
bg_overlay: false
button:
    enable: true
...
steps:
    enable: true
    title_left: "Шаги для просмотра файла NUMBERS в Java"
    content_left: |
        [GroupDocs.Viewer](/ru/viewer/java/) позволяет разработчикам Java легко добавлять в свои приложения функцию просмотра файлов NUMBERS с помощью нескольких строк кода.
        * Создайте экземпляр класса Viewer и загрузите файл NUMBERS с полным путем.
        * Установите параметры просмотра для преобразования файла NUMBERS в формат PNG.
...
demos:
    enable: true
    title: "NUMBERS Viewer Живые демонстрации"
    content: |
        Отобразите файл NUMBERS прямо сейчас, посетив веб-сайт [GroupDocs.Viewer Живые волнения](https://products.groupdocs.app/viewer/).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        ...
        - icon: "far fa-file-excel-o"
          title: "О формате файла NUMBERS"
          content: |
            Файлы с расширением .numbers относятся к типу файлов электронных таблиц, поэтому они похожи на файлы .xlsx; но файлы Numbers создаются с помощью программного обеспечения электронных таблиц Apple iWork Numbers. Apple iWork Numbers — это модуль программного обеспечения iWork Productivity Suite. iWork Productivity Suite эквивалентен Microsoft Office Suite, который используется на ПК с Windows. Следовательно, мы можем сказать, что Numbers, доступный для MacOS, также является конкурентом Microsoft Excel. Аналогично, Microsoft Excel файл NUMBERS также может содержать таблицы, диаграммы и формулы. Вы можете найти различное программное обеспечение для преобразования файла NUMBERS в Excel или другие электронные таблицы.
