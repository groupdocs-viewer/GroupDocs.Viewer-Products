...
############################# Head #############################
head_title: "Java DIB Viewer API - upodabljanje in prikaz DIB v aplikacijah Java"
head_description: "Oglejte si datoteke DIB v aplikacijah Java, J2EE, J2SE. Podpira ogled več kot 170 formatov dokumentov in slikovnih datotek v HTML, PDF ali slikovnem načinu z naprednimi funkcijami za upravljanje možnosti ogledovanja dokumentov."

############################# Header ############################
title: "Upodabljanje in ogled DIB v Javi" 
description: "Izvorni in visoko zmogljiv API pregledovalnika datotek DIB za aplikacije, ki temeljijo na Javi, J2EE in J2SE, podpira širok nabor dodatnih funkcij za prilagajanje videza oblike izhodnega dokumenta." 
...
steps:
    enable: true
    title_left: "Koraki za upodabljanje datoteke DIB v Java" 
    content_left: |
        Z [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) lahko v nekaj korakih upodobite DIB v HTML, JPEG, PNG ali PDF.
