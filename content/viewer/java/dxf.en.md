...
head_description: "View DXF files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."
...
steps:
    enable: true
    title_left: "Steps to Render DXF file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render DXF to HTML, JPEG, PNG or PDF in a few steps.
...
demos:
    ...
    content: |
        View DXF file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/dxf) website.
    lang: "en"
