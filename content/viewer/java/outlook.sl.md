...
############################# Head #############################
head_title: "Java Outlook Viewer API - upodabljanje in prikaz Outlook v aplikacijah Java"
head_description: "Oglejte si datoteke Outlook v aplikacijah Java, J2EE, J2SE. Podpira ogled več kot 170 formatov dokumentov in slikovnih datotek v HTML, PDF ali slikovnem načinu z naprednimi funkcijami za upravljanje možnosti ogledovanja dokumentov."

############################# Header ############################
title: "Upodabljanje in ogled Outlook v Javi" 
description: "Izvorni in visoko zmogljiv API pregledovalnika datotek Outlook za aplikacije, ki temeljijo na Javi, J2EE in J2SE, podpira širok nabor dodatnih funkcij za prilagajanje videza oblike izhodnega dokumenta." 
...
steps:
    enable: true
    title_left: "Koraki za upodabljanje datoteke Outlook v Java" 
    content_left: |
        Z [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) lahko v nekaj korakih upodobite Outlook v HTML, JPEG, PNG ali PDF.

        * Dodajte [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) kot odvisnost od svojega projekta. 
        * Ustvarite primerek razreda Viewer in naložite datoteko Outlook s celotno potjo. 
        * Nastavite možnosti za upodabljanje datoteke Outlook v formatu HTML, PNG, JPEG ali PDF. 
...
demos:
    ...
    content: |
        Takoj si oglejte datoteko Outlook tako, da obiščete spletno mesto [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/outlook).
    lang: "sl"
