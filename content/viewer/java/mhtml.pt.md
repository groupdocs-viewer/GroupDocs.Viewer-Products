...
############################# Head #############################
head_title: "Java MHTML API do visualizador - renderizar e exibir MHTML em aplicativos Java"
head_description: "Veja arquivos MHTML em aplicativos Java, J2EE, J2SE. Suporta a visualização de mais de 170 formatos de arquivo de imagem e documento em HTML, PDF ou modo de imagem com recursos avançados para gerenciar as opções de visualização de documentos."

############################# Header ############################
title: "Renderizar e visualizar MHTML em Java" 
description: "API do visualizador de arquivos MHTML nativo e de alto desempenho para aplicativos baseados em Java, J2EE e J2SE, suportando uma ampla gama de recursos adicionais para personalizar a aparência do formato do documento de saída." 
...
steps:
    enable: true
    title_left: "Etapas para renderizar o arquivo MHTML em Java" 
    content_left: |
        Com [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) você pode renderizar MHTML para HTML, JPEG, PNG ou PDF em algumas etapas.

        * Adicione [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) como uma dependência ao seu projeto. 
        * Crie uma instância da classe Viewer e carregue o arquivo MHTML com o caminho completo. 
        * Defina as opções para renderizar o arquivo MHTML em formato HTML, PNG, JPEG ou PDF. 
...
demos:
    enable: true
    title: "Demonstração ao vivo do visualizador MHTML"
    content: |
        Veja o arquivo MHTML agora visitando o site [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/mhtml).
    lang: "pt"
