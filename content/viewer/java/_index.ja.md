...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[HTML でドキュメントを表示する](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
      content: "CSS と SVG を使用して、あらゆる種類のドキュメントを HTML ドキュメントに変換し、最新の Web ブラウザで表示できます。"

    # feature loop
    - icon: "rasterize"
      title: "[ドキュメントをラスタライズする](https://docs.groupdocs.com/viewer/java/rendering-to-png-or-jpeg/)"
      content: "サポート可能なドキュメント形式をラスター画像にラスター化し、画像形式と圧縮品質を調整できます。"

    # feature loop
    - icon: "font"
      title: "[文書フォントの制御](https://docs.groupdocs.com/viewer/java/set-custom-fonts/)"
      content: "文書で使用されているフォントを特定します。欠落しているフォントは、置換するか出力から除外することで管理できます。"

    # feature loop
    - icon: "convertpdf"
      title: "[PDFに変換](https://docs.groupdocs.com/viewer/java/rendering-to-pdf/)"
      content: "サポート可能な形式のドキュメントは、調整可能なオプションを使用して簡単に PDF に変換して保存できます。"

    # feature loop
    - icon: "transform"
      title: "[変換を適用する](https://docs.groupdocs.com/viewer/java/flip-or-rotate-pages/)"
      content: "出力ドキュメントはレンダリング中に変換できます。ページは回転および/または再配置でき、テキストの透かしをその上に配置できます。"

    # feature loop
    - icon: "adjustment"
      title: "[HTML出力調整](https://docs.groupdocs.com/viewer/java/rendering-to-html/)"
      content: "GroupDocs.Viewer によって生成される出力 HTML ドキュメントは、非常に細かく調整できます。外部リソースまたは埋め込みリソース、コールバックなどを使用して、ストリームまたはファイルに保存できます。"

    # feature loop
    - icon: "complex"
      title: "[複雑な文書構造のサポート](https://blog.groupdocs.com/viewer/view-files-and-folders-in-zip-and-tar-archives-using-java-api/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[最適化オプション](https://docs.groupdocs.com/viewer/java/how-to-use-custom-cache-implementation/)"
    ...
    - icon: "passwordprotected"
      title: "[パスワードで保護されたドキュメントのサポート](https://docs.groupdocs.com/viewer/java/load-password-protected-document/)"
