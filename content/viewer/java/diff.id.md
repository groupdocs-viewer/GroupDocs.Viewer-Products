...
head_title: "Java DIFF Viewer API - Render & Tampilan DIFF di Aplikasi Java"
head_description: "Lihat file DIFF di aplikasi Java, J2EE, J2SE. Mendukung tampilan 150+ format file dokumen dan gambar dalam mode HTML, PDF, atau gambar dengan fitur-fitur canggih untuk mengelola opsi tampilan dokumen."

title: "Render & Lihat File DIFF di Java"
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File DIFF di Java"
    content_left: |
        [GroupDocs.Viewer](viewer/java/) memudahkan pengembang Java untuk menambahkan fitur tampilan file DIFF di aplikasi mereka menggunakan beberapa baris kode.

        * Buat instance kelas Viewer dan muat file DIFF dengan path lengkap.
        * Atur opsi tampilan untuk mengonversi file DIFF ke format PNG.
...
demos:
    ...
    content: |
        Tampilkan file DIFF sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/). Demo langsung memiliki manfaat sebagai berikut.
