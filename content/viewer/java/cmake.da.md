...
############################# Head #############################
head_title: "Java CMAKE Viewer API - Gengivelse og visning CMAKE i Java Apps"
head_description: "Se CMAKE filer i Java, J2EE, J2SE applikationer. Understøtter visning af mere end 170 dokument- og billedfilformater i HTML-, PDF- eller billedtilstand med avancerede funktioner til at administrere dokumentvisningsmuligheder."

############################# Header ############################
title: "Gengiv og vis CMAKE i Java" 
description: "Indbygget og højtydende CMAKE-filfremviser-API til Java-, J2EE- og J2SE-baserede applikationer, der understøtter en lang række yderligere funktioner til at tilpasse udseendet af outputdokumentformatet." 
...
steps:
    enable: true
    title_left: "Trin til gengivelse af CMAKE-fil i Java" 
    content_left: |
        Med [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) kan du gengive CMAKE til HTML, JPEG, PNG eller PDF i nogle få trin.

        * Tilføj [GroupDocs.Viewer til Java](https://releases.groupdocs.com/viewer/java/) som en afhængighed til dit projekt. 
        * Opret en forekomst af Viewer-klassen og indlæs CMAKE-filen med fuld sti. 
        * Indstil muligheder for at gengive filen CMAKE til HTML-, PNG-, JPEG- eller PDF-format. 
...
demos:
    enable: true
    title: "CMAKE Live-demo"
    content: |
        Se filen CMAKE lige nu ved at besøge webstedet [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cmake).
    lang: "da"
