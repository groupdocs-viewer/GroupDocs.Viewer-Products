...
steps:
    enable: true
    title_left: "Steps for View AS File in Java"
    content_left: |
        ...
        *   Set view options to convert AS file into PNG format.
...
demos:
    ...
    content: |
        Display AS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
