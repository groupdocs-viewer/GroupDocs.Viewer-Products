...
############################# Head #############################
head_title: "Java JS Viewer API - Render & Display JS dalam Java Apps"
head_description: "Lihat JS fail dalam aplikasi Java, J2EE, J2SE. Menyokong melihat 170+ format fail dokumen dan imej dalam mod HTML, PDF atau imej dengan ciri lanjutan untuk mengurus pilihan melihat dokumen."

############################# Header ############################
title: "Render & Lihat JS Dalam Java" 
description: "API pemapar fail JS asli dan berprestasi tinggi untuk aplikasi berasaskan Java, J2EE dan J2SE, menyokong pelbagai ciri tambahan untuk menyesuaikan penampilan format dokumen output." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail JS dalam Java" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) anda boleh memaparkan JS kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.
