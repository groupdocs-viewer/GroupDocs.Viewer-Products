...
############################# Head #############################
head_title: "Java TARXZ Viewer API - Render & Display TARXZ in Java Apps"
head_description: "View TARXZ files in Java, J2EE, J2SE applications. Supports viewing 170+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View TARXZ In Java" 
description: "Native and high performance TARXZ file viewer API for Java, J2EE and J2SE based applications, supporting a wide range of additional features to customize the appearance of the output document format." 
...
steps:
    enable: true
    title_left: "Steps to Render TARXZ file in Java" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) you can render TARXZ to HTML, JPEG, PNG or PDF in a few steps.

        * Add [GroupDocs.Viewer for Java](https://releases.groupdocs.com/viewer/java/) as a dependency to your project. 
        * Create an instance of Viewer class and load the TARXZ file with full path. 
        * Set options to render TARXZ file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View TARXZ file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/tarxz) website.
    lang: "en"
