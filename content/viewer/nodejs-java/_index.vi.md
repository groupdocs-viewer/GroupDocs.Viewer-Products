...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Xem tài liệu bằng HTML](https://docs.groupdocs.com/viewer/nodejs-java/rendering-to-html/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Rasterize tài liệu](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Node.js-via-Java/blob/master/Examples/BasicUsage/RenderDocumentToImage/renderToJpg.js)"
    ...
    # feature loop
    - icon: "font"
      title: "[Kiểm soát phông chữ tài liệu](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Node.js-via-Java/blob/master/Examples/AdvancedUsage/Rendering/CommonRenderingOptions/replaceMissingFont.js)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Chuyển đổi sang PDF](https://docs.groupdocs.com/viewer/nodejs-java/rendering-to-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Áp dụng các phép biến đổi](https://docs.groupdocs.com/viewer/nodejs-java/add-text-watermark/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Điều chỉnh đầu ra HTML](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Node.js-via-Java/blob/master/Examples/BasicUsage/RenderDocumentToHtml/renderToHtmlWithExternalResources.js)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Hỗ trợ cấu trúc tài liệu phức tạp](https://docs.groupdocs.com/viewer/nodejs-java/how-to-extract-and-save-attachments/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Tùy chọn tối ưu hóa](https://docs.groupdocs.com/viewer/nodejs-java/caching-results/)"
    ...
    - icon: "passwordprotected"
      title: "[Hỗ trợ các tài liệu được bảo vệ bằng mật khẩu](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Node.js-via-Java/blob/master/Examples/AdvancedUsage/Loading/loadPasswordProtectedDocument.js)"
