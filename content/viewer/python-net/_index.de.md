...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Dokumente in HTML anzeigen](https://docs.groupdocs.com/viewer/python-net/rendering-to-html/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Dokumente rastern](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/basic_usage/render_document_to_image/render_to_png.py)"
    ...
    # feature loop
    - icon: "font"
      title: "[Steuerung von Dokumentschriftarten](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/advanced_usage/rendering/common_rendering_options/replace_missing_font.py)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[In PDF konvertieren](https://docs.groupdocs.com/viewer/python-net/rendering-to-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Wenden Sie Transformationen an](https://docs.groupdocs.com/viewer/python-net/add-text-watermark/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Anpassung der HTML-Ausgabe](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/basic_usage/render_document_to_html/render_to_html_with_embedded_resources.py)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Unterstützung komplexer Dokumentenstrukturen](https://docs.groupdocs.com/viewer/python-net/how-to-extract-and-save-attachments/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Optimierungsmöglichkeiten](https://docs.groupdocs.com/viewer/python-net/caching-results/)"
    ...
    - icon: "passwordprotected"
      title: "[Unterstützung passwortgeschützter Dokumente](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/advanced_usage/loading/load_password_protected_document.py)"
