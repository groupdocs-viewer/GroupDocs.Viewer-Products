...
overview:
  ...
  features:
    ...
    - title: "Эффективное и надежное отображение документов"
      content: "С помощью API GroupDocs.Viewer вы можете эффективно рендерить документы любых поддерживаемых форматов в [HTML](https://docs.groupdocs.com/viewer/python-net/rendering-to-html/), JPEG, PNG и [PDF](https://docs.groupdocs.com/viewer/python-net/rendering-to-pdf/) с гибкими и мощными параметрами, сохраняющими целостность содержимого и структуры документа. GroupDocs.Viewer for Python работает в Windows и Linux."

    # feature loop
    - title: "Поддерживаются самые популярные форматы файлов и документов"
      content: "Мы поддерживаем рендеринг более 180 самых популярных форматов файлов и документов, включая [Word](https://docs.groupdocs.com/viewer/python-net/render-word-documents/), [Excel](https://docs.groupdocs.com/viewer/python-net/specify-rendering-options/), [PDF](https://docs.groupdocs.com/viewer/python-net/render-pdf-documents/), [PowerPoint](https://docs.groupdocs.com/viewer/python-net/render-presentations/), семейство форматов OpenDocument, архивы, растровые и векторные изображения, электронные книги, языки программирования и разметки, а также множество других типов файлов, в том числе зашифрованные файлы с защитой паролем."
...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Просмотр документов в формате HTML](https://docs.groupdocs.com/viewer/python-net/rendering-to-html/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Растеризация документов](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/basic_usage/render_document_to_image/render_to_png.py)"
    ...
    # feature loop
    - icon: "font"
      title: "[Управление шрифтами документа](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/advanced_usage/rendering/common_rendering_options/replace_missing_font.py)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Конвертировать в PDF](https://docs.groupdocs.com/viewer/python-net/rendering-to-pdf/)"
      content: "Документ любого поддерживаемого формата можно легко преобразовать и сохранить в PDF с настраиваемыми параметрами."

    # feature loop
    - icon: "transform"
      title: "[Применить преобразования](https://docs.groupdocs.com/viewer/python-net/add-text-watermark/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Настройка вывода HTML](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/basic_usage/render_document_to_html/render_to_html_with_embedded_resources.py)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Поддержка сложных структур документов](https://docs.groupdocs.com/viewer/python-net/how-to-extract-and-save-attachments/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Варианты оптимизации](https://docs.groupdocs.com/viewer/python-net/caching-results/)"
    ...
    - icon: "passwordprotected"
      title: "[Поддержка документов, защищенных паролем](https://github.com/groupdocs-viewer/GroupDocs.Viewer-for-Python-via-.NET/blob/master/Examples/advanced_usage/loading/load_password_protected_document.py)"
