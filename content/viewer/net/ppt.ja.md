...
############################# Header ############################
title: "C# .NET アプリケーション用の PPT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PPT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PPT を HTML、JPEG、PNG、または PDF にレンダリングできます。
