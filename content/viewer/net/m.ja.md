...
############################# Header ############################
title: "C# .NET アプリケーション用の M ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で M ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で M を HTML、JPEG、PNG、または PDF にレンダリングできます。
