...
############################# Header ############################
title: "C# .NET アプリケーション用の TXT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TXT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TXT を HTML、JPEG、PNG、または PDF にレンダリングできます。
