...
head_title: ".NET GROOVY Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan GROOVY di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "GROOVY File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file GROOVY dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File GROOVY di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file GROOVY dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file GROOVY dengan path lengkap.
        * Atur opsi untuk mengonversi file GROOVY ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa GROOVY"
    content: |
        Tampilkan file GROOVY sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/grrovy). Demo langsung memiliki manfaat sebagai berikut.
