...
steps:
    enable: true
    title_left: "Steps for View NUMBERS File in C#"
    content_left: |
        ...
        *   Set options to convert NUMBERS file into PNG format.
...
demos:
    ...
    content: |
        Display NUMBERS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/numbers) website.  
