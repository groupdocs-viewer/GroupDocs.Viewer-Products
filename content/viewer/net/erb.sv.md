...
############################# Head #############################
head_title: ".NET ERB Viewer API - Läs, visa, rendera i C# VB.NET"
head_description: ".NET Document Viewer API för att läsa, rendera och visa ERB i alla typer av C#, ASP.NET, VB.NET och .NET Core-applikationer."

############################# Header ############################
title: "Erb Filvisare för C# .NET-applikationer" 
description: ".NET Document Viewer API för att läsa, rendera och visa ERB-fil i alla typer av C#-, ASP.NET-, VB.NET- och .NET Core-applikationer. Visa de renderade filerna med riktig formatering och layout i HTML5, PDF eller som en bild med några rader av koden." 
...
steps:
    enable: true
    title_left: "Steg för att rendera filen ERB i C#" 
    content_left: |
        Med [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) kan du rendera ERB till HTML, JPEG, PNG eller PDF i några få steg.
