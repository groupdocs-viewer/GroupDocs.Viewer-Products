...
############################# Head #############################
head_title: ".NET PSM1 API Viewer - Lire, Afficher, Rendre en C# VB.NET"
head_description: "API de visionneuse de documents .NET pour lire, restituer et afficher PSM1 dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "PSM1 Visionneuse de fichiers pour les applications C# .NET" 
...
steps:
    enable: true
    title_left: "Étapes pour rendre le fichier PSM1 dans C#" 
    content_left: |
        Avec [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/), vous pouvez rendre PSM1 au format HTML, JPEG, PNG ou PDF en quelques étapes.
