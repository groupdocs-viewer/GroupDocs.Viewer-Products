...
############################# Header ############################
title: "C# .NET アプリケーション用の VIM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VIM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VIM を HTML、JPEG、PNG、または PDF にレンダリングできます。
