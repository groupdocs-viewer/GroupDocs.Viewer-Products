...
steps:
    enable: true
    title_left: "Steps to Render DCM file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render DCM to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render DCM file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View DCM file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/dcm) website.
    lang: "en"
