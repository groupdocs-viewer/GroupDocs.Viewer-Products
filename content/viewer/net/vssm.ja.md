...
############################# Header ############################
title: "C# .NET アプリケーション用の VSSM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSSM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSSM を HTML、JPEG、PNG、または PDF にレンダリングできます。
