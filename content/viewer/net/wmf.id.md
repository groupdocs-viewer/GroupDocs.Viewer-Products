...
head_title: ".NET WMF Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan WMF di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "WMF File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file WMF dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File WMF di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file WMF dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file WMF dengan path lengkap.
        * Atur opsi untuk mengonversi file WMF ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa WMF"
    content: |
        Tampilkan file WMF sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/WMF). Demo langsung memiliki manfaat sebagai berikut.
