...
############################# Header ############################
title: "C# .NET アプリケーション用の SCM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SCM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SCM を HTML、JPEG、PNG、または PDF にレンダリングできます。
