...
############################# Head #############################
head_title: ".NET AZW3 API de visor: leer, ver y representar en C# VB.NET"
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo AZW3 en C#" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> puede renderizar AZW3 a HTML, JPEG, PNG o PDF en unos pocos pasos.
      ...
      2. Cree una instancia de la clase Viewer y cargue el archivo AZW3 con la ruta completa.  
      3. Configure opciones para representar el archivo AZW3 en formato HTML, PNG, JPEG o PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurar el archivo de entrada AZW3
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Renderice el archivo AZW3 a HTML con recursos integrados
