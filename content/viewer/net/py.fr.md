...
############################# Head #############################
head_title: ".NET PY API Viewer - Lire, Afficher, Rendre en C# VB.NET"
head_description: "API de visionneuse de documents .NET pour lire, restituer et afficher PY dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "PY Visionneuse de fichiers pour les applications C# .NET" 
...
steps:
    enable: true
    title_left: "Étapes pour rendre le fichier PY dans C#" 
    content_left: |
        Avec [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/), vous pouvez rendre PY au format HTML, JPEG, PNG ou PDF en quelques étapes.
