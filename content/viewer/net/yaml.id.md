...
head_title: ".NET YAML Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan YAML di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "YAML File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file YAML dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File YAML di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file YAML dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file YAML dengan path lengkap.
        * Atur opsi untuk mengonversi file YAML ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa YAML"
    content: |
        Tampilkan file YAML sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/YAML). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-yaml"
          title: "Tentang Format Berkas YAML"
          content: |
            YAML (YAML Bukan Bahasa Markup) adalah bahasa serialisasi data berbasis Unicode yang digunakan untuk file konfigurasi, pesan internet, persistensi objek, dll. YAML menggunakan ekstensi .YAML untuk filenya. YAML dirancang untuk bekerja dengan baik dengan bahasa pemrograman modern.
