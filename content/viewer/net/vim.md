...
steps:
    enable: true
    title_left: "Steps for View VIM File in C#"
    content_left: |
        ...
        *   Set options to convert VIM file into PNG format.
...
demos:
    ...
    content: |
        Display VIM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/vim) website.  
