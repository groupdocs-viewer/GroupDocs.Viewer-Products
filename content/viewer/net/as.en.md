...
steps:
    enable: true
    title_left: "Steps to Render AS file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render AS to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render AS file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View AS file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/as) website.
    lang: "en"
