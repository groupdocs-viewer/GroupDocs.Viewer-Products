...
############################# Header ############################
title: "C# .NET アプリケーション用の MSG ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MSG ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MSG を HTML、JPEG、PNG、または PDF にレンダリングできます。
