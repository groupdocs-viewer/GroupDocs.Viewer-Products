...
############################# Header ############################
title: "C# .NET アプリケーション用の RTF ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で RTF ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で RTF を HTML、JPEG、PNG、または PDF にレンダリングできます。
