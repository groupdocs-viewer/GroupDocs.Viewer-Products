...
############################# Head #############################
head_title: ".NET eMail Viewer-API – Lesen, Anzeigen, Rendern in C# VB.NET"
head_description: ".NET-Dokument-Viewer-API zum Lesen, Rendern und Anzeigen von eMail in allen Arten von C#-, ASP.NET-, VB.NET- und .NET Core-Anwendungen."

############################# Header ############################
title: "eMail Dateibetrachter für C# .NET-Anwendungen" 
description: ".NET-Dokument-Viewer-API zum Lesen, Rendern und Anzeigen von eMail-Dateien in allen Arten von C#-, ASP.NET-, VB.NET- und .NET Core-Anwendungen. Zeigen Sie die gerenderten Dateien mit echter Formatierung und echtem Layout in HTML5, PDF oder als Bild an, indem Sie ein paar Codezeilen verwenden." 
...
steps:
    enable: true
    title_left: "Schritte zum Rendern der eMail-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie eMail in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
        ...
        * Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei eMail mit dem vollständigen Pfad. 
        * Legen Sie Optionen fest, um die Datei eMail im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
...
demos:
    ...
    content: |
        Sehen Sie sich die Datei eMail jetzt auf der Website von [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/email) an.
    lang: "de"
