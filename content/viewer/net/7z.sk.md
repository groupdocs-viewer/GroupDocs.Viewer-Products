...
############################# Head #############################
head_title: ".NET 7Z Viewer API – čítanie, zobrazenie, vykreslenie v C# VB.NET"
head_description: "API prehliadača dokumentov .NET na čítanie, vykresľovanie a zobrazovanie 7Z v akomkoľvek type aplikácií C#, ASP.NET, VB.NET a .NET Core."

############################# Header ############################
title: "7Z Prehliadač súborov pre aplikácie C# .NET" 
description: "API prehliadača dokumentov .NET na čítanie, vykresľovanie a zobrazovanie súboru 7Z v akomkoľvek type aplikácií C#, ASP.NET, VB.NET a .NET Core. Zobrazte vykreslené súbory so skutočným formátovaním a rozložením v HTML5, PDF alebo ako obrázok pomocou niekoľkých riadkov kódu." 
...
steps:
    enable: true
    title_left: "Kroky na vykreslenie súboru 7Z v C#" 
    content_left: |
        Pomocou [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) môžete vykresliť 7Z do HTML, JPEG, PNG alebo PDF v niekoľkých krokoch.
        ...
        * Vytvorte inštanciu triedy Viewer a načítajte súbor 7Z s úplnou cestou. 
        * Nastavte možnosti na vykreslenie súboru 7Z do formátu HTML, PNG, JPEG alebo PDF. 
...
demos:
    enable: true
    title: "Živá ukážka prehliadača 7Z"
    content: |
        Ak chcete zobraziť súbor 7Z, navštívte webovú stránku [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/7z).
    lang: "sk"
