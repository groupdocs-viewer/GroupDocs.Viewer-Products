...
############################# Header ############################
title: "C# .NET アプリケーション用の XLTX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で XLTX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で XLTX を HTML、JPEG、PNG、または PDF にレンダリングできます。
