...
head_description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan eMail di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "eMail penampil file untuk aplikasi C# .NET" 
description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan file eMail dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak sebenarnya dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode." 
...
steps:
    enable: true
    title: "Langkah-langkah merender file eMail di C#" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> Anda dapat merender eMail ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
      ...
      2. Buat instance kelas Viewer dan muat file eMail dengan path lengkap.  
      3. Tetapkan opsi untuk merender file eMail ke dalam format HTML, PNG, JPEG, atau PDF. 
    ...
    code:
      ...
      content: |
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Render file eMail ke HTML dengan sumber daya yang disematkan
