...
############################# Head #############################
head_title: ".NET RST Viewer API – čítanie, zobrazenie, vykreslenie v C# VB.NET"
head_description: "API prehliadača dokumentov .NET na čítanie, vykresľovanie a zobrazovanie RST v akomkoľvek type aplikácií C#, ASP.NET, VB.NET a .NET Core."

############################# Header ############################
title: "RST Prehliadač súborov pre aplikácie C# .NET" 
description: "API prehliadača dokumentov .NET na čítanie, vykresľovanie a zobrazovanie súboru RST v akomkoľvek type aplikácií C#, ASP.NET, VB.NET a .NET Core. Zobrazte vykreslené súbory so skutočným formátovaním a rozložením v HTML5, PDF alebo ako obrázok pomocou niekoľkých riadkov kódu." 
...
steps:
    enable: true
    title_left: "Kroky na vykreslenie súboru RST v C#" 
    content_left: |
        Pomocou [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) môžete vykresliť RST do HTML, JPEG, PNG alebo PDF v niekoľkých krokoch.
        ...
        * Vytvorte inštanciu triedy Viewer a načítajte súbor RST s úplnou cestou. 
        * Nastavte možnosti na vykreslenie súboru RST do formátu HTML, PNG, JPEG alebo PDF. 
...
demos:
    enable: true
    title: "Živá ukážka prehliadača RST"
    content: |
        Ak chcete zobraziť súbor RST, navštívte webovú stránku [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/rst).
    lang: "sk"
