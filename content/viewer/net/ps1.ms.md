...
############################# Head #############################
head_title: ".NET PS1 Viewer API - Baca, Lihat, Render dalam C# VB.NET"
head_description: "API pemapar dokumen .NET untuk membaca, membuat dan memaparkan PS1 dalam sebarang jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "PS1 Pemapar Fail Untuk Aplikasi C# .NET" 
description: "API pemapar dokumen .NET untuk membaca, membuat dan memaparkan fail PS1 dalam sebarang jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat fail yang diberikan dengan pemformatan & reka letak sebenar dalam HTML5, PDF atau sebagai imej menggunakan beberapa baris kod." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail PS1 dalam C#" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) anda boleh memaparkan PS1 kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.
        ...
        * Buat contoh kelas Viewer dan muatkan fail PS1 dengan laluan penuh. 
        * Tetapkan pilihan untuk memaparkan fail PS1 ke dalam format HTML, PNG, JPEG atau PDF. 
...
demos:
    enable: true
    title: "PS1 Demo Langsung Penonton"
    content: |
        Lihat fail PS1 sekarang dengan melawati tapak web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ps1).
    lang: "ms"
