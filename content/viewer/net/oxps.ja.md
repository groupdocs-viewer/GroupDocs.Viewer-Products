...
############################# Header ############################
title: "C# .NET アプリケーション用の OXPS ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で OXPS ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で OXPS を HTML、JPEG、PNG、または PDF にレンダリングできます。
