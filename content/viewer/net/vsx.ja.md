...
############################# Header ############################
title: "C# .NET アプリケーション用の VSX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSX を HTML、JPEG、PNG、または PDF にレンダリングできます。
