...
############################# Head #############################
head_title: ".NET HPG Kyker-API - Lees, bekyk, lewer in C# VB.NET"
head_description: ".NET dokumentkyker-API om HPG te lees, weer te gee en te vertoon in enige tipe C#-, ASP.NET-, VB.NET- en .NET Core-toepassings."

############################# Header ############################
title: "HPG Lêerkyker vir C# .NET-toepassings" 
description: ".NET-dokumentkyker-API om HPG-lêer te lees, weer te gee en te vertoon in enige tipe C#-, ASP.NET-, VB.NET- en .NET Core-toepassings. Bekyk die gelewerde lêers met ware formatering en uitleg in HTML5, PDF of as 'n prent deur 'n paar reëls van die kode te gebruik." 
...
steps:
    enable: true
    title_left: "Stappe om HPG-lêer in C# weer te gee" 
    content_left: |
        Met [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) kan jy HPG in 'n paar stappe na HTML, JPEG, PNG of PDF weergee.
