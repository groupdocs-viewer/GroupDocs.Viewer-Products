...
head_description: ".NET document viewer API to read, render and display OneNote in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "OneNote File Viewer For C# .NET Applications" 
...
steps:
    enable: true
    title_left: "Steps to Render OneNote file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render OneNote to HTML, JPEG, PNG or PDF in a few steps.
