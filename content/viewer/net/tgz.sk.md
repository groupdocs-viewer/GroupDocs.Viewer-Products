...
############################# Head #############################
head_title: ".NET TGZ Viewer API – čítanie, zobrazenie, vykreslenie v C# VB.NET"
head_description: "API prehliadača dokumentov .NET na čítanie, vykresľovanie a zobrazovanie TGZ v akomkoľvek type aplikácií C#, ASP.NET, VB.NET a .NET Core."

############################# Header ############################
title: "TGZ Prehliadač súborov pre aplikácie C# .NET" 
description: "API prehliadača dokumentov .NET na čítanie, vykresľovanie a zobrazovanie súboru TGZ v akomkoľvek type aplikácií C#, ASP.NET, VB.NET a .NET Core. Zobrazte vykreslené súbory so skutočným formátovaním a rozložením v HTML5, PDF alebo ako obrázok pomocou niekoľkých riadkov kódu." 
...
steps:
    enable: true
    title_left: "Kroky na vykreslenie súboru TGZ v C#" 
    content_left: |
        Pomocou [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) môžete vykresliť TGZ do HTML, JPEG, PNG alebo PDF v niekoľkých krokoch.
        ...
        * Vytvorte inštanciu triedy Viewer a načítajte súbor TGZ s úplnou cestou. 
        * Nastavte možnosti na vykreslenie súboru TGZ do formátu HTML, PNG, JPEG alebo PDF. 
...
demos:
    enable: true
    title: "Živá ukážka prehliadača TGZ"
    content: |
        Ak chcete zobraziť súbor TGZ, navštívte webovú stránku [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/tgz).
    lang: "sk"
