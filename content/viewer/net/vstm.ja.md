...
############################# Header ############################
title: "C# .NET アプリケーション用の VSTM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSTM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSTM を HTML、JPEG、PNG、または PDF にレンダリングできます。
