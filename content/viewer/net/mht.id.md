...
head_title: ".NET MHT Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan MHT di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "MHT File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file MHT dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File MHT di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file MHT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file MHT dengan path lengkap.
        * Atur opsi untuk mengonversi file MHT ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa MHT"
    content: |
        Tampilkan file MHT sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/MHT). Demo langsung memiliki manfaat sebagai berikut.
