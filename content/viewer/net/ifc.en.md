...
steps:
    enable: true
    title: "Steps to render IFC file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> you can render IFC to HTML, JPEG, PNG or PDF in a few steps.
