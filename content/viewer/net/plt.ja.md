...
############################# Header ############################
title: "C# .NET アプリケーション用の PLT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PLT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PLT を HTML、JPEG、PNG、または PDF にレンダリングできます。
