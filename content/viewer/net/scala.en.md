...
steps:
    enable: true
    title_left: "Steps to Render SCALA file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render SCALA to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render SCALA file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View SCALA file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/scala) website.
    lang: "en"
