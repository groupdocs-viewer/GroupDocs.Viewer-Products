...
############################# Header ############################
title: "C# .NET アプリケーション用の MOBI ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MOBI ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MOBI を HTML、JPEG、PNG、または PDF にレンダリングできます。
