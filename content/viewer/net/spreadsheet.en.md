...
############################# Header ############################
title: "Spreadsheet File Viewer For C# .NET Applications" 
...
steps:
    enable: true
    title_left: "Steps to Render Spreadsheet file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render Spreadsheet to HTML, JPEG, PNG or PDF in a few steps.
