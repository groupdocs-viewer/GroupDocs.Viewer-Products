...
############################# Header ############################
title: "C# .NET アプリケーション用の MBOX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MBOX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MBOX を HTML、JPEG、PNG、または PDF にレンダリングできます。
