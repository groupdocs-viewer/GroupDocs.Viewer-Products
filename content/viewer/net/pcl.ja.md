...
############################# Header ############################
title: "C# .NET アプリケーション用の PCL ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PCL ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PCL を HTML、JPEG、PNG、または PDF にレンダリングできます。
