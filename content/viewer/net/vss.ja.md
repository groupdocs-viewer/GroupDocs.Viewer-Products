...
############################# Header ############################
title: "C# .NET アプリケーション用の VSS ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSS ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSS を HTML、JPEG、PNG、または PDF にレンダリングできます。
