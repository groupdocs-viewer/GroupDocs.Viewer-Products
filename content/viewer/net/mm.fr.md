...
############################# Head #############################
head_title: "API de la visionneuse .NET MM - lire, afficher, rendre en C# VB.NET"
head_description: "API de visualisation de documents .NET pour lire, restituer et afficher MM dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."
...
steps:
    enable: true
    title: "Étapes pour restituer le fichier MM dans C#" 
    content: |
      Avec <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a>, vous pouvez restituer MM au format HTML, JPEG, PNG ou PDF en quelques étapes.
