...
############################# Header ############################
title: "C# .NET アプリケーション用の SVG ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SVG ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SVG を HTML、JPEG、PNG、または PDF にレンダリングできます。
