...
steps:
    enable: true
    title_left: "Schritte zum Rendern der DOCX-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie DOCX in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
