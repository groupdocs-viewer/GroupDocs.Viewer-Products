...
############################# Header ############################
title: "C# .NET アプリケーション用の MPP ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MPP ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MPP を HTML、JPEG、PNG、または PDF にレンダリングできます。
