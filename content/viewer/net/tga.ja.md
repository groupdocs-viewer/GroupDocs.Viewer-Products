...
############################# Header ############################
title: "C# .NET アプリケーション用の TGA ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TGA ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TGA を HTML、JPEG、PNG、または PDF にレンダリングできます。
