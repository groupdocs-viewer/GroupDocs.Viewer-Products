...
############################# Header ############################
title: "C# .NET アプリケーション用の SH ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SH ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SH を HTML、JPEG、PNG、または PDF にレンダリングできます。
