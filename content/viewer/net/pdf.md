...
steps:
    enable: true
    title_left: "Steps for View PDF File in C#"
    content_left: |
        ...
        *   Set options to convert PDF file into PNG format.
...
demos:
    ...
    content: |
        Display PDF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/pdf) website.  
