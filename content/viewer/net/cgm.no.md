...
############################# Head #############################
head_title: ".NET CGM Viewer API - Les, se, gjengi i C# VB.NET"
head_description: ".NET Document Viewer API for å lese, gjengi og vise CGM i alle typer C#, ASP.NET, VB.NET og .NET Core-applikasjoner."

############################# Header ############################
title: "CGM Filviser for C# .NET-applikasjoner" 
description: ".NET Document Viewer API for å lese, gjengi og vise CGM-fil i alle typer C#, ASP.NET, VB.NET og .NET Core-applikasjoner. Se de gjengitte filene med ekte formatering og layout i HTML5, PDF eller som et bilde ved å bruke noen få linjer med koden." 
...
steps:
    enable: true
    title_left: "Trinn for å gjengi CGM-filen i C#" 
    content_left: |
        Med [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) kan du gjengi CGM til HTML, JPEG, PNG eller PDF i noen få trinn.
