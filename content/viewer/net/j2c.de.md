...
steps:
    enable: true
    title: "Schritte zum Rendern der J2C-Datei in C#" 
    content: |
      Mit <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> können Sie J2C in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
