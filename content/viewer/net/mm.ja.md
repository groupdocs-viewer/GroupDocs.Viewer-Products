...
############################# Header ############################
title: "C# .NET アプリケーション用の MM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MM を HTML、JPEG、PNG、または PDF にレンダリングできます。
