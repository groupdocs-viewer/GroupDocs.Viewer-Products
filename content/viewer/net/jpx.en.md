...
steps:
    enable: true
    title_left: "Steps to Render JPX file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render JPX to HTML, JPEG, PNG or PDF in a few steps.
