...
steps:
    enable: true
    title_left: "Steps for View XLS File in C#"
    content_left: |
        ...
        *   Set options to convert XLS file into PNG format.
...
demos:
    ...
    content: |
        Display XLS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/xls) website.  
