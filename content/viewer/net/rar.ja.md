...
############################# Header ############################
title: "C# .NET アプリケーション用の RAR ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で RAR ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で RAR を HTML、JPEG、PNG、または PDF にレンダリングできます。
