...
############################# Header ############################
title: "C# .NET アプリケーション用の VB ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VB ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VB を HTML、JPEG、PNG、または PDF にレンダリングできます。
