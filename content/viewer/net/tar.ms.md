...
############################# Head #############################
head_title: ".NET TAR Viewer API - Baca, Lihat, Render dalam C# VB.NET"
head_description: "API pemapar dokumen .NET untuk membaca, membuat dan memaparkan TAR dalam sebarang jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "TAR Pemapar Fail Untuk Aplikasi C# .NET" 
description: "API pemapar dokumen .NET untuk membaca, membuat dan memaparkan fail TAR dalam sebarang jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat fail yang diberikan dengan pemformatan & reka letak sebenar dalam HTML5, PDF atau sebagai imej menggunakan beberapa baris kod." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail TAR dalam C#" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) anda boleh memaparkan TAR kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.
        ...
        * Buat contoh kelas Viewer dan muatkan fail TAR dengan laluan penuh. 
        * Tetapkan pilihan untuk memaparkan fail TAR ke dalam format HTML, PNG, JPEG atau PDF. 
...
demos:
    enable: true
    title: "TAR Demo Langsung Penonton"
    content: |
        Lihat fail TAR sekarang dengan melawati tapak web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/tar).
    lang: "ms"
