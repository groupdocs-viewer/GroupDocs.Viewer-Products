...
############################# Head #############################
head_title: ".NET SCALA Viewer API - Léigh, Amharc, Rindreáil i C# VB.NET"
head_description: "API breathnóir doiciméad .NET chun SCALA a léamh, a sholáthar agus a thaispeáint in aon chineál feidhmchláir C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "Scala Amharcóir Comhad Le haghaidh Feidhmchláir C# .NET" 
description: ".NET document viewer API chun comhad SCALA a léamh, a sholáthar agus a thaispeáint in aon chineál feidhmchláir C#, ASP.NET, VB.NET & .NET Core. Féach ar na comhaid rindreáilte le fíorfhormáidiú & leagan amach in HTML5, PDF nó mar íomhá ag baint úsáide as cúpla líne den chód." 
...
steps:
    enable: true
    title_left: "Céimeanna chun comhad SCALA a rindreáil in C#" 
    content_left: |
        Le [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) is féidir leat SCALA a dhéanamh go HTML, JPEG, PNG nó PDF i gcúpla céim.
