...
head_title: ".NET SCRIPT Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan SCRIPT di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "SCRIPT File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file SCRIPT dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File SCRIPT di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file SCRIPT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file SCRIPT dengan path lengkap.
        * Atur opsi untuk mengonversi file SCRIPT ke format PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.script"))
        {
        	// Setel opsi tampilan 
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa SCRIPT"
    content: |
        Tampilkan file SCRIPT sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/SCRIPT). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-script"
          title: "Tentang Format Berkas SCRIPT"
          content: |
            {{SCRIPT}}
