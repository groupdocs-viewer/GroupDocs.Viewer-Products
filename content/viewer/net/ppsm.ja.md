...
############################# Header ############################
title: "C# .NET アプリケーション用の PPSM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PPSM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PPSM を HTML、JPEG、PNG、または PDF にレンダリングできます。
