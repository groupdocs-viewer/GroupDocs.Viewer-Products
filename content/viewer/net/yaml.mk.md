...
############################# Head #############################
head_title: ".NET YAML API за прегледувач - Читање, прегледување, прикажување во C# VB.NET"
head_description: ".NET API за прегледувач на документи за читање, прикажување и прикажување на YAML во кој било тип на C#, ASP.NET, VB.NET и .NET Core апликации."

############################# Header ############################
title: "YAML Прегледувач на датотеки за C# .NET апликации" 
description: ".NET API за прегледувач на документи за читање, прикажување и прикажување на датотеката YAML во кој било тип на C#, ASP.NET, VB.NET и .NET Core апликации. Прегледајте ги рендерираните датотеки со вистинско форматирање и распоред во HTML5, PDF или како слика користејќи неколку линии од кодот." 
...
steps:
    enable: true
    title_left: "Чекори за прикажување на датотеката YAML во C#" 
    content_left: |
        Со [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) може да го преведете YAML во HTML, JPEG, PNG или PDF во неколку чекори.
