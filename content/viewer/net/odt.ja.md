...
############################# Header ############################
title: "ODT C# .NET アプリケーション用のファイル ビューア" 
...
steps:
    enable: true
    title_left: "C# で ODT ファイルをレンダリングする手順" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) を使用すると、いくつかの手順で ODT を HTML、JPEG、PNG、または PDF にレンダリングできます。
