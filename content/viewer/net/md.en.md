...
steps:
    enable: true
    title_left: "Steps to Render MD file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render MD to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render MD file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View MD file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/md) website.
    lang: "en"
