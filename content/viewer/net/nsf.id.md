...
head_description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan NSF di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "NSF penampil file untuk aplikasi C# .NET" 
description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan file NSF dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak sebenarnya dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode." 
...
steps:
    enable: true
    title: "Langkah-langkah merender file NSF di C#" 
    content: |
      Dengan <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> Anda dapat merender NSF ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
      ...
      2. Buat instance kelas Viewer dan muat file NSF dengan path lengkap.  
      3. Tetapkan opsi untuk merender file NSF ke dalam format HTML, PNG, JPEG, atau PDF. 
    ...
    code:
      ...
      content: |
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Render file NSF ke HTML dengan sumber daya yang disematkan
