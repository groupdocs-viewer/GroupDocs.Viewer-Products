...
steps:
    enable: true
    title_left: "Steps to Render ICO file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render ICO to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render ICO file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View ICO file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ico) website.
    lang: "en"
