...
head_title: ".NET JPX Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan JPX di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "JPX File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file JPX dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File JPX di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file JPX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file JPX dengan path lengkap.
        * Atur opsi untuk mengonversi file JPX ke format PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.jpx"))
        {
        	// Setel opsi tampilan 
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa JPX"
    content: |
        Tampilkan file JPX sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/JPX). Demo langsung memiliki manfaat sebagai berikut.
