...
head_description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan Excel dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "Excel Penampil File Untuk Aplikasi C# .NET" 
description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan file Excel dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan pemformatan & tata letak sebenarnya dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode." 
...
steps:
    enable: true
    title_left: "Langkah-langkah Render file Excel di C#" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) Anda dapat merender Excel ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file Excel ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "Excel Demo Langsung Pemirsa"
    content: |
        Lihat file Excel sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/excel).
    lang: "id"
