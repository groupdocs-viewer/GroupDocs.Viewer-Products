...
head_title: ".NET JP2 Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan JP2 di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "JP2 File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file JP2 dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File JP2 di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file JP2 dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file JP2 dengan path lengkap.
        * Atur opsi untuk mengonversi file JP2 ke format PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.jp2"))
        {
        	// Setel opsi tampilan 
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa JP2"
    content: |
        Tampilkan file JP2 sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/JP2). Demo langsung memiliki manfaat sebagai berikut.
