...
steps:
    enable: true
    title_left: "Steps to Render NSF file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render NSF to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render NSF file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View NSF file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/nsf) website.
    lang: "en"
