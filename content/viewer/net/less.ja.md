...
############################# Header ############################
title: "C# .NET アプリケーション用の LESS ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で LESS ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で LESS を HTML、JPEG、PNG、または PDF にレンダリングできます。
