...
head_title: ".NET DOT Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan DOT di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "DOT File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file DOT dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File DOT di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file DOT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file DOT dengan path lengkap.
        * Atur opsi untuk mengonversi file DOT ke format PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.dot"))
        {
        	// Setel opsi tampilan 
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa DOT"
    content: |
        Tampilkan file DOT sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/DOT). Demo langsung memiliki manfaat sebagai berikut.
