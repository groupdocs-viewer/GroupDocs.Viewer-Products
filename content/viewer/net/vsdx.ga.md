...
############################# Head #############################
head_title: ".NET VSDX Viewer API - Léigh, Amharc, Rindreáil i C# VB.NET"
head_description: "API breathnóir doiciméad .NET chun VSDX a léamh, a sholáthar agus a thaispeáint in aon chineál feidhmchláir C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "Vsdx Amharcóir Comhad Le haghaidh Feidhmchláir C# .NET" 
description: ".NET document viewer API chun comhad VSDX a léamh, a sholáthar agus a thaispeáint in aon chineál feidhmchláir C#, ASP.NET, VB.NET & .NET Core. Féach ar na comhaid rindreáilte le fíorfhormáidiú & leagan amach in HTML5, PDF nó mar íomhá ag baint úsáide as cúpla líne den chód." 
...
steps:
    enable: true
    title_left: "Céimeanna chun comhad VSDX a rindreáil in C#" 
    content_left: |
        Le [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) is féidir leat VSDX a dhéanamh go HTML, JPEG, PNG nó PDF i gcúpla céim.
