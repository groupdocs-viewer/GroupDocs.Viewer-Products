...
############################# Head #############################
head_title: ".NET MHTML Viewer API – čtení, prohlížení, vykreslování v C# VB.NET"
head_description: "API prohlížeče dokumentů .NET pro čtení, vykreslování a zobrazování MHTML v jakémkoli typu aplikací C#, ASP.NET, VB.NET a .NET Core."

############################# Header ############################
title: "MHTML Prohlížeč souborů pro aplikace C# .NET" 
description: "API prohlížeče dokumentů .NET pro čtení, vykreslování a zobrazení souboru MHTML v jakémkoli typu aplikací C#, ASP.NET, VB.NET a .NET Core. Zobrazte vykreslené soubory se skutečným formátováním a rozložením v HTML5, PDF nebo jako obrázek pomocí několika řádků kódu." 
...
steps:
    enable: true
    title_left: "Kroky k vykreslení souboru MHTML v C#" 
    content_left: |
        Pomocí [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) můžete vykreslit MHTML do HTML, JPEG, PNG nebo PDF v několika krocích.
