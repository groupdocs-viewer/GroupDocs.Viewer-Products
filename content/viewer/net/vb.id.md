...
head_title: ".NET VB Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan VB dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "VB File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file VB dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File VB di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file VB dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file VB dengan path lengkap.
        * Atur opsi untuk mengonversi file VB ke format PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.vb"))
        {
        	// Setel opsi tampilan 
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa VB"
    content: |
        Tampilkan file VB sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/VB). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-vb"
          title: "Tentang Format Berkas VB"
          content: |
            File VB adalah file kode sumber yang dibuat dalam bahasa Visual Basic yang dibuat oleh Microsoft untuk pengembangan aplikasi .NET. Bahasa serupa lainnya dengan sintaks yang berbeda adalah C# yang filenya disimpan dengan ekstensi file .CS. Format file menyediakan bahasa pemrograman tingkat rendah untuk menulis kode yang dikompilasi untuk menghasilkan file keluaran akhir dalam bentuk EXE atau DLL. Ini dapat dibuat dan dikompilasi dengan Microsoft Visual Studio. Microsoft Visual Studio Express juga dapat digunakan untuk membuat dan memperbarui file tersebut yang merupakan IDE gratis. Solusi proyek Visual Studio sederhana yang dibuat dengan bahasa VB dapat terdiri dari satu atau lebih file semacam itu. File yang ditandai untuk dimasukkan dalam kompilasi terdaftar dalam file CSPROJ yang merupakan bagian dari proyek dan memberitahu kompiler untuk menggunakan file yang ditandai.
