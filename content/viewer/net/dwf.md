...
steps:
    enable: true
    title_left: "Steps for View DWF File in C#"
    content_left: |
        ...
        *   Set options to convert DWF file into PNG format.
...
demos:
    ...
    content: |
        Display DWF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/dwf) website.  
