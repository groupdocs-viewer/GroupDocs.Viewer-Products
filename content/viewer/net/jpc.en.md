...
steps:
    enable: true
    title_left: "Steps to Render JPC file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render JPC to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render JPC file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View JPC file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/jpc) website.
    lang: "en"
