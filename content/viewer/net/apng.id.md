...
head_title: ".NET APNG Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan APNG di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "APNG File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file APNG dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File APNG di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file APNG dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file APNG dengan path lengkap.
        * Atur opsi untuk mengonversi file APNG ke format PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.apng"))
        {
        	// Setel opsi tampilan 
