...
############################# Header ############################
title: "C# .NET アプリケーション用の SASS ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SASS ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SASS を HTML、JPEG、PNG、または PDF にレンダリングできます。
