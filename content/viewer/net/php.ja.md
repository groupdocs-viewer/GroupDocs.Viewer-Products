...
############################# Header ############################
title: "C# .NET アプリケーション用の PHP ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PHP ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PHP を HTML、JPEG、PNG、または PDF にレンダリングできます。
