...
head_description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan H dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "H Penampil File Untuk Aplikasi C# .NET" 
description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan file H dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan pemformatan & tata letak sebenarnya dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode." 
...
steps:
    enable: true
    title_left: "Langkah-langkah Render file H di C#" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) Anda dapat merender H ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.
        ...
        * Setel opsi untuk merender file H ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "H Demo Langsung Pemirsa"
    content: |
        Lihat file H sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/h).
    lang: "id"
