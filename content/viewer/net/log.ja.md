...
############################# Header ############################
title: "C# .NET アプリケーション用の LOG ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で LOG ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で LOG を HTML、JPEG、PNG、または PDF にレンダリングできます。
