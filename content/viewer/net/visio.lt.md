...
############################# Head #############################
head_title: ".NET Visio peržiūros programos API – skaitykite, žiūrėkite, atvaizduokite C# VB.NET"
head_description: ".NET dokumentų peržiūros programos API, skirta skaityti, pateikti ir rodyti Visio bet kokio tipo C#, ASP.NET, VB.NET ir .NET Core programose."

############################# Header ############################
title: "Visio failų peržiūros programa, skirta C# .NET programoms" 
description: ".NET dokumentų peržiūros programa, skirta skaityti, pateikti ir rodyti Visio failą bet kokio tipo C#, ASP.NET, VB.NET ir .NET Core programose. Peržiūrėkite pateiktus failus su tikru formatavimu ir išdėstymu HTML5, PDF formatu arba kaip vaizdą naudodami kelias kodo eilutes." 
...
steps:
    enable: true
    title_left: "Veiksmai, kaip pateikti Visio failą C#" 
    content_left: |
        Naudodami [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) atlikdami kelis veiksmus galite pateikti Visio į HTML, JPEG, PNG arba PDF.

        * Įdiekite [GroupDocs.Viewer for .NET](https://www.nuget.org/packages/groupdocs.viewer) naudodami mėgstamą paketų tvarkyklę. 
        * Sukurkite Viewer klasės egzempliorių ir įkelkite failą Visio su visu keliu. 
        * Nustatykite parinktis, kaip pateikti Visio failą HTML, PNG, JPEG arba PDF formatu. 
...
demos:
    enable: true
    title: "Visio žiūrovo tiesioginė demonstracija"
    content: |
        Peržiūrėkite Visio failą dabar apsilankę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/visio) svetainėje.
    lang: "lt"
