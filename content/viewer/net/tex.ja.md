...
############################# Header ############################
title: "C# .NET アプリケーション用の TEX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TEX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TEX を HTML、JPEG、PNG、または PDF にレンダリングできます。
