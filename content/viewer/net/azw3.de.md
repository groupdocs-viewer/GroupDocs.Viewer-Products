...
steps:
    enable: true
    title: "Schritte zum Rendern der AZW3-Datei in C#" 
    content: |
      Mit <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> können Sie AZW3 in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
      ...
      2. Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei AZW3 mit dem vollständigen Pfad.  
      3. Legen Sie Optionen fest, um die Datei AZW3 im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
    ...
    code:
      ...
      content: |
        ...
        // Richten Sie die Eingabedatei AZW3 ein
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Rendern Sie die Datei AZW3 mit eingebetteten Ressourcen in HTML
