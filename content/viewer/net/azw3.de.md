...
############################# Head #############################
head_title: ".NET AZW3 Viewer-API – Lesen, Anzeigen, Rendern in C# VB.NET"
head_description: ".NET-Dokument-Viewer-API zum Lesen, Rendern und Anzeigen von AZW3 in allen Arten von C#-, ASP.NET-, VB.NET- und .NET Core-Anwendungen."

############################# Header ############################
title: "AZW3 Dateibetrachter für C# .NET-Anwendungen" 
description: ".NET-Dokument-Viewer-API zum Lesen, Rendern und Anzeigen von AZW3-Dateien in allen Arten von C#-, ASP.NET-, VB.NET- und .NET Core-Anwendungen. Zeigen Sie die gerenderten Dateien mit echter Formatierung und echtem Layout in HTML5, PDF oder als Bild an, indem Sie ein paar Codezeilen verwenden." 
...
steps:
    enable: true
    title_left: "Schritte zum Rendern der AZW3-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie AZW3 in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
        ...
        * Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei AZW3 mit dem vollständigen Pfad. 
        * Legen Sie Optionen fest, um die Datei AZW3 im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
...
demos:
    enable: true
    title: "AZW3 Viewer-Live-Demo"
    content: |
        Sehen Sie sich die Datei AZW3 jetzt auf der Website von [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/azw3) an.
    lang: "de"
