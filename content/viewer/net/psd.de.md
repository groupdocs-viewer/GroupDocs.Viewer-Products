...
steps:
    enable: true
    title_left: "Schritte zum Rendern der PSD-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie PSD in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
