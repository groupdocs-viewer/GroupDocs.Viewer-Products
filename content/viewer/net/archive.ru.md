...
draft: false
############################# Head ############################
head_title: ".NET Archive Viewer API — чтение, просмотр, рендеринг на C# VB.NET"
head_description: ".NET для просмотра документов для чтения, рендеринга и отображения архивного файла в приложениях C#, ASP.NET, VB.NET и .NET Core любого типа."
############################# Header ############################
title: "Средство просмотра архивных файлов для приложений C# .NET"
description: ".NET для просмотра документов для чтения, рендеринга и отображения файла архива в приложениях C#, ASP.NET, VB.NET и .NET Core любого типа. Просматривайте визуализированные файлы с истинным форматированием и макетом в формате HTML5, PDF или в виде изображения, используя несколько строк кода."
bg_overlay: false
button:
    enable: true
...
steps:
    enable: true
    title_left: "Шаги для просмотра архивного файла в C#"
    content_left: |
        [GroupDocs.Viewer](/ru/viewer/net/) позволяет разработчикам .NET легко добавлять функцию просмотра архивных файлов в свои приложения, выполняя несколько простых шагов.
        * Создайте экземпляр класса Viewer и загрузите ZIP-файл с полным путем.
        * Установите параметры для преобразования ZIP-файла в формат PNG.
...
demos:
    enable: true
    title: "Просмотрщик архивов Живые демонстрации"
    content: |
       Отобразите файл Archive прямо сейчас, посетив веб-сайт [GroupDocs.Viewer Живые волнения](https://products.groupdocs.app/viewer/Archive).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        ...
        - icon: "far fa-file-archive-o"
          title: "О формате архивного файла"
          content: |
            Сжатие файлов — это процесс уменьшения размера одного или нескольких файлов. Он сжимает большие файлы в гораздо меньшие, удаляя ненужные данные. Архив сжатых файлов упрощает отправку и резервное копирование больших файлов или групп файлов. Более того, такие файлы упрощают загрузку и позволяют хранить больше данных на съемных носителях. Существуют различные форматы сжатия. Ниже мы собираемся обсудить самые популярные форматы файлов сжатия и наиболее рекомендуемое программное обеспечение, которое их использует.
          link: "https://docs.fileformat.com/compression/"
############################# More Formats ############################
more_formats:
    enable: true
