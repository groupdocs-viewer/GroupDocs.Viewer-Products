...
############################# Header ############################
title: "TIFF C# .NET アプリケーション用のファイル ビューア" 
...
steps:
    enable: true
    title_left: "C# で TIFF ファイルをレンダリングする手順" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) を使用すると、いくつかの手順で TIFF を HTML、JPEG、PNG、または PDF にレンダリングできます。
