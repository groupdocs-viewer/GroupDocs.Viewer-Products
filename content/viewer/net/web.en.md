...
head_description: ".NET document viewer API to read, render and display Web in any type of C#, ASP.NET, VB.NET & .NET Core applications."
...
steps:
    enable: true
    title_left: "Steps to Render Web file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render Web to HTML, JPEG, PNG or PDF in a few steps.
