...
############################# Header ############################
title: "C# .NET アプリケーション用の VTX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VTX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VTX を HTML、JPEG、PNG、または PDF にレンダリングできます。
