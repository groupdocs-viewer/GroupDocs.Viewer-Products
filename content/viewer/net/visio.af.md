...
############################# Head #############################
head_title: ".NET Visio Kyker-API - Lees, bekyk, lewer in C# VB.NET"
head_description: ".NET dokumentkyker-API om Visio te lees, weer te gee en te vertoon in enige tipe C#-, ASP.NET-, VB.NET- en .NET Core-toepassings."

############################# Header ############################
title: "Visio Lêerkyker vir C# .NET-toepassings" 
description: ".NET-dokumentkyker-API om Visio-lêer te lees, weer te gee en te vertoon in enige tipe C#-, ASP.NET-, VB.NET- en .NET Core-toepassings. Bekyk die gelewerde lêers met ware formatering en uitleg in HTML5, PDF of as 'n prent deur 'n paar reëls van die kode te gebruik." 
...
steps:
    enable: true
    title_left: "Stappe om Visio-lêer in C# weer te gee" 
    content_left: |
        Met [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) kan jy Visio in 'n paar stappe na HTML, JPEG, PNG of PDF weergee.
