...
############################# Header ############################
title: "C# .NET アプリケーション用の SQL ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SQL ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SQL を HTML、JPEG、PNG、または PDF にレンダリングできます。
