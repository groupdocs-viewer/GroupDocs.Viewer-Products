...
############################# Header ############################
title: "C# .NET アプリケーション用の WEBP ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で WEBP ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で WEBP を HTML、JPEG、PNG、または PDF にレンダリングできます。
