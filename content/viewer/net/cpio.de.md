...
############################# Head #############################
head_title: ".NET CPIO Viewer-API – Lesen, Anzeigen, Rendern in C# VB.NET"
head_description: ".NET-Dokument-Viewer-API zum Lesen, Rendern und Anzeigen von CPIO in allen Arten von C#-, ASP.NET-, VB.NET- und .NET Core-Anwendungen."

############################# Header ############################
title: "CPIO Dateibetrachter für C# .NET-Anwendungen" 
description: ".NET-Dokument-Viewer-API zum Lesen, Rendern und Anzeigen von CPIO-Dateien in allen Arten von C#-, ASP.NET-, VB.NET- und .NET Core-Anwendungen. Zeigen Sie die gerenderten Dateien mit echter Formatierung und echtem Layout in HTML5, PDF oder als Bild an, indem Sie ein paar Codezeilen verwenden." 
...
steps:
    enable: true
    title_left: "Schritte zum Rendern der CPIO-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie CPIO in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
        ...
        * Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei CPIO mit dem vollständigen Pfad. 
        * Legen Sie Optionen fest, um die Datei CPIO im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
...
demos:
    enable: true
    title: "CPIO Viewer-Live-Demo"
    content: |
        Sehen Sie sich die Datei CPIO jetzt auf der Website von [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cpio) an.
    lang: "de"
