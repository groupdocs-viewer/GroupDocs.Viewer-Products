...
steps:
    enable: true
    title: "Schritte zum Rendern der CPIO-Datei in C#" 
    content: |
      Mit <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> können Sie CPIO in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
      ...
      2. Erstellen Sie eine Instanz der Viewer-Klasse und laden Sie die Datei CPIO mit dem vollständigen Pfad.  
      3. Legen Sie Optionen fest, um die Datei CPIO im HTML-, PNG-, JPEG- oder PDF-Format zu rendern. 
    ...
    code:
      ...
      content: |
        ...
        // Richten Sie die Eingabedatei CPIO ein
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Rendern Sie die Datei CPIO mit eingebetteten Ressourcen in HTML
