...
steps:
    enable: true
    title: "Steps to render OBJ file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> you can render OBJ to HTML, JPEG, PNG or PDF in a few steps.
      ...
      2. Create an instance of Viewer class and load the OBJ file with full path.  
      3. Set options to render OBJ file into HTML, PNG, JPEG or PDF format. 
