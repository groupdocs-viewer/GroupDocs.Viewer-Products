...
############################# Header ############################
title: "C# .NET アプリケーション用の MAKE ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MAKE ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MAKE を HTML、JPEG、PNG、または PDF にレンダリングできます。
