...
############################# Header ############################
title: "C# .NET アプリケーション用の TXZ ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TXZ ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TXZ を HTML、JPEG、PNG、または PDF にレンダリングできます。
