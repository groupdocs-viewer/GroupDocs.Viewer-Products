...
############################# Header ############################
title: "C# .NET アプリケーション用の TAR ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TAR ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TAR を HTML、JPEG、PNG、または PDF にレンダリングできます。
