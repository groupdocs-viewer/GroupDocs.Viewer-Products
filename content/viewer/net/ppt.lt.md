...
############################# Head #############################
head_title: ".NET PPT peržiūros programos API – skaitykite, žiūrėkite, atvaizduokite C# VB.NET"
head_description: ".NET dokumentų peržiūros programos API, skirta skaityti, pateikti ir rodyti PPT bet kokio tipo C#, ASP.NET, VB.NET ir .NET Core programose."

############################# Header ############################
title: "PPT failų peržiūros programa, skirta C# .NET programoms" 
description: ".NET dokumentų peržiūros programa, skirta skaityti, pateikti ir rodyti PPT failą bet kokio tipo C#, ASP.NET, VB.NET ir .NET Core programose. Peržiūrėkite pateiktus failus su tikru formatavimu ir išdėstymu HTML5, PDF formatu arba kaip vaizdą naudodami kelias kodo eilutes." 
...
steps:
    enable: true
    title_left: "Veiksmai, kaip pateikti PPT failą C#" 
    content_left: |
        Naudodami [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) atlikdami kelis veiksmus galite pateikti PPT į HTML, JPEG, PNG arba PDF.

        * Įdiekite [GroupDocs.Viewer for .NET](https://www.nuget.org/packages/groupdocs.viewer) naudodami mėgstamą paketų tvarkyklę. 
        * Sukurkite Viewer klasės egzempliorių ir įkelkite failą PPT su visu keliu. 
        * Nustatykite parinktis, kaip pateikti PPT failą HTML, PNG, JPEG arba PDF formatu. 
...
demos:
    enable: true
    title: "PPT žiūrovo tiesioginė demonstracija"
    content: |
        Peržiūrėkite PPT failą dabar apsilankę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/ppt) svetainėje.
    lang: "lt"
