...
############################# Header ############################
title: "C# .NET アプリケーション用の SCRIPT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SCRIPT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SCRIPT を HTML、JPEG、PNG、または PDF にレンダリングできます。
