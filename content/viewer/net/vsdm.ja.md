...
############################# Header ############################
title: "C# .NET アプリケーション用の VSDM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSDM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSDM を HTML、JPEG、PNG、または PDF にレンダリングできます。
