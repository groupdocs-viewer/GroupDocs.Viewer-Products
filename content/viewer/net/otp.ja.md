...
############################# Header ############################
title: "C# .NET アプリケーション用の OTP ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で OTP ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で OTP を HTML、JPEG、PNG、または PDF にレンダリングできます。
