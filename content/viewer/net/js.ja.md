...
############################# Header ############################
title: "C# .NET アプリケーション用の JS ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で JS ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で JS を HTML、JPEG、PNG、または PDF にレンダリングできます。
