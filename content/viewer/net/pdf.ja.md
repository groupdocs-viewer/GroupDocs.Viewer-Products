...
############################# Header ############################
title: "C# .NET アプリケーション用の PDF ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PDF ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PDF を HTML、JPEG、PNG、または PDF にレンダリングできます。
