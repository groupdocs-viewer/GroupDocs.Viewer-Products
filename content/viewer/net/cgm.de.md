...
steps:
    enable: true
    title_left: "Schritte zum Rendern der CGM-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie CGM in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
