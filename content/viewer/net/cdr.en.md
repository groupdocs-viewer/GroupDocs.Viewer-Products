...
steps:
    enable: true
    title_left: "Steps to Render CDR file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render CDR to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render CDR file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View CDR file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cdr) website.
    lang: "en"
