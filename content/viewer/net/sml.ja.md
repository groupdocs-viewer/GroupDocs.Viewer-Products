...
############################# Header ############################
title: "C# .NET アプリケーション用の SML ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SML ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SML を HTML、JPEG、PNG、または PDF にレンダリングできます。
