...
draft: false
############################# Head ############################
head_title: ".NET API просмотра PSB — чтение, просмотр, рендеринг на C# VB.NET"
head_description: ".NET для просмотра документов для чтения, рендеринга и отображения PSB в приложениях C#, ASP.NET, VB.NET и .NET Core любого типа."
############################# Header ############################
title: "Средство просмотра файлов PSB для приложений C# .NET"
description: ".NET для просмотра документов для чтения, рендеринга и отображения файла PSB в приложениях C#, ASP.NET, VB.NET и .NET Core любого типа. Просматривайте визуализированные файлы с истинным форматированием и макетом в формате HTML5, PDF или в виде изображения, используя несколько строк кода."
bg_overlay: false
button:
    enable: true
...
steps:
    enable: true
    title_left: "Шаги для просмотра файла PSB в C#"
    content_left: |
        [GroupDocs.Viewer](/ru/viewer/net/) позволяет разработчикам .NET легко добавлять функцию просмотра файлов PSB в свои приложения, выполняя несколько простых шагов.
        * Создайте экземпляр класса Viewer и загрузите файл PSB с полным путем.
        * Установите параметры для преобразования файла PSB в формат PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.psb"))
        {
...
demos:
    enable: true
    title: "Демоверсии PSB Viewer"
    content: |
       Отобразите файл PSB прямо сейчас, посетив веб-сайт [GroupDocs.Viewer Живые волнения](https://products.groupdocs.app/viewer/PSB).
############################# About Formats ############################
about_formats:
    enable: true
    format:
        ...
        - icon: "far fa-file-image-o"
          title: "О формате файла PSB"
          content: |
            Adobe Photoshop сохраняет файлы в двух форматах. Файлы размером 30 000 на 30 000 пикселей сохраняются с расширением PSD, а файлы размером больше PSD до 300 000 на 300 000 пикселей сохраняются с расширением PSB, известным как «Photoshop Big». В частности, файлы PSB могут иметь размер до 4 ЭБ (более 4,2 миллиарда ГБ) с изображениями высотой и шириной до 300 000 пикселей. С другой стороны, PSD-файлы могут иметь максимальный размер до 2 ГБ и размеры изображения 30 000 пикселей. PSB также известен как большой формат для фотошопа и поддерживает все функции фотошопа, такие как слои, эффекты и фильтры. Photoshop также может конвертировать файл PSB в PSD, JPG, PNG, EPS, GIF и другие форматы. Большой формат документа Photoshop доступен после включения функции панели обработки файлов в диалоговом окне настроек Photoshop.
