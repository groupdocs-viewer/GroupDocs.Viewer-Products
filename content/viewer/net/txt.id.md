...
head_title: ".NET TXT Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan TXT di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "TXT File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file TXT dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File TXT di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file TXT dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file TXT dengan path lengkap.
        * Atur opsi untuk mengonversi file TXT ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa TXT"
    content: |
        Tampilkan file TXT sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/TXT). Demo langsung memiliki manfaat sebagai berikut.
