...
overview:
  ...
  features:
    ...
    - title: "Vea documentos de manera eficiente y confiable"
      content: "Con la API GroupDocs.Viewer puede renderizar documentos de cualquier formato compatible a [HTML](https://docs.groupdocs.com/viewer/net/rendering-to-html/), [JPEG, PNG](https://docs.groupdocs.com/viewer/net/rendering-to-png-or-jpeg/), y [PDF](https://docs.groupdocs.com/viewer/net/rendering-to-pdf/) con opciones flexibles y potentes, manteniendo la integridad del contenido y la estructura del documento. GroupDocs.Viewer es compatible con .NET Framework 4.6.2 y .NET 6.0 y funciona en plataformas Windows y Linux."
  ...
  groups:
    ...
    - color: "green"
      content: |
        ...
        * **Project:** MPP, MPT, MPX {{< landing/tooltip icon="windows" title="Compatible con el paquete específico de Windows" >}}
        * **Outlook:** MSG, EML, EMLX, PST, OST
        * **OneNote:** ONE {{< landing/tooltip icon="windows" title="Compatible con el paquete específico de Windows" >}}
    ...
    - color: "blue"
      content: |
        ...
        * **Adobe Photoshop:** PSD, PSB {{< landing/tooltip icon="windows" title="Compatible con el paquete específico de Windows" >}}       
    ...
    - color: "red"
      content: |
        ...
        * **Visio:** VSD, VDX, VSS, VSSX, VSX, VST, VSTX, VTX, VSDX, VDW, VSTM, VSSM, VSDM {{< landing/tooltip icon="windows" title="Compatible con el paquete específico de Windows" >}}
        * **Project:** MPP, MPT, MPX
        * **PostScript:** PS, EPS
...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Ver documentos en HTML](https://blog.groupdocs.com/viewer/view-word-documents-as-html-responsive-page-using-csharp/)"
    ...
    # feature loop
    - icon: "font"
      title: "[Controlar fuentes del documento](https://blog.groupdocs.com/viewer/working-with-fonts/)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Convertir a PDF](https://blog.groupdocs.com/viewer/rendering-documents-as-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Aplicar transformaciones](https://blog.groupdocs.com/viewer/protect-your-documents-with-watermarks-in-groupdocs-viewer-for-dot-net/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Ajuste de salida HTML](https://blog.groupdocs.com/viewer/render-word-documents-as-clean-html-using-csharp/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Soporte de estructuras de documentos complejas.](https://blog.groupdocs.com/viewer/process-microsoft-outlook-email-attachments-in-a-.net-viewer-application/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Opciones de optimización](https://blog.groupdocs.com/viewer/exclude-specific-fonts-from-output-html-using-groupdocs.viewer-for-.net-18.10/)"
    ...
    - icon: "passwordprotected"
      title: "[Soporte de documentos protegidos con contraseña.](https://docs.groupdocs.com/viewer/net/load-password-protected-document/)"
