...
steps:
    enable: true
    title_left: "Steps to Render PHP file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render PHP to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render PHP file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View PHP file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/php) website.
    lang: "en"
