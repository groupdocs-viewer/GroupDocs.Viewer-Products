...
############################# Head #############################
head_title: ".NET MSG Viewer API - Leer, Ver, Renderizar en C# VB.NET"
...
steps:
    enable: true
    title_left: "Pasos para procesar el archivo MSG en C#" 
    content_left: |
        Con [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) puede representar MSG a HTML, JPEG, PNG o PDF en unos pocos pasos.
