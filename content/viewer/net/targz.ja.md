...
############################# Header ############################
title: "C# .NET アプリケーション用の TARGZ ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TARGZ ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TARGZ を HTML、JPEG、PNG、または PDF にレンダリングできます。
