...
steps:
    enable: true
    title_left: "Steps to Render SML file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render SML to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render SML file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View SML file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/sml) website.
    lang: "en"
