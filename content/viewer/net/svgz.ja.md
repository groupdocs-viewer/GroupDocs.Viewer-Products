...
############################# Header ############################
title: "C# .NET アプリケーション用の SVGZ ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SVGZ ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SVGZ を HTML、JPEG、PNG、または PDF にレンダリングできます。
