...
steps:
    enable: true
    title_left: "Steps to Render DOCX file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render DOCX to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render DOCX file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View DOCX file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/docx) website.
    lang: "en"
