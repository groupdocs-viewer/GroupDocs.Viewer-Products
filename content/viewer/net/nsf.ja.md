...
############################# Header ############################
title: "C# .NET アプリケーション用の NSF ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で NSF ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で NSF を HTML、JPEG、PNG、または PDF にレンダリングできます。
