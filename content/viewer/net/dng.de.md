...
steps:
    enable: true
    title_left: "Schritte zum Rendern der DNG-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie DNG in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
