...
############################# Header ############################
title: "C# .NET アプリケーション用の PSD1 ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PSD1 ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PSD1 を HTML、JPEG、PNG、または PDF にレンダリングできます。
