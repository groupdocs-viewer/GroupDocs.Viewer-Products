...
############################# Head #############################
head_title: "API visualizzatore .NET CPIO: lettura, visualizzazione, rendering in C# VB.NET"
head_description: "API per visualizzatore di documenti .NET per leggere, eseguire il rendering e visualizzare CPIO in qualsiasi tipo di applicazioni C#, ASP.NET, VB.NET e .NET Core."

############################# Header ############################
title: "Visualizzatore di file CPIO per applicazioni C# .NET" 
description: "API per visualizzatore di documenti .NET per leggere, eseguire il rendering e visualizzare file CPIO in qualsiasi tipo di applicazioni C#, ASP.NET, VB.NET e .NET Core. Visualizza i file renderizzati con formattazione e layout reali in HTML5, PDF o come immagine utilizzando poche righe di codice." 
...
steps:
    enable: true
    title: "Passaggi per eseguire il rendering del file CPIO in C#" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> puoi eseguire il rendering di CPIO in HTML, JPEG, PNG o PDF in pochi passaggi.
      ...
      2. Crea un'istanza della classe Viewer e carica il file CPIO con il percorso completo.  
      3. Imposta le opzioni per eseguire il rendering del file CPIO nel formato HTML, PNG, JPEG o PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configura il file di input CPIO
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Visualizza il file CPIO in HTML con risorse incorporate
