...
############################# Head #############################
head_title: ".NET PDF peržiūros programos API – skaitykite, žiūrėkite, atvaizduokite C# VB.NET"
head_description: ".NET dokumentų peržiūros programos API, skirta skaityti, pateikti ir rodyti PDF bet kokio tipo C#, ASP.NET, VB.NET ir .NET Core programose."

############################# Header ############################
title: "PDF failų peržiūros programa, skirta C# .NET programoms" 
description: ".NET dokumentų peržiūros programa, skirta skaityti, pateikti ir rodyti PDF failą bet kokio tipo C#, ASP.NET, VB.NET ir .NET Core programose. Peržiūrėkite pateiktus failus su tikru formatavimu ir išdėstymu HTML5, PDF formatu arba kaip vaizdą naudodami kelias kodo eilutes." 
...
steps:
    enable: true
    title_left: "Veiksmai, kaip pateikti PDF failą C#" 
    content_left: |
        Naudodami [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) atlikdami kelis veiksmus galite pateikti PDF į HTML, JPEG, PNG arba PDF.

        * Įdiekite [GroupDocs.Viewer for .NET](https://www.nuget.org/packages/groupdocs.viewer) naudodami mėgstamą paketų tvarkyklę. 
        * Sukurkite Viewer klasės egzempliorių ir įkelkite failą PDF su visu keliu. 
        * Nustatykite parinktis, kaip pateikti PDF failą HTML, PNG, JPEG arba PDF formatu. 
...
demos:
    enable: true
    title: "PDF žiūrovo tiesioginė demonstracija"
    content: |
        Peržiūrėkite PDF failą dabar apsilankę [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/pdf) svetainėje.
    lang: "lt"
