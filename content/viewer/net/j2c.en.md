...
steps:
    enable: true
    title_left: "Steps to Render J2C file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render J2C to HTML, JPEG, PNG or PDF in a few steps.
