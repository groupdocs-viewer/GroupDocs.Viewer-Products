...
head_title: ".NET ZIP Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan ZIP di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "ZIP File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file ZIP dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File ZIP di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file ZIP dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa ZIP"
    content: |
        Tampilkan file ZIP sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/ZIP). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-zip"
          title: "Tentang Format Berkas ZIP"
          content: |
            Ekstensi file ZIP mewakili arsip yang dapat menampung satu atau lebih file atau direktori. Arsip dapat memiliki kompresi yang diterapkan ke file yang disertakan untuk mengurangi ukuran file ZIP. Format file ZIP dipublikasikan kembali pada Februari 1989 oleh Phil Katz untuk mencapai pengarsipan file dan folder. Format ini menjadi bagian dari utilitas PKZIP, dibuat oleh PKWARE, Inc. Tepat setelah ketersediaan spesifikasi yang tersedia, banyak perusahaan menjadikan format file ZIP sebagai bagian dari utilitas perangkat lunak mereka termasuk Microsoft (sejak Windows 7), Apple (Mac OS X ) dan banyak lagi yang lain.
