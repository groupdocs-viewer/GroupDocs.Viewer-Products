...
############################# Header ############################
title: "C# .NET アプリケーション用の CC ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で CC ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で CC を HTML、JPEG、PNG、または PDF にレンダリングできます。
