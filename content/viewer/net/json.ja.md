...
############################# Header ############################
title: "C# .NET アプリケーション用の JSON ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で JSON ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で JSON を HTML、JPEG、PNG、または PDF にレンダリングできます。
