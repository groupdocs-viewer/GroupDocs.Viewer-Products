...
############################# Header ############################
title: "C# .NET アプリケーション用の SXC ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SXC ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SXC を HTML、JPEG、PNG、または PDF にレンダリングできます。
