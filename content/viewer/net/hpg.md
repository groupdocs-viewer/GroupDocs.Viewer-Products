...
steps:
    enable: true
    title_left: "Steps for View HPG File in C#"
    content_left: |
        ...
        *   Set options to convert HPG file into PNG format.
...
demos:
    ...
    content: |
        Display HPG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/hpg) website.  
