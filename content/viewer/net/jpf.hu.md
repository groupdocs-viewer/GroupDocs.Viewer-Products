...
############################# Head #############################
head_title: ".NET JPF Viewer API – olvasás, megtekintés, renderelés C# VB.NET-ben"
head_description: ".NET dokumentumnézegető API a JPF olvasásához, megjelenítéséhez és megjelenítéséhez bármilyen típusú C#, ASP.NET, VB.NET és .NET Core alkalmazásokban."

############################# Header ############################
title: "JPF Fájlnézegető C# .NET alkalmazásokhoz" 
description: ".NET dokumentumnézegető API JPF fájlok olvasásához, megjelenítéséhez és megjelenítéséhez bármilyen típusú C#, ASP.NET, VB.NET és .NET Core alkalmazásokban. Tekintse meg a renderelt fájlokat valódi formázással és elrendezéssel HTML5-ben, PDF-ben vagy képként a kód néhány sorával." 
...
steps:
    enable: true
    title_left: "A JPF fájl renderelésének lépései a C# programban" 
    content_left: |
        A [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) segítségével néhány lépésben megjelenítheti a JPF fájlt HTML, JPEG, PNG vagy PDF formátumban.

        * Telepítse a [GroupDocs.Viewer for .NET] programot (https://www.nuget.org/packages/groupdocs.viewer) kedvenc csomagkezelőjével. 
        * Hozzon létre egy példányt a Viewer osztályból, és töltse be a JPF fájlt a teljes elérési úttal. 
        * Állítsa be a JPF fájl HTML, PNG, JPEG vagy PDF formátumban történő megjelenítését. 
...
demos:
    enable: true
    title: "JPF Viewer élő bemutató"
    content: |
        Tekintse meg a(z) JPF fájlt most a [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/jpf) webhelyen.
    lang: "hu"
