...
############################# Header ############################
title: "C# .NET アプリケーション用の OST ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で OST ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で OST を HTML、JPEG、PNG、または PDF にレンダリングできます。
