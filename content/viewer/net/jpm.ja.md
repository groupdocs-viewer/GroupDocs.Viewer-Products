...
############################# Header ############################
title: "C# .NET アプリケーション用の JPM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で JPM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で JPM を HTML、JPEG、PNG、または PDF にレンダリングできます。
