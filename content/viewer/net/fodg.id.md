...
head_title: ".NET FODG Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan FODG di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "FODG File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file FODG dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File FODG di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file FODG dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file FODG dengan path lengkap.
        * Atur opsi untuk mengonversi file FODG ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa FODG"
    content: |
        Tampilkan file FODG sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/FODG). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-fodg"
          title: "Tentang Format Berkas FODG"
          content: |
            File dengan ekstensi .FODG adalah format file Apache OpenOffice Drawing untuk menyimpan elemen gambar. Ini didasarkan pada spesifikasi format file yang digariskan oleh Kemajuan Standar Informasi Struktural (OASIS). Format file serupa lainnya untuk grafik OpenOffice adalah ODG yang menyimpan elemen gambar sebagai gambar vektor. File FODG dapat dibuka dengan OpenOffice serta LibreOffice. Format file lain yang didukung oleh OpenOffice, misalnya, termasuk ODT, ODF, ODP dan ODS.
