...
steps:
    enable: true
    title: "Steps to render STL file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> you can render STL to HTML, JPEG, PNG or PDF in a few steps.
      ...
      2. Create an instance of Viewer class and load the STL file with full path.  
      3. Set options to render STL file into HTML, PNG, JPEG or PDF format. 
