...
############################# Head #############################
head_title: ".NET VIM Viewer API – olvasás, megtekintés, renderelés C# VB.NET-ben"
head_description: ".NET dokumentumnézegető API a VIM olvasásához, megjelenítéséhez és megjelenítéséhez bármilyen típusú C#, ASP.NET, VB.NET és .NET Core alkalmazásokban."

############################# Header ############################
title: "VIM Fájlnézegető C# .NET alkalmazásokhoz" 
description: ".NET dokumentumnézegető API VIM fájlok olvasásához, megjelenítéséhez és megjelenítéséhez bármilyen típusú C#, ASP.NET, VB.NET és .NET Core alkalmazásokban. Tekintse meg a renderelt fájlokat valódi formázással és elrendezéssel HTML5-ben, PDF-ben vagy képként a kód néhány sorával." 
...
steps:
    enable: true
    title_left: "A VIM fájl renderelésének lépései a C# programban" 
    content_left: |
        A [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) segítségével néhány lépésben megjelenítheti a VIM fájlt HTML, JPEG, PNG vagy PDF formátumban.

        * Telepítse a [GroupDocs.Viewer for .NET] programot (https://www.nuget.org/packages/groupdocs.viewer) kedvenc csomagkezelőjével. 
        * Hozzon létre egy példányt a Viewer osztályból, és töltse be a VIM fájlt a teljes elérési úttal. 
        * Állítsa be a VIM fájl HTML, PNG, JPEG vagy PDF formátumban történő megjelenítését. 
...
demos:
    enable: true
    title: "VIM Viewer élő bemutató"
    content: |
        Tekintse meg a(z) VIM fájlt most a [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/vim) webhelyen.
    lang: "hu"
