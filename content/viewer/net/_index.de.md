  ...
  groups:
    ...
    - color: "green"
      content: |
        ...
        * **Project:** MPP, MPT, MPX {{< landing/tooltip icon="windows" title="Unterstützt durch Windows-spezifisches Paket" >}}
        * **Outlook:** MSG, EML, EMLX, PST, OST
        * **OneNote:** ONE {{< landing/tooltip icon="windows" title="Unterstützt durch Windows-spezifisches Paket" >}}
    ...
    - color: "blue"
      content: |
        ...
        * **Adobe Photoshop:** PSD, PSB {{< landing/tooltip icon="windows" title="Unterstützt durch Windows-spezifisches Paket" >}}       
    ...
    - color: "red"
      content: |
        ...
        * **Visio:** VSD, VDX, VSS, VSSX, VSX, VST, VSTX, VTX, VSDX, VDW, VSTM, VSSM, VSDM {{< landing/tooltip icon="windows" title="Unterstützt durch Windows-spezifisches Paket" >}}
        * **Project:** MPP, MPT, MPX
        * **PostScript:** PS, EPS
...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Dokumente in HTML anzeigen](https://blog.groupdocs.com/viewer/view-word-documents-as-html-responsive-page-using-csharp/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Dokumente rastern](https://docs.groupdocs.com/viewer/net/rendering-to-png-or-jpeg/)"
    ...
    # feature loop
    - icon: "font"
      title: "[Steuerung von Dokumentschriftarten](https://blog.groupdocs.com/viewer/working-with-fonts/)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[In PDF konvertieren](https://blog.groupdocs.com/viewer/rendering-documents-as-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Wenden Sie Transformationen an](https://blog.groupdocs.com/viewer/protect-your-documents-with-watermarks-in-groupdocs-viewer-for-dot-net/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Anpassung der HTML-Ausgabe](https://blog.groupdocs.com/viewer/render-word-documents-as-clean-html-using-csharp/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Unterstützung komplexer Dokumentenstrukturen](https://blog.groupdocs.com/viewer/process-microsoft-outlook-email-attachments-in-a-.net-viewer-application/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Optimierungsmöglichkeiten](https://blog.groupdocs.com/viewer/exclude-specific-fonts-from-output-html-using-groupdocs.viewer-for-.net-18.10/)"
    ...
    - icon: "passwordprotected"
      title: "[Unterstützung passwortgeschützter Dokumente](https://docs.groupdocs.com/viewer/net/load-password-protected-document/)"
