...
############################# Head #############################
head_title: ".NET VST Viewer API - Read, View, Render in C# VB.NET"
head_description: ".NET document viewer API to read, render and display VST in any type of C#, ASP.NET, VB.NET & .NET Core applications."
...
steps:
    enable: true
    title_left: "Steps to Render VST file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render VST to HTML, JPEG, PNG or PDF in a few steps.
