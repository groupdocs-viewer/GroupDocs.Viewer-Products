...
steps:
    enable: true
    title_left: "Steps for View TXT File in C#"
    content_left: |
        ...
        *   Set options to convert TXT file into PNG format.
...
demos:
    ...
    content: |
        Display TXT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/txt) website.  
