...
steps:
    enable: true
    title_left: "Steps to Render JPG file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render JPG to HTML, JPEG, PNG or PDF in a few steps.
...
demos:
    ...
    content: |
        View JPG file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/jpg) website.
    lang: "en"
