...
############################# Head #############################
head_title: ".NET BMP API de visor: leer, ver y representar en C# VB.NET"
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo BMP en C#" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> puede renderizar BMP a HTML, JPEG, PNG o PDF en unos pocos pasos.
