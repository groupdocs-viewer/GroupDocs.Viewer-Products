...
head_title: ".NET MOBI Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan MOBI di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "MOBI File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file MOBI dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File MOBI di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file MOBI dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file MOBI dengan path lengkap.
        * Atur opsi untuk mengonversi file MOBI ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa MOBI"
    content: |
        Tampilkan file MOBI sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/MOBI). Demo langsung memiliki manfaat sebagai berikut.
