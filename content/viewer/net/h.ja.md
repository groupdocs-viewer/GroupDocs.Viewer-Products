...
############################# Header ############################
title: "H C# .NET アプリケーション用のファイル ビューア" 
...
steps:
    enable: true
    title_left: "C# で H ファイルをレンダリングする手順" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) を使用すると、いくつかの手順で H を HTML、JPEG、PNG、または PDF にレンダリングできます。
