...
############################# Header ############################
title: "C# .NET アプリケーション用の RB ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で RB ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で RB を HTML、JPEG、PNG、または PDF にレンダリングできます。
