...
############################# Header ############################
title: "C# .NET アプリケーション用の OTT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で OTT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で OTT を HTML、JPEG、PNG、または PDF にレンダリングできます。
