...
############################# Header ############################
title: "C# .NET アプリケーション用の PPTX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PPTX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PPTX を HTML、JPEG、PNG、または PDF にレンダリングできます。
