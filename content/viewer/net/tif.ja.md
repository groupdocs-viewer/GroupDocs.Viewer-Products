...
############################# Header ############################
title: "C# .NET アプリケーション用の TIF ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TIF ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TIF を HTML、JPEG、PNG、または PDF にレンダリングできます。
