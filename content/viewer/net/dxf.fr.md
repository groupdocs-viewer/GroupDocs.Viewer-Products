...
############################# Head #############################
head_title: ".NET DXF API Viewer - Lire, Afficher, Rendre en C# VB.NET"
head_description: "API de visionneuse de documents .NET pour lire, restituer et afficher DXF dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "DXF Visionneuse de fichiers pour les applications C# .NET" 
...
steps:
    enable: true
    title_left: "Étapes pour rendre le fichier DXF dans C#" 
    content_left: |
        Avec [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/), vous pouvez rendre DXF au format HTML, JPEG, PNG ou PDF en quelques étapes.
