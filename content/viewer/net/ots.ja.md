...
############################# Header ############################
title: "C# .NET アプリケーション用の OTS ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で OTS ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で OTS を HTML、JPEG、PNG、または PDF にレンダリングできます。
