...
############################# Header ############################
title: "C# .NET アプリケーション用の PST ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PST ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PST を HTML、JPEG、PNG、または PDF にレンダリングできます。
