...
steps:
    enable: true
    title_left: "Steps to Render HH file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render HH to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render HH file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View HH file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/hh) website.
    lang: "en"
