...
steps:
    enable: true
    title_left: "Steps to Render EMF file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render EMF to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render EMF file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View EMF file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/emf) website.
    lang: "en"
