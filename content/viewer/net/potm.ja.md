...
############################# Header ############################
title: "C# .NET アプリケーション用の POTM ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で POTM ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で POTM を HTML、JPEG、PNG、または PDF にレンダリングできます。
