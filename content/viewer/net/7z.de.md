...
steps:
    enable: true
    title: "Schritte zum Rendern der 7Z-Datei in C#" 
    content: |
      Mit <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> können Sie 7Z in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
