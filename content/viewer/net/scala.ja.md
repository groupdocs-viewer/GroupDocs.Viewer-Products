...
############################# Header ############################
title: "C# .NET アプリケーション用の SCALA ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で SCALA ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で SCALA を HTML、JPEG、PNG、または PDF にレンダリングできます。
