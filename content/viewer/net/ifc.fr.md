...
############################# Head #############################
head_title: "API de la visionneuse .NET IFC - lire, afficher, rendre en C# VB.NET"
head_description: "API de visualisation de documents .NET pour lire, restituer et afficher IFC dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "IFC visionneuse de fichiers pour les applications C# .NET" 
...
steps:
    enable: true
    title: "Étapes pour restituer le fichier IFC dans C#" 
    content: |
      Avec <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a>, vous pouvez restituer IFC au format HTML, JPEG, PNG ou PDF en quelques étapes.
