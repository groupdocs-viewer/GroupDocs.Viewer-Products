...
steps:
    enable: true
    title_left: "Steps to Render ODT file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render ODT to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render ODT file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View ODT file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/odt) website.
    lang: "en"
