...
head_description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan TARXZ dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "TARXZ Penampil File Untuk Aplikasi C# .NET" 
description: "API penampil dokumen .NET untuk membaca, merender, dan menampilkan file TARXZ dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan pemformatan & tata letak sebenarnya dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode." 
...
steps:
    enable: true
    title_left: "Langkah-langkah Render file TARXZ di C#" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) Anda dapat merender TARXZ ke HTML, JPEG, PNG, atau PDF dalam beberapa langkah.

        * Instal [GroupDocs.Viewer untuk .NET](https://www.nuget.org/packages/groupdocs.viewer) menggunakan pengelola paket favorit Anda. 
        * Buat instance kelas Viewer dan muat file TARXZ dengan path lengkap. 
        * Setel opsi untuk merender file TARXZ ke dalam format HTML, PNG, JPEG, atau PDF. 
...
demos:
    enable: true
    title: "TARXZ Demo Langsung Pemirsa"
    content: |
        Lihat file TARXZ sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/tarxz).
    lang: "id"
