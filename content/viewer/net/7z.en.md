...
steps:
    enable: true
    title: "Steps to render 7Z file in C#" 
    content: |
      With <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> you can render 7Z to HTML, JPEG, PNG or PDF in a few steps.
