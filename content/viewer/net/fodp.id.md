...
head_title: ".NET FODP Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan FODP di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "FODP File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file FODP dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File FODP di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file FODP dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file FODP dengan path lengkap.
        * Atur opsi untuk mengonversi file FODP ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa FODP"
    content: |
        Tampilkan file FODP sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/FODP). Demo langsung memiliki manfaat sebagai berikut.
