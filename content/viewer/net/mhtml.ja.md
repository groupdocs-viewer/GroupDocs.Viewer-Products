...
############################# Header ############################
title: "C# .NET アプリケーション用の MHTML ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MHTML ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MHTML を HTML、JPEG、PNG、または PDF にレンダリングできます。
