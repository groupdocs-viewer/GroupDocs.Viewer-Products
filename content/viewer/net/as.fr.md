...
############################# Head #############################
head_title: ".NET AS API Viewer - Lire, Afficher, Rendre en C# VB.NET"
head_description: "API de visionneuse de documents .NET pour lire, restituer et afficher AS dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "AS Visionneuse de fichiers pour les applications C# .NET" 
...
steps:
    enable: true
    title_left: "Étapes pour rendre le fichier AS dans C#" 
    content_left: |
        Avec [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/), vous pouvez rendre AS au format HTML, JPEG, PNG ou PDF en quelques étapes.
