...
############################# Head #############################
head_title: ".NET PS1 API de visor: leer, ver y representar en C# VB.NET"
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo PS1 en C#" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> puede renderizar PS1 a HTML, JPEG, PNG o PDF en unos pocos pasos.
