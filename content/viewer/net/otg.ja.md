...
############################# Header ############################
title: "C# .NET アプリケーション用の OTG ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で OTG ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で OTG を HTML、JPEG、PNG、または PDF にレンダリングできます。
