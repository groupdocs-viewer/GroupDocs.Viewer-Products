...
head_description: "C# ASP.NET מציג קבצים וממשק API לעיבוד. הוסף מציג PDF, מציג Word, מציג Excel, מציג תמונות, מציג HTML, מציג דוא"ל באפליקציות NET."
