...
############################# Header ############################
title: "C# .NET アプリケーション用の POT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で POT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で POT を HTML、JPEG、PNG、または PDF にレンダリングできます。
