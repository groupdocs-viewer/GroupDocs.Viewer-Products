...
############################# Head #############################
head_title: ".NET EMZ Viewer API — lasīšana, skatīšana, renderēšana C# VB.NET"
head_description: ".NET dokumentu skatītāja API, lai lasītu, renderētu un parādītu EMZ jebkura veida C#, ASP.NET, VB.NET un .NET Core lietojumprogrammās."

############################# Header ############################
title: "EMZ failu skatītājs C# .NET lietojumprogrammām" 
description: ".NET dokumentu skatītāja API, lai lasītu, renderētu un parādītu EMZ failu jebkura veida C#, ASP.NET, VB.NET un .NET Core lietojumprogrammās. Skatiet renderētos failus ar patiesu formatējumu un izkārtojumu HTML5, PDF formātā vai kā attēlu, izmantojot dažas koda rindiņas." 
...
steps:
    enable: true
    title_left: "Darbības, lai renderētu EMZ failu programmā C#" 
    content_left: |
        Izmantojot programmu [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/), varat atveidot EMZ HTML, JPEG, PNG vai PDF formātā, veicot dažas darbības.
        ...
        * Izveidojiet Viewer klases gadījumu un ielādējiet failu EMZ ar pilnu ceļu. 
        * Iestatiet opcijas EMZ faila renderēšanai HTML, PNG, JPEG vai PDF formātā. 
...
demos:
    enable: true
    title: "EMZ skatītāja tiešraides demonstrācija"
    content: |
        Skatiet failu EMZ tūlīt, apmeklējot vietni [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/emz).
    lang: "lv"
