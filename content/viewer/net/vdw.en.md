...
steps:
    enable: true
    title_left: "Steps to Render VDW file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render VDW to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render VDW file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View VDW file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/vdw) website.
    lang: "en"
