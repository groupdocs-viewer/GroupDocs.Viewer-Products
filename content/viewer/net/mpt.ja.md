...
############################# Header ############################
title: "C# .NET アプリケーション用の MPT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MPT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MPT を HTML、JPEG、PNG、または PDF にレンダリングできます。
