...
steps:
    enable: true
    title_left: "Steps for View CPP File in C#"
    content_left: |
        ...
        *   Set options to convert CPP file into PNG format.
...
demos:
    ...
    content: |
        Display CPP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/cpp) website.  
