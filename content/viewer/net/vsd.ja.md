...
############################# Header ############################
title: "C# .NET アプリケーション用の VSD ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSD ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSD を HTML、JPEG、PNG、または PDF にレンダリングできます。
