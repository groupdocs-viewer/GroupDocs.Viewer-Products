...
############################# Header ############################
title: "C# .NET アプリケーション用の PL ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PL ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PL を HTML、JPEG、PNG、または PDF にレンダリングできます。
