...
############################# Head #############################
head_title: ".NET CHM API de visor: leer, ver y representar en C# VB.NET"
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo CHM en C#" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> puede renderizar CHM a HTML, JPEG, PNG o PDF en unos pocos pasos.
