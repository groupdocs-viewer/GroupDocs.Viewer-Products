...
############################# Head #############################
head_title: "API de la visionneuse .NET CPIO - lire, afficher, rendre en C# VB.NET"
head_description: "API de visualisation de documents .NET pour lire, restituer et afficher CPIO dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "CPIO visionneuse de fichiers pour les applications C# .NET" 
description: "API de visualisation de documents .NET pour lire, restituer et afficher le fichier CPIO dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core. Affichez les fichiers rendus avec un véritable formatage et une mise en page en HTML5, PDF ou sous forme d'image en utilisant quelques lignes de code." 
...
steps:
    enable: true
    title: "Étapes pour restituer le fichier CPIO dans C#" 
    content: |
      Avec <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a>, vous pouvez restituer CPIO au format HTML, JPEG, PNG ou PDF en quelques étapes.
      ...
      2. Créez une instance de la classe Viewer et chargez le fichier CPIO avec le chemin complet.  
      3. Définissez les options pour restituer le fichier CPIO au format HTML, PNG, JPEG ou PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurer le fichier d'entrée CPIO
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Rendre le fichier CPIO au format HTML avec des ressources intégrées
