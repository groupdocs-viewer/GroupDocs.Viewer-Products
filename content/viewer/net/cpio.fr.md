...
############################# Head #############################
head_title: ".NET CPIO API Viewer - Lire, Afficher, Rendre en C# VB.NET"
head_description: "API de visionneuse de documents .NET pour lire, restituer et afficher CPIO dans tout type d'applications C#, ASP.NET, VB.NET et .NET Core."

############################# Header ############################
title: "CPIO Visionneuse de fichiers pour les applications C# .NET" 
description: "API de visionneuse de documents .NET pour lire, restituer et afficher le fichier CPIO dans tout type d'applications C #, ASP.NET, VB.NET et .NET Core. Affichez les fichiers rendus avec une mise en forme et une mise en page authentiques au format HTML5, PDF ou sous forme d'image en utilisant quelques lignes de code." 
...
steps:
    enable: true
    title_left: "Étapes pour rendre le fichier CPIO dans C#" 
    content_left: |
        Avec [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/), vous pouvez rendre CPIO au format HTML, JPEG, PNG ou PDF en quelques étapes.
        ...
        * Créez une instance de la classe Viewer et chargez le fichier CPIO avec le chemin complet. 
        * Définissez les options pour rendre le fichier CPIO au format HTML, PNG, JPEG ou PDF. 
...
demos:
    enable: true
    title: "CPIO Démo en direct du spectateur"
    content: |
        Affichez le fichier CPIO dès maintenant en visitant le site Web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cpio).
    lang: "fr"
