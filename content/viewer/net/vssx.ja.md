...
############################# Header ############################
title: "C# .NET アプリケーション用の VSSX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSSX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSSX を HTML、JPEG、PNG、または PDF にレンダリングできます。
