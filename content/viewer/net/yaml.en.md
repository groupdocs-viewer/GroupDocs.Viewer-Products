...
steps:
    enable: true
    title_left: "Steps to Render YAML file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render YAML to HTML, JPEG, PNG or PDF in a few steps.
        ...
        * Set options to render YAML file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View YAML file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/yaml) website.
    lang: "en"
