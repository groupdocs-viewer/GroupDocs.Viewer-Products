...
############################# Head #############################
head_title: ".NET SCALA Viewer API - Baca, Lihat, Render dalam C# VB.NET"
head_description: "API pemapar dokumen .NET untuk membaca, membuat dan memaparkan SCALA dalam sebarang jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

############################# Header ############################
title: "SCALA Pemapar Fail Untuk Aplikasi C# .NET" 
description: "API pemapar dokumen .NET untuk membaca, membuat dan memaparkan fail SCALA dalam sebarang jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat fail yang diberikan dengan pemformatan & reka letak sebenar dalam HTML5, PDF atau sebagai imej menggunakan beberapa baris kod." 
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Memaparkan fail SCALA dalam C#" 
    content_left: |
        Dengan [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) anda boleh memaparkan SCALA kepada HTML, JPEG, PNG atau PDF dalam beberapa langkah.
        ...
        * Buat contoh kelas Viewer dan muatkan fail SCALA dengan laluan penuh. 
        * Tetapkan pilihan untuk memaparkan fail SCALA ke dalam format HTML, PNG, JPEG atau PDF. 
...
demos:
    enable: true
    title: "SCALA Demo Langsung Penonton"
    content: |
        Lihat fail SCALA sekarang dengan melawati tapak web [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/scala).
    lang: "ms"
