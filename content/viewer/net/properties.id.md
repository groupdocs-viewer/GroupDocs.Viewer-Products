...
head_title: ".NET PROPERTIES Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: "..NET document viewer API untuk membaca, merender, dan menampilkan PROPERTIES di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "PROPERTIES File Viewer untuk Aplikasi C# .NET"
description: "..NET document viewer API untuk membaca, merender, dan menampilkan file PROPERTIES dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File PROPERTIES di C#"
    content_left: |
        [GroupDocs.Viewer](viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file PROPERTIES dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file PROPERTIES dengan path lengkap.
        * Atur opsi untuk mengonversi file PROPERTIES ke format PNG.
    ...
    code: |
        ...
        using (Viewer viewer = new Viewer("sample.properties"))
        {
        	// Setel opsi tampilan 
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa PROPERTIES"
    content: |
        Tampilkan file PROPERTIES sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/PROPERTIES). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-properties"
          title: "Tentang Format Berkas PROPERTIES"
          content: |
            {{PROPERTIES}}
