...
############################# Header ############################
title: "C# .NET アプリケーション用の MHT ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MHT ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MHT を HTML、JPEG、PNG、または PDF にレンダリングできます。
