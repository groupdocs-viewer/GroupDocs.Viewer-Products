...
head_title: ".NET POTX Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan POTX di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "POTX File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file POTX dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File POTX di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file POTX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file POTX dengan path lengkap.
        * Atur opsi untuk mengonversi file POTX ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa POTX"
    content: |
        Tampilkan file POTX sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/POTX). Demo langsung memiliki manfaat sebagai berikut.
