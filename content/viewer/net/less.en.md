...
steps:
    enable: true
    title_left: "Steps to Render LESS file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render LESS to HTML, JPEG, PNG or PDF in a few steps.
