...
############################# Header ############################
title: "C# .NET アプリケーション用の MPX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MPX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MPX を HTML、JPEG、PNG、または PDF にレンダリングできます。
