...
############################# Header ############################
title: "C# .NET アプリケーション用の MD ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で MD ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で MD を HTML、JPEG、PNG、または PDF にレンダリングできます。
