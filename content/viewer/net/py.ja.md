...
############################# Header ############################
title: "C# .NET アプリケーション用の PY ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PY ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PY を HTML、JPEG、PNG、または PDF にレンダリングできます。
