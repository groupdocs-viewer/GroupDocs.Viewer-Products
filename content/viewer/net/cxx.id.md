...
head_title: ".NET CXX Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan CXX di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "CXX File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file CXX dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File CXX di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file CXX dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file CXX dengan path lengkap.
        * Atur opsi untuk mengonversi file CXX ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa CXX"
    content: |
        Tampilkan file CXX sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/CXX). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-cxx"
          title: "Tentang Format Berkas CXX"
          content: |
            {{CXX}}
