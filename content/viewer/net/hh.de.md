...
steps:
    enable: true
    title_left: "Schritte zum Rendern der HH-Datei in C#" 
    content_left: |
        Mit [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) können Sie HH in wenigen Schritten in HTML, JPEG, PNG oder PDF rendern.
