...
############################# Header ############################
title: "Worksheet C# .NET アプリケーション用のファイル ビューア" 
...
steps:
    enable: true
    title_left: "C# で Worksheet ファイルをレンダリングする手順" 
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) を使用すると、いくつかの手順で Worksheet を HTML、JPEG、PNG、または PDF にレンダリングできます。
