...
features:
  ...
  items:
    # feature loop
    - icon: "viewhtml"
      title: "[Afficher les documents en HTML](https://blog.groupdocs.com/viewer/view-word-documents-as-html-responsive-page-using-csharp/)"
    ...
    # feature loop
    - icon: "rasterize"
      title: "[Pixelliser les documents](https://docs.groupdocs.com/viewer/net/rendering-to-png-or-jpeg/)"
    ...
    # feature loop
    - icon: "font"
      title: "[Contrôler les polices du document](https://blog.groupdocs.com/viewer/working-with-fonts/)"
    ...
    # feature loop
    - icon: "convertpdf"
      title: "[Convertir en PDF](https://blog.groupdocs.com/viewer/rendering-documents-as-pdf/)"
    ...
    # feature loop
    - icon: "transform"
      title: "[Appliquer des transformations](https://blog.groupdocs.com/viewer/protect-your-documents-with-watermarks-in-groupdocs-viewer-for-dot-net/)"
    ...
    # feature loop
    - icon: "adjustment"
      title: "[Ajustement de la sortie HTML](https://blog.groupdocs.com/viewer/render-word-documents-as-clean-html-using-csharp/)"
    ...
    # feature loop
    - icon: "complex"
      title: "[Prise en charge de structures de documents complexes](https://blog.groupdocs.com/viewer/process-microsoft-outlook-email-attachments-in-a-.net-viewer-application/)"
    ...
    # feature loop
    - icon: "optimization"
      title: "[Options d'optimisation](https://blog.groupdocs.com/viewer/exclude-specific-fonts-from-output-html-using-groupdocs.viewer-for-.net-18.10/)"
    ...
    - icon: "passwordprotected"
      title: "[Prise en charge des documents protégés par mot de passe](https://docs.groupdocs.com/viewer/net/load-password-protected-document/)"
