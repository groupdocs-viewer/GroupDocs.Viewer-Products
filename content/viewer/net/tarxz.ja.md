...
############################# Header ############################
title: "C# .NET アプリケーション用の TARXZ ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で TARXZ ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で TARXZ を HTML、JPEG、PNG、または PDF にレンダリングできます。
