...
head_title: ".NET ARCHIVE Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan file ARCHIVE dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "ARCHIVE File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file ARCHIVE dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File ARCHIVE di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file ARCHIVE dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file ZIP dengan path lengkap.
        * Atur opsi untuk mengonversi file ZIP ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa ARCHIVE"
    content: |
        Tampilkan file ARCHIVE sekarang dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/zip). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-archive-o"
          title: "Tentang Format Berkas ARCHIVE"
          content: |
            Kompresi File adalah proses untuk mengurangi ukuran satu atau lebih file. Ini menyusutkan file besar menjadi file yang jauh lebih kecil dengan menghapus data yang tidak dibutuhkan. File terkompresi ARCHIVE memudahkan pengiriman dan pencadangan file besar atau grup file. Selain itu, file semacam itu membuat pengunduhan lebih cepat dan memungkinkan lebih banyak data disimpan di media yang dapat dipindahkan. Ada berbagai format kompresi. Di bawah ini kita akan membahas Format File Kompresi paling populer dan perangkat lunak yang paling direkomendasikan yang menggunakannya.
