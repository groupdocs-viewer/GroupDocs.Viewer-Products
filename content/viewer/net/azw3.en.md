...
############################# Head #############################
head_title: ".NET AZW3 Viewer API - Read, View, Render in C# VB.NET"
head_description: ".NET document viewer API to read, render and display AZW3 in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "AZW3 File Viewer For C# .NET Applications" 
description: ".NET document viewer API to read, render and display AZW3 file in any type of C#, ASP.NET, VB.NET & .NET Core applications. View the rendered files with true formatting & layout in HTML5, PDF or as an image using a few lines of the code." 
...
steps:
    enable: true
    title_left: "Steps to Render AZW3 file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render AZW3 to HTML, JPEG, PNG or PDF in a few steps.

        * Install [GroupDocs.Viewer for .NET](https://www.nuget.org/packages/groupdocs.viewer) using your favorite package manager. 
        * Create an instance of Viewer class and load the AZW3 file with full path. 
        * Set options to render AZW3 file into HTML, PNG, JPEG or PDF format. 
...
demos:
    ...
    content: |
        View AZW3 file right now by visiting [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/azw3) website.
    lang: "en"
