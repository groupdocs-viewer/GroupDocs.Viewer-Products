...
############################# Header ############################
title: "C# .NET アプリケーション用の CF2 ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で CF2 ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で CF2 を HTML、JPEG、PNG、または PDF にレンダリングできます。
