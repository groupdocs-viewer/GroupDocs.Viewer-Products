...
############################# Head #############################
head_title: ".NET AZW3 Kyker-API - Lees, bekyk, lewer in C# VB.NET"
head_description: ".NET dokumentkyker-API om AZW3 te lees, weer te gee en te vertoon in enige tipe C#-, ASP.NET-, VB.NET- en .NET Core-toepassings."

############################# Header ############################
title: "AZW3 Lêerkyker vir C# .NET-toepassings" 
description: ".NET-dokumentkyker-API om AZW3-lêer te lees, weer te gee en te vertoon in enige tipe C#-, ASP.NET-, VB.NET- en .NET Core-toepassings. Bekyk die gelewerde lêers met ware formatering en uitleg in HTML5, PDF of as 'n prent deur 'n paar reëls van die kode te gebruik." 
...
steps:
    enable: true
    title_left: "Stappe om AZW3-lêer in C# weer te gee" 
    content_left: |
        Met [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) kan jy AZW3 in 'n paar stappe na HTML, JPEG, PNG of PDF weergee.
        ...
        * Skep 'n instansie van Viewer-klas en laai die AZW3-lêer met volle pad. 
        * Stel opsies om AZW3-lêer in HTML-, PNG-, JPEG- of PDF-formaat weer te gee. 
...
demos:
    enable: true
    title: "AZW3 Kyker Regstreekse Demo"
    content: |
        Bekyk AZW3-lêer op die oomblik deur [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/azw3) se webwerf te besoek.
    lang: "af"
