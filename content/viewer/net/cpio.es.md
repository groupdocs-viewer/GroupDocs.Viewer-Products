...
############################# Head #############################
head_title: ".NET CPIO API de visor: leer, ver y representar en C# VB.NET"
...
steps:
    enable: true
    title: "Pasos para renderizar el archivo CPIO en C#" 
    content: |
      Con <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> puede renderizar CPIO a HTML, JPEG, PNG o PDF en unos pocos pasos.
      ...
      2. Cree una instancia de la clase Viewer y cargue el archivo CPIO con la ruta completa.  
      3. Configure opciones para representar el archivo CPIO en formato HTML, PNG, JPEG o PDF. 
    ...
    code:
      ...
      content: |
        ...
        // Configurar el archivo de entrada CPIO
        ...
        using (Viewer viewer = new Viewer(filePath))
        {
            ...
            // Renderice el archivo CPIO a HTML con recursos integrados
