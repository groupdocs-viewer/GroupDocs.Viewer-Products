...
############################# Header ############################
title: "C# .NET アプリケーション用の PSB ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で PSB ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で PSB を HTML、JPEG、PNG、または PDF にレンダリングできます。
