...
############################# Head #############################
head_title: ".NET CDR Viewer API — lasīšana, skatīšana, renderēšana C# VB.NET"
head_description: ".NET dokumentu skatītāja API, lai lasītu, renderētu un parādītu CDR jebkura veida C#, ASP.NET, VB.NET un .NET Core lietojumprogrammās."

############################# Header ############################
title: "CDR failu skatītājs C# .NET lietojumprogrammām" 
description: ".NET dokumentu skatītāja API, lai lasītu, renderētu un parādītu CDR failu jebkura veida C#, ASP.NET, VB.NET un .NET Core lietojumprogrammās. Skatiet renderētos failus ar patiesu formatējumu un izkārtojumu HTML5, PDF formātā vai kā attēlu, izmantojot dažas koda rindiņas." 
...
steps:
    enable: true
    title_left: "Darbības, lai renderētu CDR failu programmā C#" 
    content_left: |
        Izmantojot programmu [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/), varat atveidot CDR HTML, JPEG, PNG vai PDF formātā, veicot dažas darbības.
        ...
        * Izveidojiet Viewer klases gadījumu un ielādējiet failu CDR ar pilnu ceļu. 
        * Iestatiet opcijas CDR faila renderēšanai HTML, PNG, JPEG vai PDF formātā. 
...
demos:
    enable: true
    title: "CDR skatītāja tiešraides demonstrācija"
    content: |
        Skatiet failu CDR tūlīt, apmeklējot vietni [GroupDocs.Viewer Online Apps](https://products.groupdocs.app/viewer/cdr).
    lang: "lv"
