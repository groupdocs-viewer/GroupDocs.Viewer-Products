...
############################# Header ############################
title: "C# .NET アプリケーション用の JPX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で JPX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で JPX を HTML、JPEG、PNG、または PDF にレンダリングできます。
