...
head_title: ".NET CMAKE Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan CMAKE di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "CMAKE File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file CMAKE dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File CMAKE di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file CMAKE dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file CMAKE dengan path lengkap.
        * Atur opsi untuk mengonversi file CMAKE ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa CMAKE"
    content: |
        Tampilkan file CMAKE sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/CMAKE). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-cmake"
          title: "Tentang Format Berkas CMAKE"
          content: |
            {{CMAKE}}
