...
############################# Head #############################
head_title: ".NET ODS Viewer API - Read, View, Render in C# VB.NET"
head_description: ".NET document viewer API to read, render and display ODS in any type of C#, ASP.NET, VB.NET & .NET Core applications."
...
steps:
    enable: true
    title_left: "Steps to Render ODS file in C#" 
    content_left: |
        With [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) you can render ODS to HTML, JPEG, PNG or PDF in a few steps.
