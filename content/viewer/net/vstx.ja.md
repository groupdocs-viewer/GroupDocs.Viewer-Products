...
############################# Header ############################
title: "C# .NET アプリケーション用の VSTX ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で VSTX ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で VSTX を HTML、JPEG、PNG、または PDF にレンダリングできます。
