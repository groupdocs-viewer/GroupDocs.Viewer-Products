...
############################# Header ############################
title: "C# .NET アプリケーション用の ODP ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で ODP ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で ODP を HTML、JPEG、PNG、または PDF にレンダリングできます。
