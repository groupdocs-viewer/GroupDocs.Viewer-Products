...
head_title: ".NET SCM Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan SCM di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "SCM File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file SCM dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File SCM di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file SCM dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file SCM dengan path lengkap.
        * Atur opsi untuk mengonversi file SCM ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa SCM"
    content: |
        Tampilkan file SCM sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/SCM). Demo langsung memiliki manfaat sebagai berikut.
        
about_formats:
    enable: true
    format:
        - icon: "far fa-file-scm"
          title: "Tentang Format Berkas SCM"
          content: |
            {{SCM}}
