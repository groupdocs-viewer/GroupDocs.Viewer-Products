...
head_title: ".NET J2K Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan J2K di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "J2K File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file J2K dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File J2K di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file J2K dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file J2K dengan path lengkap.
        * Atur opsi untuk mengonversi file J2K ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa J2K"
    content: |
        Tampilkan file J2K sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/J2K). Demo langsung memiliki manfaat sebagai berikut.
