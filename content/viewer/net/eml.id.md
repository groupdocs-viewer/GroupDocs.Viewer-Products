...
head_title: ".NET EML Viewer API - Baca, Lihat, Render di C# VB.NET"
head_description: ".NET document viewer API untuk membaca, merender, dan menampilkan EML di semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core."

title: "EML File Viewer untuk Aplikasi C# .NET"
description: ".NET document viewer API untuk membaca, merender, dan menampilkan file EML dalam semua jenis aplikasi C#, ASP.NET, VB.NET & .NET Core. Lihat file yang dirender dengan format & tata letak yang benar dalam HTML5, PDF, atau sebagai gambar menggunakan beberapa baris kode."
...
steps:
    enable: true
    title_left: "Langkah-langkah untuk Melihat File EML di C#"
    content_left: |
        [GroupDocs.Viewer](/viewer/net/) memudahkan pengembang .NET untuk menambahkan fitur tampilan file EML dalam aplikasi mereka dengan menerapkan beberapa langkah mudah.

        * Buat instance kelas Viewer dan muat file EML dengan path lengkap.
        * Atur opsi untuk mengonversi file EML ke format PNG.
...
demos:
    enable: true
    title: "Demo Langsung Pemirsa EML"
    content: |
        Tampilkan file EML sekarang juga dengan mengunjungi situs web [GroupDocs.Viewer](https://products.groupdocs.app/viewer/EML). Demo langsung memiliki manfaat sebagai berikut.
