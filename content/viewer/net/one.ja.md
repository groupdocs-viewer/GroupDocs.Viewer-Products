...
############################# Header ############################
title: "C# .NET アプリケーション用の ONE ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で ONE ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で ONE を HTML、JPEG、PNG、または PDF にレンダリングできます。
