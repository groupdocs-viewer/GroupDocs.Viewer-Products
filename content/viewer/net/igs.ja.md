...
############################# Header ############################
title: "C# .NET アプリケーション用の IGS ファイル ビューア" 
...
steps:
    enable: true
    title: "C# で IGS ファイルをレンダリングする手順" 
    content: |
      <a href='https://products.groupdocs.com/viewer/net/'>GroupDocs.Viewer</a> を使用すると、いくつかの手順で IGS を HTML、JPEG、PNG、または PDF にレンダリングできます。
