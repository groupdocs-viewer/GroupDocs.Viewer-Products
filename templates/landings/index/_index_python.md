...
############################# Header ############################
title: "<% "{index-content-python.header_title}" %>"
description: "<% "{index-content-python.header_description}" %>"
words:
  for: "for"
...
overview:
  enable: true
  title: "<% "{index-content-python.overview_title}" %>"
  description: "<% "{index-content-python.overview_description}" %>"
  features:
    # feature loop
    - title: "<% "{index-content-python.overview_features.feature1_title}" %>"
      content: "<% "{index-content-python.overview_features.feature1_content}" %>"

    # feature loop
    - title: "<% "{index-content-python.overview_features.feature2_title}" %>"
      content: "<% "{index-content-python.overview_features.feature2_content}" %>"

    # feature loop
    - title: "<% "{index-content-python.overview_features.feature3_title}" %>"
      content: "<% "{index-content-python.overview_features.feature3_content}" %>"

############################# Platforms ############################
platforms:
  enable: true
  title: "<% "{index-content-python.platforms_title}" %>"
...
formats:
  ...
  description: |
    <% "{index-content-python.formats.description}" %>
  groups:
    # group loop
    - color: "green"
      content: |
...
code_samples:
  enable: true
  title: "<% "{index-content-python.code_samples.title}" %>"
  description: "<% "{index-content-python.code_samples.description}" %>"
  items:
    # code sample loop
    - title: "<% "{index-content-python.code_samples.sample1_title}" %>"
      content: |
        <% "{index-content-python.code_samples.sample1_content1}" %> <% "{index-content-python.code_samples.sample1_content2}" %>
        {{< landing/code title="Python">}}
        ```python {style=abap}
        import groupdocs.viewer as gv
        import groupdocs.viewer.options as gvo 

        // <% "{index-content-python.code_samples.sample1_comment_1}" %>
        with gv.Viewer("resume.docx") as viewer:
          // <% "{index-content-python.code_samples.sample1_comment_2}" %>
          viewOptions = gvo.HtmlViewOptions.for_embedded_resources("page_{0}.html")
          // <% "{index-content-python.code_samples.sample1_comment_3}" %>
          viewer.view(viewOptions)
        ```
        {{< /landing/code >}}
    # code sample loop
    - title: "<% "{index-content-python.code_samples.sample2_title}" %>"
      content: |
        <% "{index-content-python.code_samples.sample2_content1}" %> <% "{index-content-python.code_samples.sample2_content2}" %>
        {{< landing/code title="Python">}}
        ```python {style=abap}
        import groupdocs.viewer as gv
        import groupdocs.viewer.options as gvo  

        // <% "{index-content-python.code_samples.sample2_comment_1}" %>
        with gv.Viewer("presentation.pptx") as viewer:
          // <% "{index-content-python.code_samples.sample2_comment_2}" %>
          viewOptions = gvo.PdfViewOptions("presentation.pdf")
          // <% "{index-content-python.code_samples.sample2_comment_3}" %>
          viewer.view(viewOptions)
        ```
        {{< /landing/code >}}
############################# Reviews ############################
