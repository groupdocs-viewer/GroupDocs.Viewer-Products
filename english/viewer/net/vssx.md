...
############################# Head ############################
head_title: ".NET VSSX Viewer API - Read, View, Render in C# VB.NET"
head_description: ".NET document viewer API to read, render and display VSSX in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "VSSX File Viewer for C# .NET Applications"
description: ".NET document viewer API to read, render and display VSSX file in any type of C#, ASP.NET, VB.NET & .NET Core applications. View the rendered files with true formatting & layout in HTML5, PDF or as an image using a few lines of the code."
...
steps:
    enable: true
    title_left: "Steps for Viewing VSSX File in C#"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) makes it easy for .NET developers to add VSSX file viewing feature in their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Display VSSX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/vssx) website.  
