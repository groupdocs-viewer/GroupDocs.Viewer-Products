...
head_description: ".NET document viewer API to read, render and display Project file in any type of C#, ASP.NET, VB.NET & .NET Core applications."

############################# Header ############################
title: "Project File Viewer for C# .NET"
...
steps:
    enable: true
    title_left: "Steps for Viewing Project File in C#"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) makes it easy for .NET developers to add Project file viewing feature in their applications by implementing a few easy steps.

        *   Create an instance of Viewer class and load the MPP file with full path.
        *   Set options to convert MPP file into PNG format.
...
demos:
    enable: true
    title: "Project File Viewer Live Demos"
    content: |
        Display Project file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/project) website.  
