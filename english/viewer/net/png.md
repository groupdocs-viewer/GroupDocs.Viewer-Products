...
steps:
    ...
    content_left: |
        ...
        *   Set options to convert PNG file into PNG format.
...
demos:
    ...
    content: |
        Display PNG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/png) website.  
