...
############################# Header ############################
title: "Presentation File Viewer for C# .NET"
...
steps:
    enable: true
    title_left: "Steps for Viewing Presentation in C#"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) makes it easy for .NET developers to add Presentation file viewing feature in their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Display Presentation file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/pptx) website.  
