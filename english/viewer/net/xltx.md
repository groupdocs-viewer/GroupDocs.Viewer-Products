...
############################# Head ############################
head_title: "View XLTX files in C# .NET Applications | Document Viewer APIs"
head_description: "Render and view XLTX files in .NET applications. Also display a wide range of business documents, images, diagrams, web and other formats using native .NET APIs."

############################# Header ############################
title: "View XLTX Files in C#"
description: "Cross-platform XLTX files viewing solution using server side GroupDocs.Viewer for .NET APIs, without depending on any third party software, pre-installed on your system."
...
steps:
    enable: true
    title_left: "Steps for Viewing XLTX File in C#"
    content_left: |
        ...
        *   Set options for rendering XLTX file into PNG format.
...
demos:
    ...
    content: |
        Display XLTX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/family) website.  
