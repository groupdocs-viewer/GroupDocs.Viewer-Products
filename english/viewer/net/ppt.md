...
############################# Head ############################
head_title: "View PPT files in C# .NET Applications | Document Viewer APIs"
head_description: "Render and view PPT files in .NET applications. Also display a wide range of business documents, images, diagrams, web and other formats using native .NET APIs."

############################# Header ############################
title: "View PPT Files in C#"
description: "Cross-platform PPT files viewing solution using server side GroupDocs.Viewer for .NET APIs, without depending on any third party software, pre-installed on your system."
...
steps:
    enable: true
    title_left: "Steps for Viewing PPT File in C#"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net) makes it easy for .NET developers to add PPT file viewing feature in their applications by implementing a few easy steps.
