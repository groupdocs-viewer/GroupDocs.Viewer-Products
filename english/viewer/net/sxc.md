...
steps:
    enable: true
    title_left: "Steps for Viewing SXC File in C#"
    content_left: |
...
demos:
    ...
    content: |
        Display SXC file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/sxc) website.  
