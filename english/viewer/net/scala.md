...
############################# Head ############################
head_title: "View SCALA files in C# .NET Applications | Document Viewer APIs"
head_description: "Render and view SCALA files in .NET applications. Also display a wide range of business documents, images, diagrams, web and other formats using native .NET APIs."

############################# Header ############################
title: "View SCALA Files in C#"
description: "Cross-platform SCALA files viewing solution using server side GroupDocs.Viewer for .NET APIs, without depending on any third party software, pre-installed on your system."
...
demos:
    ...
    content: |
        Display SCALA file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/family) website.  
