...
head_description: ".NET document viewer API to read, render and display Outlook file in any type of C#, ASP.NET, VB.NET & .NET Core applications."
...
steps:
    enable: true
    title_left: "Steps for Viewing Outlook File"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) makes it easy for .NET developers to add Outlook file viewing feature in their applications by implementing a few easy steps.
...
demos:
    ...
    content: |
        Display Outlook file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/outlook) website.  
