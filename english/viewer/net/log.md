...
steps:
    enable: true
    title_left: "Steps for View LOG File in C#"
    content_left: |
        ...
        *   Set options to convert LOG file into PNG format.
...
demos:
    ...
    content: |
        Display LOG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/log) website.  
