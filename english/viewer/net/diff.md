...
steps:
    enable: true
    title_left: "Steps for Viewing DIFF File in C#"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) makes it easy for .NET developers to add DIFF file viewing feature in their applications by implementing a few easy steps.

        *   Create an instance of Viewer class and load the DIFF file with full path.
        *   Set options to convert DIFF file into PNG format.
...
demos:
    ...
    content: |
        Display DIFF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/diff) website.  
