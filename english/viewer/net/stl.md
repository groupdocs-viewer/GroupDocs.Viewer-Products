...
############################# Static ############################
layout: "auto-gen"
date: 2021-05-12T12:19:01+03:00
draft: false

############################# Head ############################
head_title: "View STL files in C# .NET Applications | Document Viewer APIs"
head_description: "Render and view STL files in .NET applications. Also display a wide range of business documents, images, diagrams, web and other formats using native .NET APIs."

############################# Header ############################
title: "View STL Files in C#"
description: "Cross-platform STL files viewing solution using server side GroupDocs.Viewer for .NET APIs, without depending on any third party software, pre-installed on your system."
...
steps:
    enable: true
    title_left: "Steps for Viewing STL File in C#"
    content_left: |
        ...
        *   Set options for rendering STL file into PNG format.
...
demos:
    ...
    content: |
        Display STL file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/family) website.  
