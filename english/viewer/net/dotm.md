...
steps:
    enable: true
    title_left: "Steps for View DOTM File in C#"
    content_left: |
        ...
        *   Set options to convert DOTM file into PNG format.
...
demos:
    ...
    content: |
        Display DOTM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/dotm) website.  
