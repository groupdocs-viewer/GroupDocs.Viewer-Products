...
steps:
    enable: true
    title_left: "Steps for Viewing XLTM File in C#"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) makes it easy for .NET developers to add XLTM file viewing feature in their applications by implementing a few easy steps.

        *   Create an instance of Viewer class and load the XLTM file with full path.
        *   Set options for rendering XLTM file into PNG format.
...
demos:
    enable: true
    title: "XLTM Viewer Live Demos"
    content: |
        Display XLTM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/xltm) website.  
