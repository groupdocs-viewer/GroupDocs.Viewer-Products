...
steps:
    enable: true
    title_left: "Steps for View MPP File in C#"
    content_left: |
...
demos:
    ...
    content: |
        Display MPP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/mpp) website.  
