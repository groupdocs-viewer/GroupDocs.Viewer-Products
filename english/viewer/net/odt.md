...
############################# Head ############################
head_title: "View ODT files in C# .NET Applications | Document Viewer APIs"
head_description: "Render and view ODT files in .NET applications. Also display a wide range of business documents, images, diagrams, web and other formats using native .NET APIs."

############################# Header ############################
title: "View ODT Files in C#"
description: "Cross-platform ODT files viewing solution using server side GroupDocs.Viewer for .NET APIs, without depending on any third party software, pre-installed on your system."
...
demos:
    ...
    content: |
        Display ODT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/family) website.  
