...
head_description: ".NET document viewer API to read, render and display Word file in any type of C#, ASP.NET, VB.NET & .NET Core applications."
...
steps:
    enable: true
    title_left: "Steps for Viewing Word File in C#"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/net/) makes it easy for .NET developers to add Word file viewing feature in their applications by implementing a few easy steps.

        *   Create an instance of Viewer class and load the Word file with full path.
        *   Set options for rendering Word file into PNG format.
...
demos:
    enable: true
    title: "Word Viewer Live Demos"
    content: |
        Display Word file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/word) website.  
