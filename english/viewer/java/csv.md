...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CSV file into PNG format.
...
demos:
    ...
    content: |
        Display CSV file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
