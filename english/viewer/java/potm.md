...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert POTM file into PNG format.
...
demos:
    ...
    content: |
        Display POTM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
