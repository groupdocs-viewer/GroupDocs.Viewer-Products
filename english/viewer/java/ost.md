...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert OST file into PNG format.
...
demos:
    ...
    content: |
        Display OST file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
