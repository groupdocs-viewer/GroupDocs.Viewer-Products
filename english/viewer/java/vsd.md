...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSD file into PNG format.
...
demos:
    ...
    content: |
        Display VSD file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
