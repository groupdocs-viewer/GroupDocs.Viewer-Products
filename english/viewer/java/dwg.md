...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DWG file into PNG format.
...
demos:
    ...
    content: |
        Display DWG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
