...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert ODS file into PNG format.
...
demos:
    ...
    content: |
        Display ODS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
