...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert RB file into PNG format.
...
demos:
    ...
    content: |
        Display RB file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
