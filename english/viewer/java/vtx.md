...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VTX file into PNG format.
...
demos:
    ...
    content: |
        Display VTX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
