...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert ERB file into PNG format.
...
demos:
    ...
    content: |
        Display ERB file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
