...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert RST file into PNG format.
...
demos:
    ...
    content: |
        Display RST file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
