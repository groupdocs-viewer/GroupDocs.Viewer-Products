...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert MOBI file into PNG format.
...
demos:
    ...
    content: |
        Display MOBI file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
