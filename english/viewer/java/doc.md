...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DOC file into PNG format.
...
demos:
    ...
    content: |
        Display DOC file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
