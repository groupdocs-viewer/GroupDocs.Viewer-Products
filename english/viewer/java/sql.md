...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert SQL file into PNG format.
...
demos:
    ...
    content: |
        Display SQL file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
