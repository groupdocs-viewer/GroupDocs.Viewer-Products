...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PST file into PNG format.
...
demos:
    ...
    content: |
        Display PST file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
