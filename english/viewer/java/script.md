...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert SCRIPT file into PNG format.
...
demos:
    ...
    content: |
        Display SCRIPT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
