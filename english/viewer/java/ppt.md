...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PPT file into PNG format.
...
demos:
    ...
    content: |
        Display PPT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
