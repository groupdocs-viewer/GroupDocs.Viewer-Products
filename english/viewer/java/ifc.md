...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert IFC file into PNG format.
...
demos:
    ...
    content: |
        Display IFC file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
