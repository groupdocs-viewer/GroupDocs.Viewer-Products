...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert SCM file into PNG format.
...
demos:
    ...
    content: |
        Display SCM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
