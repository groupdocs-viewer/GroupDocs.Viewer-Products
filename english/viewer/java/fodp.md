...
############################# Head ############################
head_title: "Java FODP Viewer API - Render &amp; Display FODP in Java Apps"
head_description: "View FODP files in Java, J2EE, J2SE applications. Supports viewing 150+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render &amp; View FODP File in Java"
description: "Native and high performance FODP file viewer API for Java, J2EE and J2SE based applications, supporting a wide range of additional features to customize the appearance of the output document format."
...
steps:
    enable: true
    title_left: "Steps for Viewing FODP File in Java"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java) makes it easy for Java developers to add FODP file viewing feature in their applications using a few lines of code.

        *   Create an instance of Viewer class and load the FODP file with full path.
        *   Set options for rendering FODP file into PNG format.
...
demos:
    enable: true
    title: "FODP Viewer Live Demos"
    content: |
        Display FODP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/family) website.  
