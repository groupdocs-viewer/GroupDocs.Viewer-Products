...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert FODP file into PNG format.
...
demos:
    ...
    content: |
        Display FODP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
