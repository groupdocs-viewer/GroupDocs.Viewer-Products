...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JPF file into PNG format.
...
demos:
    ...
    content: |
        Display JPF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
