...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DOTX file into PNG format.
...
demos:
    ...
    content: |
        Display DOTX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
