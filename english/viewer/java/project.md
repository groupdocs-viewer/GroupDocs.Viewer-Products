...
head_description: "View Project files in Java, J2EE, J2SE applications. Supports viewing 150+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View Project File in Java"
...
steps:
    enable: true
    title_left: "Steps for Viewing Project File in Java"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) makes it easy for Java developers to add Project file viewing feature in their applications using a few lines of code.

        *   Create an instance of Viewer class and load the MPP file with full path.
        *   Set view options to convert MPP file into PNG format.
...
demos:
    enable: true
    title: "Project Viewer Live Demos"
    content: |
        Display Project file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
