...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert XLAM file into PNG format.
...
demos:
    ...
    content: |
        Display XLAM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
