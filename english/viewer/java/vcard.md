...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VCARD file into PNG format.
...
demos:
    ...
    content: |
        Display VCARD file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
