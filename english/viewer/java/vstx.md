...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSTX file into PNG format.
...
demos:
    ...
    content: |
        Display VSTX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
