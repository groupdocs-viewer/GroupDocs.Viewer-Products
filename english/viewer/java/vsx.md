...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSX file into PNG format.
...
demos:
    ...
    content: |
        Display VSX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
