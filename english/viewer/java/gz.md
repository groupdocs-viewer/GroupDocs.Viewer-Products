...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert GZ file into PNG format.
...
demos:
    ...
    content: |
        Display GZ file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
