...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert MHT file into PNG format.
...
demos:
    ...
    content: |
        Display MHT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
