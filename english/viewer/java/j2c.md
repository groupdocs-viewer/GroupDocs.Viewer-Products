...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert J2C file into PNG format.
...
demos:
    ...
    content: |
        Display J2C file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
