...
head_description: "View Word files in Java, J2EE, J2SE applications. Supports viewing 150+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View Word File in Java"
...
steps:
    enable: true
    title_left: "Steps for Viewing Word File in Java"
    content_left: |
...
demos:
    ...
    content: |
        Display Word file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
