...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CF2 file into PNG format.
...
demos:
    ...
    content: |
        Display CF2 file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
