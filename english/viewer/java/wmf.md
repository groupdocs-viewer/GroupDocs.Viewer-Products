...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert WMF file into PNG format.
...
demos:
    ...
    content: |
        Display WMF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
