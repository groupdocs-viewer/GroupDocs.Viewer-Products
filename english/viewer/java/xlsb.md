...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert XLSB file into PNG format.
...
demos:
    ...
    content: |
        Display XLSB file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
