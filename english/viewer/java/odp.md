...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert ODP file into PNG format.
...
demos:
    ...
    content: |
        Display ODP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
