...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JPM file into PNG format.
...
demos:
    ...
    content: |
        Display JPM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
