...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JSON file into PNG format.
...
demos:
    ...
    content: |
        Display JSON file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
