...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DIB file into PNG format.
...
demos:
    ...
    content: |
        Display DIB file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
