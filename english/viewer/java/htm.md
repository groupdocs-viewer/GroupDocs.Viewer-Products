...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert HTM file into PNG format.
...
demos:
    ...
    content: |
        Display HTM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
