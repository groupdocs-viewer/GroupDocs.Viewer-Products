...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert RTF file into PNG format.
...
demos:
    ...
    content: |
        Display RTF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
