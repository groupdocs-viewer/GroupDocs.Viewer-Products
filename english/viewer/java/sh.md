...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert SH file into PNG format.
...
demos:
    ...
    content: |
        Display SH file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
