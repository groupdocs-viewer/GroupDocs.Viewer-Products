...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PLT file into PNG format.
...
demos:
    ...
    content: |
        Display PLT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
