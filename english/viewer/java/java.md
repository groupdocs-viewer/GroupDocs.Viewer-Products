...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JAVA file into PNG format.
...
demos:
    ...
    content: |
        Display JAVA file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
