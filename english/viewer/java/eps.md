...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert EPS file into PNG format.
...
demos:
    ...
    content: |
        Display EPS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
