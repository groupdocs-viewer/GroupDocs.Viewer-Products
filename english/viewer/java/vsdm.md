...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSDM file into PNG format.
...
demos:
    ...
    content: |
        Display VSDM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
