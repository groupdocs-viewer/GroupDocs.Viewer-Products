...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VCF file into PNG format.
...
demos:
    ...
    content: |
        Display VCF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
