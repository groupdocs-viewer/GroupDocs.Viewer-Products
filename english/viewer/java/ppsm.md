...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PPSM file into PNG format.
...
demos:
    ...
    content: |
        Display PPSM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
