...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CMAKE file into PNG format.
...
demos:
    ...
    content: |
        Display CMAKE file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
