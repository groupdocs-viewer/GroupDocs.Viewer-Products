...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert IGS file into PNG format.
...
demos:
    ...
    content: |
        Display IGS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
