...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VDX file into PNG format.
...
demos:
    ...
    content: |
        Display VDX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
