...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert TEX file into PNG format.
...
demos:
    ...
    content: |
        Display TEX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
