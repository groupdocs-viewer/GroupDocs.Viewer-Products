...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert ODG file into PNG format.
...
demos:
    ...
    content: |
        Display ODG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
