...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert FODG file into PNG format.
...
demos:
    ...
    content: |
        Display FODG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
