...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert TAR file into PNG format.
...
demos:
    ...
    content: |
        Display TAR file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
