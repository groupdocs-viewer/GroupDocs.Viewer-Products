...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert M file into PNG format.
...
demos:
    ...
    content: |
        Display M file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
