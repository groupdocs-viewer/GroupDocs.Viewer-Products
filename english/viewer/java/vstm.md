...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSTM file into PNG format.
...
demos:
    ...
    content: |
        Display VSTM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
