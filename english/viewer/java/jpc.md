...
steps:
    enable: true
    title_left: "Steps for View JPC File in Java"
    content_left: |
        ...
        *   Set view options to convert JPC file into PNG format.
...
demos:
    ...
    content: |
        Display JPC file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
