...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PROPERTIES file into PNG format.
...
demos:
    ...
    content: |
        Display PROPERTIES file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
