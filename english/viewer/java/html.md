...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert HTML file into PNG format.
...
demos:
    ...
    content: |
        Display HTML file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
