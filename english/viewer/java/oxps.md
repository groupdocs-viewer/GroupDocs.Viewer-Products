...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert OXPS file into PNG format.
...
demos:
    ...
    content: |
        Display OXPS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
