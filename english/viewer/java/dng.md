...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DNG file into PNG format.
...
demos:
    ...
    content: |
        Display DNG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
