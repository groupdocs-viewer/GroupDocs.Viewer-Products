...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert OTG file into PNG format.
...
demos:
    ...
    content: |
        Display OTG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
