...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert SASS file into PNG format.
...
demos:
    ...
    content: |
        Display SASS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
