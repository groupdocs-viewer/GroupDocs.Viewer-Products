...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CC file into PNG format.
...
demos:
    ...
    content: |
        Display CC file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
