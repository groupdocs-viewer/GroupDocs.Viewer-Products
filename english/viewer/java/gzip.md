...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert GZIP file into PNG format.
...
demos:
    ...
    content: |
        Display GZIP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
