...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert GIF file into PNG format.
...
demos:
    ...
    content: |
        Display GIF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
