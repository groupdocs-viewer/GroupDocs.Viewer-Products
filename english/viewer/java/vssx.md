...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSSX file into PNG format.
...
demos:
    ...
    content: |
        Display VSSX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
