...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert OBJ file into PNG format.
...
demos:
    ...
    content: |
        Display OBJ file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
