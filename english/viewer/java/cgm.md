...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CGM file into PNG format.
...
demos:
    ...
    content: |
        Display CGM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
