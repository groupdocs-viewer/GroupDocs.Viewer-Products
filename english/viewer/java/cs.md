...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CS file into PNG format.
...
demos:
    ...
    content: |
        Display CS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
