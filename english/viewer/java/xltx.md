...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert XLTX file into PNG format.
...
demos:
    ...
    content: |
        Display XLTX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
