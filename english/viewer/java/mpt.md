...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert MPT file into PNG format.
...
demos:
    ...
    content: |
        Display MPT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
