...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert WEBP file into PNG format.
...
demos:
    ...
    content: |
        Display WEBP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
