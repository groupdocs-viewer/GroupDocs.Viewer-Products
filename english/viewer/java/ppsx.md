...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PPSX file into PNG format.
...
demos:
    ...
    content: |
        Display PPSX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
