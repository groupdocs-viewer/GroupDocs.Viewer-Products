...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert ZIP file into PNG format.
...
demos:
    ...
    content: |
        Display ZIP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
