...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JPX file into PNG format.
...
demos:
    ...
    content: |
        Display JPX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
