...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PPS file into PNG format.
...
demos:
    ...
    content: |
        Display PPS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
