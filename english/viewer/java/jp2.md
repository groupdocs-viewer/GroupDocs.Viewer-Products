...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JP2 file into PNG format.
...
demos:
    ...
    content: |
        Display JP2 file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
