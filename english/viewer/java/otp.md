...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert OTP file into PNG format.
...
demos:
    ...
    content: |
        Display OTP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
