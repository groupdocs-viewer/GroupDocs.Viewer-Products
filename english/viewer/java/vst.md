...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VST file into PNG format.
...
demos:
    ...
    content: |
        Display VST file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
