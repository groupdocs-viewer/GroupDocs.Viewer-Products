...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DOT file into PNG format.
...
demos:
    ...
    content: |
        Display DOT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
