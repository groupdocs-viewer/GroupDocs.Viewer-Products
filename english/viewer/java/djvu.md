...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DJVU file into PNG format.
...
demos:
    ...
    content: |
        Display DJVU file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
