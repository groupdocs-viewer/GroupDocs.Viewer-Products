...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert C file into PNG format.
...
demos:
    ...
    content: |
        Display C file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
