...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert AS3 file into PNG format.
...
demos:
    ...
    content: |
        Display AS3 file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
