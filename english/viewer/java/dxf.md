...
steps:
    enable: true
    title_left: "Steps for View DXF File in Java"
    content_left: |
        ...
        *   Set view options to convert DXF file into PNG format.
...
demos:
    ...
    content: |
        Display DXF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
