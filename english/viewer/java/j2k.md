...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert J2K file into PNG format.
...
demos:
    ...
    content: |
        Display J2K file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
