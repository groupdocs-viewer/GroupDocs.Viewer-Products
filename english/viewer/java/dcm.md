...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DCM file into PNG format.
...
demos:
    ...
    content: |
        Display DCM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
