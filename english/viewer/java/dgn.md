...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DGN file into PNG format.
...
demos:
    ...
    content: |
        Display DGN file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
