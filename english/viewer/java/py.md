...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PY file into PNG format.
...
demos:
    ...
    content: |
        Display PY file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
