...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DWT file into PNG format.
...
demos:
    ...
    content: |
        Display DWT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
