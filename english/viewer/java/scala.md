...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert SCALA file into PNG format.
...
demos:
    ...
    content: |
        Display SCALA file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
