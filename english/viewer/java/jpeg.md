...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JPEG file into PNG format.
...
demos:
    ...
    content: |
        Display JPEG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
