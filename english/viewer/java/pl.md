...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PL file into PNG format.
...
demos:
    ...
    content: |
        Display PL file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
