...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert HAML file into PNG format.
...
demos:
    ...
    content: |
        Display HAML file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
