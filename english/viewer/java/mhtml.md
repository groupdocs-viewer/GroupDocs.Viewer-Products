...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert MHTML file into PNG format.
...
demos:
    ...
    content: |
        Display MHTML file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
