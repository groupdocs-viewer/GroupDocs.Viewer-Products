...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PHP file into PNG format.
...
demos:
    ...
    content: |
        Display PHP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
