...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert MM file into PNG format.
...
demos:
    ...
    content: |
        Display MM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
