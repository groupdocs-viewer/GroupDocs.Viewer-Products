...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PPTM file into PNG format.
...
demos:
    ...
    content: |
        Display PPTM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
