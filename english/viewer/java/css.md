...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CSS file into PNG format.
...
demos:
    ...
    content: |
        Display CSS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
