...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert MAKE file into PNG format.
...
demos:
    ...
    content: |
        Display MAKE file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
