...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert FODS file into PNG format.
...
demos:
    ...
    content: |
        Display FODS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
