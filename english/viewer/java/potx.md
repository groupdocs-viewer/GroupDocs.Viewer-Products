...
############################# Head ############################
head_title: "Java POTX Viewer API - Render &amp; Display POTX in Java Apps"
head_description: "View POTX files in Java, J2EE, J2SE applications. Supports viewing 150+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render &amp; View POTX File in Java"
description: "Native and high performance POTX file viewer API for Java, J2EE and J2SE based applications, supporting a wide range of additional features to customize the appearance of the output document format."
...
steps:
    enable: true
    title_left: "Steps for Viewing POTX File in Java"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java) makes it easy for Java developers to add POTX file viewing feature in their applications using a few lines of code.

        *   Create an instance of Viewer class and load the POTX file with full path.
        *   Set options for rendering POTX file into PNG format.
    ...
    code: |
        ```java
        // Instantiate viewer
        try (Viewer viewer = new Viewer("sample.potx"))
        {
...
demos:
    enable: true
    title: "POTX Viewer Live Demos"
    content: |
        Display POTX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/family) website.  
