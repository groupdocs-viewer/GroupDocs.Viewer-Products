...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert POTX file into PNG format.
...
demos:
    ...
    content: |
        Display POTX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
