...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert OTT file into PNG format.
...
demos:
    ...
    content: |
        Display OTT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
