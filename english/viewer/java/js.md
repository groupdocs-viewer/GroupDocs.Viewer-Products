...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert JS file into PNG format.
...
demos:
    ...
    content: |
        Display JS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
