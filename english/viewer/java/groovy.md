...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert GROOVY file into PNG format.
...
demos:
    ...
    content: |
        Display GROOVY file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
