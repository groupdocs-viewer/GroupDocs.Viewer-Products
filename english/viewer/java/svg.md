...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert SVG file into PNG format.
...
demos:
    ...
    content: |
        Display SVG file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
