...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert OTS file into PNG format.
...
demos:
    ...
    content: |
        Display OTS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
