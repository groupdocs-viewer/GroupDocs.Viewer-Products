...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert ASM file into PNG format.
...
demos:
    ...
    content: |
        Display ASM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
