...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert BMP file into PNG format.
...
demos:
    ...
    content: |
        Display BMP file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
