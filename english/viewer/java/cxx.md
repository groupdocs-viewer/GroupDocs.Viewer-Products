...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert CXX file into PNG format.
...
demos:
    ...
    content: |
        Display CXX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
