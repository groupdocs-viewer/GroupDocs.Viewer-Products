...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VB file into PNG format.
...
demos:
    ...
    content: |
        Display VB file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
