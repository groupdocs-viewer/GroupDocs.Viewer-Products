...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert ODT file into PNG format.
...
demos:
    ...
    content: |
        Display ODT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
