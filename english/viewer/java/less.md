...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert LESS file into PNG format.
...
demos:
    ...
    content: |
        Display LESS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
