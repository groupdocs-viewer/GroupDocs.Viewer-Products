...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert EMLX file into PNG format.
...
demos:
    ...
    content: |
        Display EMLX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
