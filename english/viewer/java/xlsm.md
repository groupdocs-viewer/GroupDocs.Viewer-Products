...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert XLSM file into PNG format.
...
demos:
    ...
    content: |
        Display XLSM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
