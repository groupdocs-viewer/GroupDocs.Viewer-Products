...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert PSD file into PNG format.
...
demos:
    ...
    content: |
        Display PSD file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
