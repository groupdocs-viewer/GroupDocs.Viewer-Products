...
steps:
    enable: true
    title_left: "Steps for Viewing XPS File in Java"
    content_left: |
        ...
        *   Set options for rendering XPS file into PNG format.
...
demos:
    ...
    content: |
        Display XPS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/family) website.  
