...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert BZ2 file into PNG format.
...
demos:
    ...
    content: |
        Display BZ2 file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
