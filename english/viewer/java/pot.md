...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert POT file into PNG format.
...
demos:
    ...
    content: |
        Display POT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
