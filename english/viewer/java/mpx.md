...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert MPX file into PNG format.
...
demos:
    ...
    content: |
        Display MPX file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
