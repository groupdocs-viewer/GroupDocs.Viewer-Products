...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSS file into PNG format.
...
demos:
    ...
    content: |
        Display VSS file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
