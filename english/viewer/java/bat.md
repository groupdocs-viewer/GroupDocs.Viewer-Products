...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert BAT file into PNG format.
...
demos:
    ...
    content: |
        Display BAT file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
