...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert DOCM file into PNG format.
...
demos:
    ...
    content: |
        Display DOCM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
