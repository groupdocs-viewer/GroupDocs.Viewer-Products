...
head_description: "View Presentation files in Java, J2EE, J2SE applications. Supports viewing 150+ document and image file formats in HTML, PDF or image mode with advanced features to manage document viewing options."

############################# Header ############################
title: "Render & View Presentation File in Java"
...
steps:
    enable: true
    title_left: "Steps for Viewing Presentation File in Java"
    content_left: |
        [GroupDocs.Viewer](https://products.groupdocs.com/viewer/java/) makes it easy for Java developers to add Presentation file viewing feature in their applications using a few lines of code.

        *   Create an instance of Viewer class and load the PPTX file with full path.
        *   Set view options to convert PPTX file into PNG format.
...
demos:
    enable: true
    title: "Presentation Viewer Live Demos"
    content: |
        Display Presentation file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
