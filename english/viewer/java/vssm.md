...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert VSSM file into PNG format.
...
demos:
    ...
    content: |
        Display VSSM file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
