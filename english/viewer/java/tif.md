...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert TIF file into PNG format.
...
demos:
    ...
    content: |
        Display TIF file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
