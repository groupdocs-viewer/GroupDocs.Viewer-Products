...
steps:
    ...
    content_left: |
        ...
        *   Set view options to convert XML file into PNG format.
...
demos:
    ...
    content: |
        Display XML file right now by visiting [GroupDocs.Viewer Live Demos](https://products.groupdocs.app/viewer/) website.  
